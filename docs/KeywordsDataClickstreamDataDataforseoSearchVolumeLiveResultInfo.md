...
**use_clickstream** | **boolean** | indicates if the use_clickstream parameter is active<br>possible values: true, false |[optional]|
**items_count** | **number** | ithe number of results returned in the items array |[optional]|
**items** | **KeywordsDataClickstreamDataSearchVolumeLiveItem[]** | array of keywords<br>contains keywords and their search volume rates |[optional]|