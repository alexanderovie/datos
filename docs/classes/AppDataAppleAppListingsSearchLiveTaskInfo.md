...
> **new AppDataAppleAppListingsSearchLiveTaskInfo**(`data?`): `AppDataAppleAppListingsSearchLiveTaskInfo`

Defined in: main.ts:221562
...
> `static` **fromJS**(`data`): `AppDataAppleAppListingsSearchLiveTaskInfo`
