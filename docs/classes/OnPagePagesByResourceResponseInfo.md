...
> **new OnPagePagesByResourceResponseInfo**(`data?`): `OnPagePagesByResourceResponseInfo`

Defined in: main.ts:179865
...
> `static` **fromJS**(`data`): `OnPagePagesByResourceResponseInfo`
