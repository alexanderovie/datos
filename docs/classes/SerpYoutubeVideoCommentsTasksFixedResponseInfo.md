...
> **new SerpYoutubeVideoCommentsTasksFixedResponseInfo**(`data`?): `SerpYoutubeVideoCommentsTasksFixedResponseInfo`
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoCommentsTasksFixedResponseInfo`

Defined in: main.ts:76638
