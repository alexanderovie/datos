...
> **new MerchantAmazonSellersTaskGetAdvancedTaskInfo**(`data?`): `MerchantAmazonSellersTaskGetAdvancedTaskInfo`

Defined in: main.ts:208650
...
> `static` **fromJS**(`data`): `MerchantAmazonSellersTaskGetAdvancedTaskInfo`

Defined in: main.ts:208669
