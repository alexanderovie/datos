...
> **new DataforseoLabsGoogleDomainWhoisOverviewLiveTaskInfo**(`data?`): `DataforseoLabsGoogleDomainWhoisOverviewLiveTaskInfo`

Defined in: main.ts:111252
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleDomainWhoisOverviewLiveTaskInfo`

Defined in: main.ts:111271
