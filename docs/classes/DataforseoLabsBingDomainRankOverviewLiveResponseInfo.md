...
> **new DataforseoLabsBingDomainRankOverviewLiveResponseInfo**(`data?`): `DataforseoLabsBingDomainRankOverviewLiveResponseInfo`

Defined in: main.ts:129415
...
> `static` **fromJS**(`data`): `DataforseoLabsBingDomainRankOverviewLiveResponseInfo`

Defined in: main.ts:129434
