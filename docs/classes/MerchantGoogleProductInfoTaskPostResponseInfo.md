...
> **new MerchantGoogleProductInfoTaskPostResponseInfo**(`data`?): `MerchantGoogleProductInfoTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleProductInfoTaskPostResponseInfo`

Defined in: main.ts:201864
