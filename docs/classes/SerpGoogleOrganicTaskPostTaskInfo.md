...
> **new SerpGoogleOrganicTaskPostTaskInfo**(`data?`): `SerpGoogleOrganicTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicTaskPostTaskInfo`
