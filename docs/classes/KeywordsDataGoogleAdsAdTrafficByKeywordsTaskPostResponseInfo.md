...
> **new KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostResponseInfo**(`data`?): `KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostResponseInfo`

Defined in: main.ts:143345
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostResponseInfo`

Defined in: main.ts:143364
