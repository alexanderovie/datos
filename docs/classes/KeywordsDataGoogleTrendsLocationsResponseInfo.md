...
> **new KeywordsDataGoogleTrendsLocationsResponseInfo**(`data?`): `KeywordsDataGoogleTrendsLocationsResponseInfo`

Defined in: main.ts:144693
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsLocationsResponseInfo`

Defined in: main.ts:144712
