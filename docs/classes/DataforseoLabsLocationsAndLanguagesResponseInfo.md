...
> **new DataforseoLabsLocationsAndLanguagesResponseInfo**(`data`?): `DataforseoLabsLocationsAndLanguagesResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsLocationsAndLanguagesResponseInfo`

Defined in: main.ts:102838
