...
> **new SerpGoogleImagesTaskPostResponseInfo**(`data`?): `SerpGoogleImagesTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleImagesTaskPostResponseInfo`

Defined in: main.ts:53121
