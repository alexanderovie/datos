...
### new SerpGoogleFinanceQuoteLiveHtmlResponseInfo()

> **new SerpGoogleFinanceQuoteLiveHtmlResponseInfo**(`data`?): [`SerpGoogleFinanceQuoteLiveHtmlResponseInfo`](SerpGoogleFinanceQuoteLiveHtmlResponseInfo.md)

Defined in: main.ts:93622
...
> `static` **fromJS**(`data`): [`SerpGoogleFinanceQuoteLiveHtmlResponseInfo`](SerpGoogleFinanceQuoteLiveHtmlResponseInfo.md)

Defined in: main.ts:93641
