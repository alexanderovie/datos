...
> **new KeywordsDataGoogleAdsLocationsResponseInfo**(`data`?): `KeywordsDataGoogleAdsLocationsResponseInfo`

Defined in: main.ts:138167
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsLocationsResponseInfo`

Defined in: main.ts:138186
