...
> **new KeywordsDataDataforseoTrendsSubregionInterestsLiveResponseInfo**(`data`?): `KeywordsDataDataforseoTrendsSubregionInterestsLiveResponseInfo`

Defined in: main.ts:148899
...
> `static` **fromJS**(`data`): `KeywordsDataDataforseoTrendsSubregionInterestsLiveResponseInfo`

Defined in: main.ts:148918
