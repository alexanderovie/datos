...
> **new SerpYoutubeVideoCommentsTasksReadyResponseInfo**(`data?`): `SerpYoutubeVideoCommentsTasksReadyResponseInfo`

Defined in: main.ts:76519
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoCommentsTasksReadyResponseInfo`

Defined in: main.ts:76538
