...
> **new KeywordsDataBingAudienceEstimationLiveResponseInfo**(`data?`): `KeywordsDataBingAudienceEstimationLiveResponseInfo`

Defined in: main.ts:153443
...
> `static` **fromJS**(`data`): `KeywordsDataBingAudienceEstimationLiveResponseInfo`

Defined in: main.ts:153462
