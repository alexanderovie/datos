...
> **new DataforseoLabsCategoriesResponseInfo**(`data`?): `DataforseoLabsCategoriesResponseInfo`

Defined in: main.ts:103009
...
> `static` **fromJS**(`data`): `DataforseoLabsCategoriesResponseInfo`
