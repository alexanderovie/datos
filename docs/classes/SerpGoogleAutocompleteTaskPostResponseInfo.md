...
> **new SerpGoogleAutocompleteTaskPostResponseInfo**(`data?`): `SerpGoogleAutocompleteTaskPostResponseInfo`

Defined in: main.ts:58443
...
> `static` **fromJS**(`data`): `SerpGoogleAutocompleteTaskPostResponseInfo`

Defined in: main.ts:58462
