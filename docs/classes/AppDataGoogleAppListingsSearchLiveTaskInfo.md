...
> **new AppDataGoogleAppListingsSearchLiveTaskInfo**(`data`?): `AppDataGoogleAppListingsSearchLiveTaskInfo`

Defined in: main.ts:216390
...
> `static` **fromJS**(`data`): `AppDataGoogleAppListingsSearchLiveTaskInfo`

Defined in: main.ts:216409
