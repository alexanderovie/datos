...
> **new BusinessDataTrustpilotSearchTasksReadyTaskInfo**(`data?`): `BusinessDataTrustpilotSearchTasksReadyTaskInfo`

Defined in: main.ts:238146
...
> `static` **fromJS**(`data`): `BusinessDataTrustpilotSearchTasksReadyTaskInfo`

Defined in: main.ts:238165
