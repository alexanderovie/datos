...
> **new SerpBingOrganicTaskGetRegularTaskInfo**(`data?`): `SerpBingOrganicTaskGetRegularTaskInfo`

Defined in: main.ts:67423
...
> `static` **fromJS**(`data`): `SerpBingOrganicTaskGetRegularTaskInfo`

Defined in: main.ts:67442
