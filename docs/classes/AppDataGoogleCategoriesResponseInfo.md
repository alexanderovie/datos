...
> **new AppDataGoogleCategoriesResponseInfo**(`data?`): `AppDataGoogleCategoriesResponseInfo`

Defined in: main.ts:210963
...
> `static` **fromJS**(`data`): `AppDataGoogleCategoriesResponseInfo`

Defined in: main.ts:210982
