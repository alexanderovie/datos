...
> **new AppDataAppleAppListTaskPostResponseInfo**(`data`?): `AppDataAppleAppListTaskPostResponseInfo`

Defined in: main.ts:219101
...
> `static` **fromJS**(`data`): `AppDataAppleAppListTaskPostResponseInfo`
