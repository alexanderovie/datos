...
> **new SerpBingOrganicTaskGetRegularResponseInfo**(`data`?): `SerpBingOrganicTaskGetRegularResponseInfo`

Defined in: main.ts:67364
...
> `static` **fromJS**(`data`): `SerpBingOrganicTaskGetRegularResponseInfo`
