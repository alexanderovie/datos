...
### new DataforseoLabsBingRankedKeywordsLiveResponseInfo()
...
> `static` **fromJS**(`data`): [`DataforseoLabsBingRankedKeywordsLiveResponseInfo`](DataforseoLabsBingRankedKeywordsLiveResponseInfo.md)
