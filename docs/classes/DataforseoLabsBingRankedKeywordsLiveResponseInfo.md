...
> **new DataforseoLabsBingRankedKeywordsLiveResponseInfo**(`data?`): `DataforseoLabsBingRankedKeywordsLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsBingRankedKeywordsLiveResponseInfo`

Defined in: main.ts:130682
