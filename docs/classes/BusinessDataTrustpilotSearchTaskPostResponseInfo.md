...
> **new BusinessDataTrustpilotSearchTaskPostResponseInfo**(`data`?): `BusinessDataTrustpilotSearchTaskPostResponseInfo`

Defined in: main.ts:237477
...
> `static` **fromJS**(`data`): `BusinessDataTrustpilotSearchTaskPostResponseInfo`

Defined in: main.ts:237496
