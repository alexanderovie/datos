...
> **new BacklinksBulkRanksLiveResponseInfo**(`data?`): `BacklinksBulkRanksLiveResponseInfo`
...
> `static` **fromJS**(`data`): `BacklinksBulkRanksLiveResponseInfo`

Defined in: main.ts:172884
