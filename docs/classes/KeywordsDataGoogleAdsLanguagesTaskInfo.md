...
> **new KeywordsDataGoogleAdsLanguagesTaskInfo**(`data?`): `KeywordsDataGoogleAdsLanguagesTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsLanguagesTaskInfo`

Defined in: main.ts:138619
