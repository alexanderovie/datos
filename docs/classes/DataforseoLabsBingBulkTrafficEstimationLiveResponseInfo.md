...
> **new DataforseoLabsBingBulkTrafficEstimationLiveResponseInfo**(`data`?): `DataforseoLabsBingBulkTrafficEstimationLiveResponseInfo`

Defined in: main.ts:127797
...
> `static` **fromJS**(`data`): `DataforseoLabsBingBulkTrafficEstimationLiveResponseInfo`

Defined in: main.ts:127816
