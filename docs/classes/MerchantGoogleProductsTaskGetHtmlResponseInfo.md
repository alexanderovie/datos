...
> **new MerchantGoogleProductsTaskGetHtmlResponseInfo**(`data?`): `MerchantGoogleProductsTaskGetHtmlResponseInfo`

Defined in: main.ts:199441
...
> `static` **fromJS**(`data`): `MerchantGoogleProductsTaskGetHtmlResponseInfo`

Defined in: main.ts:199460
