...
> **new DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResponseInfo**(`data?`): `DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResponseInfo`

Defined in: main.ts:122699
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResponseInfo`

Defined in: main.ts:122718
