...
> **new AppDataGoogleAppInfoTasksReadyResponseInfo**(`data?`): `AppDataGoogleAppInfoTasksReadyResponseInfo`

Defined in: main.ts:214239
...
> `static` **fromJS**(`data`): `AppDataGoogleAppInfoTasksReadyResponseInfo`

Defined in: main.ts:214258
