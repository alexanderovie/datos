...
> **new SerpYahooOrganicLiveAdvancedResponseInfo**(`data`?): `SerpYahooOrganicLiveAdvancedResponseInfo`

Defined in: main.ts:80697
...
> `static` **fromJS**(`data`): `SerpYahooOrganicLiveAdvancedResponseInfo`
