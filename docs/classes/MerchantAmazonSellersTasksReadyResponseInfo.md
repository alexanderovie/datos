...
> **new MerchantAmazonSellersTasksReadyResponseInfo**(`data?`): `MerchantAmazonSellersTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonSellersTasksReadyResponseInfo`

Defined in: main.ts:208242
