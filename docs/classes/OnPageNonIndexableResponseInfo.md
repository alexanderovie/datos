...
> **new OnPageNonIndexableResponseInfo**(`data`?): `OnPageNonIndexableResponseInfo`

Defined in: main.ts:182557
...
> `static` **fromJS**(`data`): `OnPageNonIndexableResponseInfo`

Defined in: main.ts:182576
