...
> **new BusinessDataTripadvisorLocationsResponseInfo**(`data?`): `BusinessDataTripadvisorLocationsResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorLocationsResponseInfo`
