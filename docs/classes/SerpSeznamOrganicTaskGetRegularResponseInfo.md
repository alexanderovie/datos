...
> **new SerpSeznamOrganicTaskGetRegularResponseInfo**(`data`?): `SerpSeznamOrganicTaskGetRegularResponseInfo`
...
> `static` **fromJS**(`data`): `SerpSeznamOrganicTaskGetRegularResponseInfo`

Defined in: main.ts:86702
