...
> **new BusinessDataTrustpilotReviewsTaskGetResponseInfo**(`data`?): `BusinessDataTrustpilotReviewsTaskGetResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataTrustpilotReviewsTaskGetResponseInfo`
