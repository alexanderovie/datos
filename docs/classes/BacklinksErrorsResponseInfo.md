...
> **new BacklinksErrorsResponseInfo**(`data`?): `BacklinksErrorsResponseInfo`
...
> `static` **fromJS**(`data`): `BacklinksErrorsResponseInfo`

Defined in: main.ts:161332
