...
> **new OnPageRedirectChainsResponseInfo**(`data?`): `OnPageRedirectChainsResponseInfo`

Defined in: main.ts:182591
...
> `static` **fromJS**(`data`): `OnPageRedirectChainsResponseInfo`

Defined in: main.ts:182610
