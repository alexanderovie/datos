...
> **new DataforseoLabsGoogleSerpCompetitorsLiveResponseInfo**(`data?`): `DataforseoLabsGoogleSerpCompetitorsLiveResponseInfo`

Defined in: main.ts:113181
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleSerpCompetitorsLiveResponseInfo`

Defined in: main.ts:113200
