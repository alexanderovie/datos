...
> **new SerpBingOrganicTaskGetAdvancedResponseInfo**(`data`?): `SerpBingOrganicTaskGetAdvancedResponseInfo`
...
> `static` **fromJS**(`data`): `SerpBingOrganicTaskGetAdvancedResponseInfo`

Defined in: main.ts:67653
