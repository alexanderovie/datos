...
> **new ContentAnalysisLanguagesResponseInfo**(`data?`): `ContentAnalysisLanguagesResponseInfo`

Defined in: main.ts:189249
...
> `static` **fromJS**(`data`): `ContentAnalysisLanguagesResponseInfo`

Defined in: main.ts:189268
