...
> **new SerpGoogleNewsTasksFixedTaskInfo**(`data?`): `SerpGoogleNewsTasksFixedTaskInfo`

Defined in: main.ts:48951
...
> `static` **fromJS**(`data`): `SerpGoogleNewsTasksFixedTaskInfo`
