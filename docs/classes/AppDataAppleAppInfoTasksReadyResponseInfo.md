...
> **new AppDataAppleAppInfoTasksReadyResponseInfo**(`data`?): `AppDataAppleAppInfoTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `AppDataAppleAppInfoTasksReadyResponseInfo`
