...
> **new KeywordsDataBingKeywordsForKeywordsTaskPostTaskInfo**(`data?`): `KeywordsDataBingKeywordsForKeywordsTaskPostTaskInfo`

Defined in: main.ts:155161
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForKeywordsTaskPostTaskInfo`

Defined in: main.ts:155176
