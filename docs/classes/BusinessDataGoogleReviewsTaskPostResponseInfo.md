...
> **new BusinessDataGoogleReviewsTaskPostResponseInfo**(`data?`): `BusinessDataGoogleReviewsTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleReviewsTaskPostResponseInfo`

Defined in: main.ts:234156
