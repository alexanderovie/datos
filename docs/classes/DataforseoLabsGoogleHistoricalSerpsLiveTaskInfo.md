...
> **new DataforseoLabsGoogleHistoricalSerpsLiveTaskInfo**(`data?`): `DataforseoLabsGoogleHistoricalSerpsLiveTaskInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleHistoricalSerpsLiveTaskInfo`
