...
> **new DomainAnalyticsTechnologiesLocationsTaskInfo**(`data?`): `DomainAnalyticsTechnologiesLocationsTaskInfo`
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesLocationsTaskInfo`

Defined in: main.ts:96671
