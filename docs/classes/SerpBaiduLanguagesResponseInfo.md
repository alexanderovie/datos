...
> **new SerpBaiduLanguagesResponseInfo**(`data`?): `SerpBaiduLanguagesResponseInfo`

Defined in: main.ts:81713
...
> `static` **fromJS**(`data`): `SerpBaiduLanguagesResponseInfo`

Defined in: main.ts:81732
