...
> **new BacklinksReferringNetworksLiveTaskInfo**(`data?`): `BacklinksReferringNetworksLiveTaskInfo`
...
> `static` **fromJS**(`data`): `BacklinksReferringNetworksLiveTaskInfo`

Defined in: main.ts:168949
