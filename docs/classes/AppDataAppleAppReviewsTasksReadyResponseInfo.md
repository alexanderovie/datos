...
> **new AppDataAppleAppReviewsTasksReadyResponseInfo**(`data`?): `AppDataAppleAppReviewsTasksReadyResponseInfo`

Defined in: main.ts:220087
...
> `static` **fromJS**(`data`): `AppDataAppleAppReviewsTasksReadyResponseInfo`

Defined in: main.ts:220106
