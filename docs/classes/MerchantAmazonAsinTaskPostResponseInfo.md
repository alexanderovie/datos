...
> **new MerchantAmazonAsinTaskPostResponseInfo**(`data?`): `MerchantAmazonAsinTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonAsinTaskPostResponseInfo`

Defined in: main.ts:206002
