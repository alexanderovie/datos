...
> **new SerpYoutubeVideoSubtitlesTasksFixedResponseInfo**(`data`?): `SerpYoutubeVideoSubtitlesTasksFixedResponseInfo`

Defined in: main.ts:75011
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoSubtitlesTasksFixedResponseInfo`
