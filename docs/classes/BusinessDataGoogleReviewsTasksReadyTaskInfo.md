...
> **new BusinessDataGoogleReviewsTasksReadyTaskInfo**(`data?`): `BusinessDataGoogleReviewsTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleReviewsTasksReadyTaskInfo`
