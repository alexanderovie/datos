...
> **new AppDataGoogleAppReviewsTasksReadyResponseInfo**(`data?`): `AppDataGoogleAppReviewsTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleAppReviewsTasksReadyResponseInfo`

Defined in: main.ts:215624
