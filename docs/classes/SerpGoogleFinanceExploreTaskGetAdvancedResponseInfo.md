...
### new SerpGoogleFinanceExploreTaskGetAdvancedResponseInfo()

> **new SerpGoogleFinanceExploreTaskGetAdvancedResponseInfo**(`data`?): [`SerpGoogleFinanceExploreTaskGetAdvancedResponseInfo`](SerpGoogleFinanceExploreTaskGetAdvancedResponseInfo.md)

Defined in: main.ts:88824
...
> `static` **fromJS**(`data`): [`SerpGoogleFinanceExploreTaskGetAdvancedResponseInfo`](SerpGoogleFinanceExploreTaskGetAdvancedResponseInfo.md)

Defined in: main.ts:88843
