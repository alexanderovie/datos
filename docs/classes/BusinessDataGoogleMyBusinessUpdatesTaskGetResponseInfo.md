...
> **new BusinessDataGoogleMyBusinessUpdatesTaskGetResponseInfo**(`data?`): `BusinessDataGoogleMyBusinessUpdatesTaskGetResponseInfo`

Defined in: main.ts:228343
...
> `static` **fromJS**(`data`): `BusinessDataGoogleMyBusinessUpdatesTaskGetResponseInfo`

Defined in: main.ts:228362
