...
> **new DataforseoLabsGoogleBulkKeywordDifficultyLiveResponseInfo**(`data?`): `DataforseoLabsGoogleBulkKeywordDifficultyLiveResponseInfo`

Defined in: main.ts:107087
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleBulkKeywordDifficultyLiveResponseInfo`

Defined in: main.ts:107106
