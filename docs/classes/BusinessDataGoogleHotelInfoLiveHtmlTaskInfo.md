...
> **new BusinessDataGoogleHotelInfoLiveHtmlTaskInfo**(`data?`): `BusinessDataGoogleHotelInfoLiveHtmlTaskInfo`

Defined in: main.ts:233682
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelInfoLiveHtmlTaskInfo`

Defined in: main.ts:233701
