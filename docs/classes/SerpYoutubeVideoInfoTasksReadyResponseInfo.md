...
> **new SerpYoutubeVideoInfoTasksReadyResponseInfo**(`data?`): `SerpYoutubeVideoInfoTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoInfoTasksReadyResponseInfo`
