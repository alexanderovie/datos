...
> **new BusinessDataTripadvisorReviewsTaskGetTaskInfo**(`data?`): `BusinessDataTripadvisorReviewsTaskGetTaskInfo`

Defined in: main.ts:241840
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorReviewsTaskGetTaskInfo`

Defined in: main.ts:241859
