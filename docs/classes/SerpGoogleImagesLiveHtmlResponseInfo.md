...
> **new SerpGoogleImagesLiveHtmlResponseInfo**(`data`?): `SerpGoogleImagesLiveHtmlResponseInfo`

Defined in: main.ts:55321
...
> `static` **fromJS**(`data`): `SerpGoogleImagesLiveHtmlResponseInfo`

Defined in: main.ts:55340
