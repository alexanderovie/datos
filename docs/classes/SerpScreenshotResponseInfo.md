...
> **new SerpScreenshotResponseInfo**(`data`?): `SerpScreenshotResponseInfo`
...
> `static` **fromJS**(`data`): `SerpScreenshotResponseInfo`

Defined in: main.ts:28215
