...
> **new AppDataGoogleLocationsCountryResponseInfo**(`data?`): `AppDataGoogleLocationsCountryResponseInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleLocationsCountryResponseInfo`

Defined in: main.ts:211374
