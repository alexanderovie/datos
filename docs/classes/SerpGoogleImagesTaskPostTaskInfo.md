...
> **new SerpGoogleImagesTaskPostTaskInfo**(`data?`): `SerpGoogleImagesTaskPostTaskInfo`

Defined in: main.ts:53168
...
> `static` **fromJS**(`data`): `SerpGoogleImagesTaskPostTaskInfo`
