...
> **new BusinessDataGoogleHotelSearchesTaskGetTaskInfo**(`data?`): `BusinessDataGoogleHotelSearchesTaskGetTaskInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelSearchesTaskGetTaskInfo`

Defined in: main.ts:229883
