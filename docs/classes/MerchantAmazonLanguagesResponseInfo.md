...
> **new MerchantAmazonLanguagesResponseInfo**(`data`?): `MerchantAmazonLanguagesResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonLanguagesResponseInfo`

Defined in: main.ts:203360
