...
> **new BusinessDataGoogleHotelInfoTaskPostTaskInfo**(`data?`): `BusinessDataGoogleHotelInfoTaskPostTaskInfo`

Defined in: main.ts:231003
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelInfoTaskPostTaskInfo`

Defined in: main.ts:231018
