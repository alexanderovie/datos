...
> **new SerpGoogleNewsTaskGetAdvancedResponseInfo**(`data?`): `SerpGoogleNewsTaskGetAdvancedResponseInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleNewsTaskGetAdvancedResponseInfo`
