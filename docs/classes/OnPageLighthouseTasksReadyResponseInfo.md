...
> **new OnPageLighthouseTasksReadyResponseInfo**(`data`?): `OnPageLighthouseTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `OnPageLighthouseTasksReadyResponseInfo`
