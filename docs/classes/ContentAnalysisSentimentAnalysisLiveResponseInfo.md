...
> **new ContentAnalysisSentimentAnalysisLiveResponseInfo**(`data`?): `ContentAnalysisSentimentAnalysisLiveResponseInfo`

Defined in: main.ts:191069
...
> `static` **fromJS**(`data`): `ContentAnalysisSentimentAnalysisLiveResponseInfo`

Defined in: main.ts:191088
