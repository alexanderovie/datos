...
> **new BusinessDataTripadvisorReviewsTaskPostResponseInfo**(`data?`): `BusinessDataTripadvisorReviewsTaskPostResponseInfo`

Defined in: main.ts:241231
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorReviewsTaskPostResponseInfo`

Defined in: main.ts:241250
