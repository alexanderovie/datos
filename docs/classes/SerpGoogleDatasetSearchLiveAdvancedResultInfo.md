...
> **new SerpGoogleDatasetSearchLiveAdvancedResultInfo**(`data?`): `SerpGoogleDatasetSearchLiveAdvancedResultInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetSearchLiveAdvancedResultInfo`

Defined in: main.ts:61601
