...
> **new MerchantAmazonReviewsTaskPostTaskInfo**(`data?`): `MerchantAmazonReviewsTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonReviewsTaskPostTaskInfo`

Defined in: main.ts:209374
