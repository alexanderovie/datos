...
> **new KeywordsDataGoogleAdsLocationsTaskInfo**(`data?`): `KeywordsDataGoogleAdsLocationsTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsLocationsTaskInfo`
