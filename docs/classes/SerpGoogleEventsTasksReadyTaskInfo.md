...
> **new SerpGoogleEventsTasksReadyTaskInfo**(`data?`): `SerpGoogleEventsTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleEventsTasksReadyTaskInfo`
