...
> **new DomainAnalyticsTechnologiesDomainsByTechnologyLiveResponseInfo**(`data?`): `DomainAnalyticsTechnologiesDomainsByTechnologyLiveResponseInfo`

Defined in: main.ts:99415
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesDomainsByTechnologyLiveResponseInfo`

Defined in: main.ts:99434
