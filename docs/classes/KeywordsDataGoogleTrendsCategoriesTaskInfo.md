...
> **new KeywordsDataGoogleTrendsCategoriesTaskInfo**(`data?`): `KeywordsDataGoogleTrendsCategoriesTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsCategoriesTaskInfo`
