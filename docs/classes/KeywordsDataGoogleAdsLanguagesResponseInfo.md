...
> **new KeywordsDataGoogleAdsLanguagesResponseInfo**(`data`?): `KeywordsDataGoogleAdsLanguagesResponseInfo`

Defined in: main.ts:138533
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsLanguagesResponseInfo`
