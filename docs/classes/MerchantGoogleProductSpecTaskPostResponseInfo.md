...
> **new MerchantGoogleProductSpecTaskPostResponseInfo**(`data`?): `MerchantGoogleProductSpecTaskPostResponseInfo`

Defined in: main.ts:200709
...
> `static` **fromJS**(`data`): `MerchantGoogleProductSpecTaskPostResponseInfo`

Defined in: main.ts:200728
