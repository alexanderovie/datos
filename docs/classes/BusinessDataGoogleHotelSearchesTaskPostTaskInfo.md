...
> **new BusinessDataGoogleHotelSearchesTaskPostTaskInfo**(`data?`): `BusinessDataGoogleHotelSearchesTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelSearchesTaskPostTaskInfo`
