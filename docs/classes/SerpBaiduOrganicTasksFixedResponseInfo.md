...
> **new SerpBaiduOrganicTasksFixedResponseInfo**(`data?`): `SerpBaiduOrganicTasksFixedResponseInfo`

Defined in: main.ts:82677
...
> `static` **fromJS**(`data`): `SerpBaiduOrganicTasksFixedResponseInfo`

Defined in: main.ts:82696
