...
> **new KeywordsDataBingKeywordsForKeywordsTasksReadyTaskInfo**(`data?`): `KeywordsDataBingKeywordsForKeywordsTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForKeywordsTasksReadyTaskInfo`

Defined in: main.ts:155365
