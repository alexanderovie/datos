...
> **new BacklinksBulkPagesSummaryLiveItem**(`data?`): `BacklinksBulkPagesSummaryLiveItem`

Defined in: main.ts:174906
...
> `static` **fromJS**(`data`): `BacklinksBulkPagesSummaryLiveItem`

Defined in: main.ts:174984
