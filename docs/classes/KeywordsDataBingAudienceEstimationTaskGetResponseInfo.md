...
> **new KeywordsDataBingAudienceEstimationTaskGetResponseInfo**(`data`?): `KeywordsDataBingAudienceEstimationTaskGetResponseInfo`

Defined in: main.ts:152907
...
> `static` **fromJS**(`data`): `KeywordsDataBingAudienceEstimationTaskGetResponseInfo`

Defined in: main.ts:152926
