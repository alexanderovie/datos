...
> **new KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostTaskInfo**(`data?`): `KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostTaskInfo`

Defined in: main.ts:141985
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostTaskInfo`

Defined in: main.ts:142000
