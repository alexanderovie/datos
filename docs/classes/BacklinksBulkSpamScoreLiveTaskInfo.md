...
> **new BacklinksBulkSpamScoreLiveTaskInfo**(`data?`): `BacklinksBulkSpamScoreLiveTaskInfo`

Defined in: main.ts:173490
...
> `static` **fromJS**(`data`): `BacklinksBulkSpamScoreLiveTaskInfo`
