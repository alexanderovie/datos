...
> **new ProductConsiderationsSerpElementItem**(`data`?): `ProductConsiderationsSerpElementItem`
...
> `static` **fromJS**(`data`): `ProductConsiderationsSerpElementItem`

Defined in: main.ts:39451
