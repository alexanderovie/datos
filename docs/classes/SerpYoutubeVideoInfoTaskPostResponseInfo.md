...
> **new SerpYoutubeVideoInfoTaskPostResponseInfo**(`data`?): `SerpYoutubeVideoInfoTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoInfoTaskPostResponseInfo`
