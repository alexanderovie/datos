...
> **new DataforseoLabsAppleKeywordsForAppLiveResponseInfo**(`data`?): `DataforseoLabsAppleKeywordsForAppLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsAppleKeywordsForAppLiveResponseInfo`

Defined in: main.ts:135914
