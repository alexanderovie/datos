...
> **new AppDataAppleAppListTasksReadyResponseInfo**(`data?`): `AppDataAppleAppListTasksReadyResponseInfo`

Defined in: main.ts:219831
...
> `static` **fromJS**(`data`): `AppDataAppleAppListTasksReadyResponseInfo`

Defined in: main.ts:219850
