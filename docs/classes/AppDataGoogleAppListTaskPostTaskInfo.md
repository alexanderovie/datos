...
> **new AppDataGoogleAppListTaskPostTaskInfo**(`data?`): `AppDataGoogleAppListTaskPostTaskInfo`

Defined in: main.ts:213029
...
> `static` **fromJS**(`data`): `AppDataGoogleAppListTaskPostTaskInfo`
