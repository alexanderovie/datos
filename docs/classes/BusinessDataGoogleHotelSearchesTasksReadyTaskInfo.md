...
### new BusinessDataGoogleHotelSearchesTasksReadyTaskInfo()
...
> `static` **fromJS**(`data`): [`BusinessDataGoogleHotelSearchesTasksReadyTaskInfo`](BusinessDataGoogleHotelSearchesTasksReadyTaskInfo.md)
