...
[Documentation](../README.md) / SerpGoogleDatasetSearchLiveAdvancedResponseInfo
...
> **new SerpGoogleDatasetSearchLiveAdvancedResponseInfo**(`data`?): `SerpGoogleDatasetSearchLiveAdvancedResponseInfo`

Defined in: main.ts:61619
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetSearchLiveAdvancedResponseInfo`

Defined in: main.ts:61638
