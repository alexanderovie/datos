...
> **new AppDataAppleAppInfoTaskPostTaskInfo**(`data?`): `AppDataAppleAppInfoTaskPostTaskInfo`

Defined in: main.ts:218553
...
> `static` **fromJS**(`data`): `AppDataAppleAppInfoTaskPostTaskInfo`
