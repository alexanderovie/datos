...
> **new KeywordsDataBingKeywordsForKeywordsTaskGetResponseInfo**(`data?`): `KeywordsDataBingKeywordsForKeywordsTaskGetResponseInfo`

Defined in: main.ts:155663
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForKeywordsTaskGetResponseInfo`

Defined in: main.ts:155682
