...
> **new KeywordsDataBingSearchVolumeTaskPostTaskInfo**(`data?`): `KeywordsDataBingSearchVolumeTaskPostTaskInfo`

Defined in: main.ts:150875
...
> `static` **fromJS**(`data`): `KeywordsDataBingSearchVolumeTaskPostTaskInfo`
