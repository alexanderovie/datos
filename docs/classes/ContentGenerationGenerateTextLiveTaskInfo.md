...
> **new ContentGenerationGenerateTextLiveTaskInfo**(`data?`): `ContentGenerationGenerateTextLiveTaskInfo`
...
> `static` **fromJS**(`data`): `ContentGenerationGenerateTextLiveTaskInfo`

Defined in: main.ts:193981
