...
> **new OnPageTaskPostResponseInfo**(`data`?): `OnPageTaskPostResponseInfo`

Defined in: main.ts:176871
...
> `static` **fromJS**(`data`): `OnPageTaskPostResponseInfo`

Defined in: main.ts:176890
