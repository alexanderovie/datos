...
> **new SerpGoogleAdsAdvertisersTaskGetAdvancedResponseInfo**(`data?`): `SerpGoogleAdsAdvertisersTaskGetAdvancedResponseInfo`

Defined in: main.ts:64436
...
> `static` **fromJS**(`data`): `SerpGoogleAdsAdvertisersTaskGetAdvancedResponseInfo`

Defined in: main.ts:64455
