...
> **new ContentGenerationCheckGrammarLiveResponseInfo**(`data`?): `ContentGenerationCheckGrammarLiveResponseInfo`

Defined in: main.ts:194709
...
> `static` **fromJS**(`data`): `ContentGenerationCheckGrammarLiveResponseInfo`

Defined in: main.ts:194728
