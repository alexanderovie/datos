...
> **new BusinessDataGoogleMyBusinessUpdatesTaskGetTaskInfo**(`data?`): `BusinessDataGoogleMyBusinessUpdatesTaskGetTaskInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleMyBusinessUpdatesTaskGetTaskInfo`

Defined in: main.ts:228307
