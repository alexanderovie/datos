...
> **new PerspectivesSerpElementItem**(`data`?): `PerspectivesSerpElementItem`

Defined in: main.ts:40219
...
> `static` **fromJS**(`data`): `PerspectivesSerpElementItem`
