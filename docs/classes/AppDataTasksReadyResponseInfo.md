...
> **new AppDataTasksReadyResponseInfo**(`data?`): `AppDataTasksReadyResponseInfo`

Defined in: main.ts:212263
...
> `static` **fromJS**(`data`): `AppDataTasksReadyResponseInfo`
