...
> **new MerchantGoogleSellersTaskPostRequestInfo**(`data`?): `MerchantGoogleSellersTaskPostRequestInfo`

Defined in: main.ts:199075
...
> `static` **fromJS**(`data`): `MerchantGoogleSellersTaskPostRequestInfo`

Defined in: main.ts:199114
