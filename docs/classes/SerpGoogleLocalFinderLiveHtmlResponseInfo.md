...
### new SerpGoogleLocalFinderLiveHtmlResponseInfo()
...
> `static` **fromJS**(`data`): [`SerpGoogleLocalFinderLiveHtmlResponseInfo`](SerpGoogleLocalFinderLiveHtmlResponseInfo.md)

Defined in: main.ts:47572
