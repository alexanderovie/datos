...
> **new SerpGoogleEventsTasksFixedResponseInfo**(`data?`): `SerpGoogleEventsTasksFixedResponseInfo`

Defined in: main.ts:51640
...
> `static` **fromJS**(`data`): `SerpGoogleEventsTasksFixedResponseInfo`

Defined in: main.ts:51659
