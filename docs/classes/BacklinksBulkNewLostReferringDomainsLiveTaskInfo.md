...
> **new BacklinksBulkNewLostReferringDomainsLiveTaskInfo**(`data?`): `BacklinksBulkNewLostReferringDomainsLiveTaskInfo`

Defined in: main.ts:174608
...
> `static` **fromJS**(`data`): `BacklinksBulkNewLostReferringDomainsLiveTaskInfo`
