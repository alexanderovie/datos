...
> **new SerpGoogleOrganicTaskGetRegularResultInfo**(`data?`): `SerpGoogleOrganicTaskGetRegularResultInfo`

Defined in: main.ts:31091
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicTaskGetRegularResultInfo`
