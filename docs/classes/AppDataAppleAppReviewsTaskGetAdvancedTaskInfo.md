...
> **new AppDataAppleAppReviewsTaskGetAdvancedTaskInfo**(`data?`): `AppDataAppleAppReviewsTaskGetAdvancedTaskInfo`

Defined in: main.ts:220892
...
> `static` **fromJS**(`data`): `AppDataAppleAppReviewsTaskGetAdvancedTaskInfo`

Defined in: main.ts:220911
