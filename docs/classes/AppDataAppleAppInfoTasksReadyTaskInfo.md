...
> **new AppDataAppleAppInfoTasksReadyTaskInfo**(`data?`): `AppDataAppleAppInfoTasksReadyTaskInfo`

Defined in: main.ts:218746
...
> `static` **fromJS**(`data`): `AppDataAppleAppInfoTasksReadyTaskInfo`
