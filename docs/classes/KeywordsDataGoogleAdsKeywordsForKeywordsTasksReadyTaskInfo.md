...
> **new KeywordsDataGoogleAdsKeywordsForKeywordsTasksReadyTaskInfo**(`data?`): `KeywordsDataGoogleAdsKeywordsForKeywordsTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsKeywordsForKeywordsTasksReadyTaskInfo`
