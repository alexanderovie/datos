...
> **new SerpYahooOrganicTaskPostResponseInfo**(`data?`): `SerpYahooOrganicTaskPostResponseInfo`

Defined in: main.ts:78549
...
> `static` **fromJS**(`data`): `SerpYahooOrganicTaskPostResponseInfo`

Defined in: main.ts:78568
