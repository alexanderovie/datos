...
> **new OnPagePagesByResourceTaskInfo**(`data?`): `OnPagePagesByResourceTaskInfo`
...
> `static` **fromJS**(`data`): `OnPagePagesByResourceTaskInfo`

Defined in: main.ts:179829
