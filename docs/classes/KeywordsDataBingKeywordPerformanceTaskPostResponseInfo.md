...
> **new KeywordsDataBingKeywordPerformanceTaskPostResponseInfo**(`data`?): `KeywordsDataBingKeywordPerformanceTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordPerformanceTaskPostResponseInfo`

Defined in: main.ts:156680
