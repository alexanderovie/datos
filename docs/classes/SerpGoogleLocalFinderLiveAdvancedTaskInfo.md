...
> **new SerpGoogleLocalFinderLiveAdvancedTaskInfo**(`data?`): `SerpGoogleLocalFinderLiveAdvancedTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleLocalFinderLiveAdvancedTaskInfo`

Defined in: main.ts:47566
