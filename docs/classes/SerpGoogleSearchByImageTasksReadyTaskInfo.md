...
> **new SerpGoogleSearchByImageTasksReadyTaskInfo**(`data?`): `SerpGoogleSearchByImageTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleSearchByImageTasksReadyTaskInfo`

Defined in: main.ts:56053
