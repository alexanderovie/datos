...
> **new BusinessDataTripadvisorLanguagesTaskInfo**(`data?`): `BusinessDataTripadvisorLanguagesTaskInfo`

Defined in: main.ts:239908
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorLanguagesTaskInfo`

Defined in: main.ts:239927
