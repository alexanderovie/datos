...
> **new SerpGoogleLanguagesResponseInfo**(`data?`): `SerpGoogleLanguagesResponseInfo`

Defined in: main.ts:29100
...
> `static` **fromJS**(`data`): `SerpGoogleLanguagesResponseInfo`

Defined in: main.ts:29119
