...
> **new KeywordsDataGoogleAdsSearchVolumeLiveTaskInfo**(`data?`): `KeywordsDataGoogleAdsSearchVolumeLiveTaskInfo`

Defined in: main.ts:140004
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsSearchVolumeLiveTaskInfo`
