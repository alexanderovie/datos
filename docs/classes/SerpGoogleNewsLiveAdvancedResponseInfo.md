...
> **new SerpGoogleNewsLiveAdvancedResponseInfo**(`data`?): `SerpGoogleNewsLiveAdvancedResponseInfo`

Defined in: main.ts:50198
...
> `static` **fromJS**(`data`): `SerpGoogleNewsLiveAdvancedResponseInfo`

Defined in: main.ts:50217
