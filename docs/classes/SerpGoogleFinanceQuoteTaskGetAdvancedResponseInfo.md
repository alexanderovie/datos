...
### new SerpGoogleFinanceQuoteTaskGetAdvancedResponseInfo()

> **new SerpGoogleFinanceQuoteTaskGetAdvancedResponseInfo**(`data`?): [`SerpGoogleFinanceQuoteTaskGetAdvancedResponseInfo`](SerpGoogleFinanceQuoteTaskGetAdvancedResponseInfo.md)

Defined in: main.ts:92570
...
> `static` **fromJS**(`data`): [`SerpGoogleFinanceQuoteTaskGetAdvancedResponseInfo`](SerpGoogleFinanceQuoteTaskGetAdvancedResponseInfo.md)
