...
> **new SerpGoogleLocalFinderTaskGetHtmlTaskInfo**(`data?`): `SerpGoogleLocalFinderTaskGetHtmlTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleLocalFinderTaskGetHtmlTaskInfo`

Defined in: main.ts:47036
