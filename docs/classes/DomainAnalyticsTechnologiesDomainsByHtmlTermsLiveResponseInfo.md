...
> **new DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveResponseInfo**(`data`?): `DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesDomainsByHtmlTermsLiveResponseInfo`

Defined in: main.ts:99764
