...
> **new DataforseoLabsGoogleCompetitorsDomainLiveTaskInfo**(`data?`): `DataforseoLabsGoogleCompetitorsDomainLiveTaskInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleCompetitorsDomainLiveTaskInfo`

Defined in: main.ts:113879
