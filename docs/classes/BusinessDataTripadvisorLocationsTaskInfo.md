...
> **new BusinessDataTripadvisorLocationsTaskInfo**(`data?`): `BusinessDataTripadvisorLocationsTaskInfo`

Defined in: main.ts:239550
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorLocationsTaskInfo`
