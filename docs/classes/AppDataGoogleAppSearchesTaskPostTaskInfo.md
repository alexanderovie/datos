...
> **new AppDataGoogleAppSearchesTaskPostTaskInfo**(`data?`): `AppDataGoogleAppSearchesTaskPostTaskInfo`

Defined in: main.ts:211815
...
> `static` **fromJS**(`data`): `AppDataGoogleAppSearchesTaskPostTaskInfo`
