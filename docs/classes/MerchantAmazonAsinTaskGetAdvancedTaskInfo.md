...
> **new MerchantAmazonAsinTaskGetAdvancedTaskInfo**(`data?`): `MerchantAmazonAsinTaskGetAdvancedTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonAsinTaskGetAdvancedTaskInfo`

Defined in: main.ts:207413
