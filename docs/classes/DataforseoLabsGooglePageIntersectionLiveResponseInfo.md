...
> **new DataforseoLabsGooglePageIntersectionLiveResponseInfo**(`data`?): `DataforseoLabsGooglePageIntersectionLiveResponseInfo`

Defined in: main.ts:121361
...
> `static` **fromJS**(`data`): `DataforseoLabsGooglePageIntersectionLiveResponseInfo`

Defined in: main.ts:121380
