...
> **new MerchantGoogleProductSpecTaskGetHtmlTaskInfo**(`data?`): `MerchantGoogleProductSpecTaskGetHtmlTaskInfo`

Defined in: main.ts:201948
...
> `static` **fromJS**(`data`): `MerchantGoogleProductSpecTaskGetHtmlTaskInfo`
