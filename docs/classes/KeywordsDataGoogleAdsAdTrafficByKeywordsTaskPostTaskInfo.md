...
> **new KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo**(`data?`): `KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo`

Defined in: main.ts:143419
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo`

Defined in: main.ts:143434
