...
> **new SerpGoogleLocationsCountryTaskInfo**(`data?`): `SerpGoogleLocationsCountryTaskInfo`

Defined in: main.ts:28879
...
> `static` **fromJS**(`data`): `SerpGoogleLocationsCountryTaskInfo`

Defined in: main.ts:28898
