...
> **new SerpYoutubeVideoInfoTasksReadyTaskInfo**(`data?`): `SerpYoutubeVideoInfoTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoInfoTasksReadyTaskInfo`

Defined in: main.ts:72934
