...
> **new DataforseoLabsAmazonBulkSearchVolumeLiveResponseInfo**(`data`?): `DataforseoLabsAmazonBulkSearchVolumeLiveResponseInfo`

Defined in: main.ts:124045
...
> `static` **fromJS**(`data`): `DataforseoLabsAmazonBulkSearchVolumeLiveResponseInfo`

Defined in: main.ts:124064
