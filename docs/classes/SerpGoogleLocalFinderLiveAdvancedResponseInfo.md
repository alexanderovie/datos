...
> **new SerpGoogleLocalFinderLiveAdvancedResponseInfo**(`data`?): `SerpGoogleLocalFinderLiveAdvancedResponseInfo`

Defined in: main.ts:47500
...
> `static` **fromJS**(`data`): `SerpGoogleLocalFinderLiveAdvancedResponseInfo`

Defined in: main.ts:47519
