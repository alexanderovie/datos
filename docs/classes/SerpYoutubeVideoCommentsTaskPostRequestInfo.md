...
> **new SerpYoutubeVideoCommentsTaskPostRequestInfo**(`data?`): `SerpYoutubeVideoCommentsTaskPostRequestInfo`

Defined in: main.ts:76092
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoCommentsTaskPostRequestInfo`
