...
> **new KeywordsDataBingKeywordsForSiteTaskGetResultInfo**(`data?`): `KeywordsDataBingKeywordsForSiteTaskGetResultInfo`

Defined in: main.ts:154123
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForSiteTaskGetResultInfo`
