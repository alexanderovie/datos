...
> **new KeywordsDataBingSearchVolumeTaskPostResponseInfo**(`data`?): `KeywordsDataBingSearchVolumeTaskPostResponseInfo`

Defined in: main.ts:150799
...
> `static` **fromJS**(`data`): `KeywordsDataBingSearchVolumeTaskPostResponseInfo`

Defined in: main.ts:150818
