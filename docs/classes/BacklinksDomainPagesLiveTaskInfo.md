...
> **new BacklinksDomainPagesLiveTaskInfo**(`data?`): `BacklinksDomainPagesLiveTaskInfo`
...
> `static` **fromJS**(`data`): `BacklinksDomainPagesLiveTaskInfo`
