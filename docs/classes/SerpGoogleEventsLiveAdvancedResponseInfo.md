...
> **new SerpGoogleEventsLiveAdvancedResponseInfo**(`data`?): `SerpGoogleEventsLiveAdvancedResponseInfo`

Defined in: main.ts:52662
...
> `static` **fromJS**(`data`): `SerpGoogleEventsLiveAdvancedResponseInfo`
