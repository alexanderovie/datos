...
> **new DataforseoLabsBingBulkTrafficEstimationLiveTaskInfo**(`data?`): `DataforseoLabsBingBulkTrafficEstimationLiveTaskInfo`

Defined in: main.ts:127864
...
> `static` **fromJS**(`data`): `DataforseoLabsBingBulkTrafficEstimationLiveTaskInfo`

Defined in: main.ts:127883
