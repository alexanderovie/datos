...
> **new MerchantGoogleLocationsCountryResponseInfo**(`data`?): `MerchantGoogleLocationsCountryResponseInfo`

Defined in: main.ts:196805
...
> `static` **fromJS**(`data`): `MerchantGoogleLocationsCountryResponseInfo`
