...
> **new KeywordsDataBingSearchVolumeTaskGetTaskInfo**(`data?`): `KeywordsDataBingSearchVolumeTaskGetTaskInfo`

Defined in: main.ts:151320
...
> `static` **fromJS**(`data`): `KeywordsDataBingSearchVolumeTaskGetTaskInfo`
