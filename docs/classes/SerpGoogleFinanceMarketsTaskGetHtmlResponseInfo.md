...
### new SerpGoogleFinanceMarketsTaskGetHtmlResponseInfo()

> **new SerpGoogleFinanceMarketsTaskGetHtmlResponseInfo**(`data`?): [`SerpGoogleFinanceMarketsTaskGetHtmlResponseInfo`](SerpGoogleFinanceMarketsTaskGetHtmlResponseInfo.md)

Defined in: main.ts:90872
...
> `static` **fromJS**(`data`): [`SerpGoogleFinanceMarketsTaskGetHtmlResponseInfo`](SerpGoogleFinanceMarketsTaskGetHtmlResponseInfo.md)
