...
> **new BacklinksPageIntersectionLiveTaskInfo**(`data?`): `BacklinksPageIntersectionLiveTaskInfo`
...
> `static` **fromJS**(`data`): `BacklinksPageIntersectionLiveTaskInfo`
