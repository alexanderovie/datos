...
> **new BusinessDataGoogleHotelInfoTasksReadyResponseInfo**(`data`?): `BusinessDataGoogleHotelInfoTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelInfoTasksReadyResponseInfo`
