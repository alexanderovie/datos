...
> **new KeywordsDataBingKeywordPerformanceTaskGetResponseInfo**(`data`?): `KeywordsDataBingKeywordPerformanceTaskGetResponseInfo`

Defined in: main.ts:157275
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordPerformanceTaskGetResponseInfo`
