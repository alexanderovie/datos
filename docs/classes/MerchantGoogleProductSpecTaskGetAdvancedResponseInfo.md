...
> **new MerchantGoogleProductSpecTaskGetAdvancedResponseInfo**(`data`?): `MerchantGoogleProductSpecTaskGetAdvancedResponseInfo`

Defined in: main.ts:201257
...
> `static` **fromJS**(`data`): `MerchantGoogleProductSpecTaskGetAdvancedResponseInfo`

Defined in: main.ts:201276
