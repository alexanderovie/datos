...
> **new KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo**(`data`?): `KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo`

Defined in: main.ts:141319
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo`

Defined in: main.ts:141353
