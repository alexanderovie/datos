...
> **new OnPageKeywordDensityResponseInfo**(`data`?): `OnPageKeywordDensityResponseInfo`

Defined in: main.ts:183421
...
> `static` **fromJS**(`data`): `OnPageKeywordDensityResponseInfo`

Defined in: main.ts:183440
