...
> **new KeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo**(`data?`): `KeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo`

Defined in: main.ts:139196
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo`

Defined in: main.ts:139215
