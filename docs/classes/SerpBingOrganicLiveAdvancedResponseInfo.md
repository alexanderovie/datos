...
> **new SerpBingOrganicLiveAdvancedResponseInfo**(`data`?): `SerpBingOrganicLiveAdvancedResponseInfo`

Defined in: main.ts:68980
...
> `static` **fromJS**(`data`): `SerpBingOrganicLiveAdvancedResponseInfo`

Defined in: main.ts:68999
