...
> **new SerpNaverOrganicTaskGetHtmlResponseInfo**(`data?`): `SerpNaverOrganicTaskGetHtmlResponseInfo`
...
> `static` **fromJS**(`data`): `SerpNaverOrganicTaskGetHtmlResponseInfo`

Defined in: main.ts:85132
