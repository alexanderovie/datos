...
> **new KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo**(`data`?): `KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo`

Defined in: main.ts:142731
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo`

Defined in: main.ts:142765
