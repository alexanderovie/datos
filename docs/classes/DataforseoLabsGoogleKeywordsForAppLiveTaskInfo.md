...
> **new DataforseoLabsGoogleKeywordsForAppLiveTaskInfo**(`data?`): `DataforseoLabsGoogleKeywordsForAppLiveTaskInfo`

Defined in: main.ts:133868
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleKeywordsForAppLiveTaskInfo`

Defined in: main.ts:133887
