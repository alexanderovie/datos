...
> **new KeywordsDataBingAudienceEstimationTasksReadyResponseInfo**(`data?`): `KeywordsDataBingAudienceEstimationTasksReadyResponseInfo`

Defined in: main.ts:152685
...
> `static` **fromJS**(`data`): `KeywordsDataBingAudienceEstimationTasksReadyResponseInfo`

Defined in: main.ts:152704
