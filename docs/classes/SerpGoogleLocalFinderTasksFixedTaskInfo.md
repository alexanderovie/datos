...
> **new SerpGoogleLocalFinderTasksFixedTaskInfo**(`data?`): `SerpGoogleLocalFinderTasksFixedTaskInfo`

Defined in: main.ts:46533
...
> `static` **fromJS**(`data`): `SerpGoogleLocalFinderTasksFixedTaskInfo`

Defined in: main.ts:46552
