...
> **new BusinessDataGoogleHotelInfoLiveHtmlResponseInfo**(`data`?): `BusinessDataGoogleHotelInfoLiveHtmlResponseInfo`

Defined in: main.ts:233207
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelInfoLiveHtmlResponseInfo`

Defined in: main.ts:233226
