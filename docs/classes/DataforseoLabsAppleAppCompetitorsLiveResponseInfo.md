...
> **new DataforseoLabsAppleAppCompetitorsLiveResponseInfo**(`data?`): `DataforseoLabsAppleAppCompetitorsLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsAppleAppCompetitorsLiveResponseInfo`

Defined in: main.ts:136652
