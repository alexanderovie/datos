...
> **new BacklinksReferringDomainsLiveResponseInfo**(`data?`): `BacklinksReferringDomainsLiveResponseInfo`

Defined in: main.ts:168183
...
> `static` **fromJS**(`data`): `BacklinksReferringDomainsLiveResponseInfo`
