...
> **new DataforseoLabsAvailableFiltersTaskInfo**(`data?`): `DataforseoLabsAvailableFiltersTaskInfo`

Defined in: main.ts:102587
...
> `static` **fromJS**(`data`): `DataforseoLabsAvailableFiltersTaskInfo`

Defined in: main.ts:102606
