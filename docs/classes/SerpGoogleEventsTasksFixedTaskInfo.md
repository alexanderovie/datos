...
> **new SerpGoogleEventsTasksFixedTaskInfo**(`data?`): `SerpGoogleEventsTasksFixedTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleEventsTasksFixedTaskInfo`

Defined in: main.ts:51604
