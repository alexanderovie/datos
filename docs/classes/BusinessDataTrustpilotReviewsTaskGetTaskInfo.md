...
> **new BusinessDataTrustpilotReviewsTaskGetTaskInfo**(`data?`): `BusinessDataTrustpilotReviewsTaskGetTaskInfo`

Defined in: main.ts:239358
...
> `static` **fromJS**(`data`): `BusinessDataTrustpilotReviewsTaskGetTaskInfo`

Defined in: main.ts:239377
