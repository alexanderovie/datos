...
> **new DataforseoLabsAmazonProductCompetitorsLiveTaskInfo**(`data?`): `DataforseoLabsAmazonProductCompetitorsLiveTaskInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsAmazonProductCompetitorsLiveTaskInfo`

Defined in: main.ts:126571
