...
> **new SerpBingOrganicTasksReadyResponseInfo**(`data`?): `SerpBingOrganicTasksReadyResponseInfo`

Defined in: main.ts:66884
...
> `static` **fromJS**(`data`): `SerpBingOrganicTasksReadyResponseInfo`

Defined in: main.ts:66903
