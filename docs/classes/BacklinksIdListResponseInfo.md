...
> **new BacklinksIdListResponseInfo**(`data?`): `BacklinksIdListResponseInfo`

Defined in: main.ts:161097
...
> `static` **fromJS**(`data`): `BacklinksIdListResponseInfo`
