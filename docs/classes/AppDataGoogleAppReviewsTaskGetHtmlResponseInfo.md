...
> **new AppDataGoogleAppReviewsTaskGetHtmlResponseInfo**(`data`?): `AppDataGoogleAppReviewsTaskGetHtmlResponseInfo`

Defined in: main.ts:215775
...
> `static` **fromJS**(`data`): `AppDataGoogleAppReviewsTaskGetHtmlResponseInfo`
