...
> **new BusinessDataGoogleMyBusinessInfoTaskPostTaskInfo**(`data?`): `BusinessDataGoogleMyBusinessInfoTaskPostTaskInfo`

Defined in: main.ts:225537
...
> `static` **fromJS**(`data`): `BusinessDataGoogleMyBusinessInfoTaskPostTaskInfo`

Defined in: main.ts:225552
