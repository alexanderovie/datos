...
> **new MerchantIdListResponseInfo**(`data?`): `MerchantIdListResponseInfo`

Defined in: main.ts:196447
...
> `static` **fromJS**(`data`): `MerchantIdListResponseInfo`
