...
> **new ImageResourceElementItem**(`data?`): `ImageResourceElementItem`

Defined in: main.ts:180615
...
> `static` **fromJS**(`data`): `ImageResourceElementItem`

Defined in: main.ts:180633
