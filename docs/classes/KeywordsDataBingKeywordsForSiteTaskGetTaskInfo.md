...
> **new KeywordsDataBingKeywordsForSiteTaskGetTaskInfo**(`data?`): `KeywordsDataBingKeywordsForSiteTaskGetTaskInfo`

Defined in: main.ts:154242
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForSiteTaskGetTaskInfo`
