...
> **new SerpGoogleAutocompleteLiveAdvancedResponseInfo**(`data`?): `SerpGoogleAutocompleteLiveAdvancedResponseInfo`

Defined in: main.ts:59629
...
> `static` **fromJS**(`data`): `SerpGoogleAutocompleteLiveAdvancedResponseInfo`

Defined in: main.ts:59648
