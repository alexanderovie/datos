...
> **new SerpYahooOrganicTaskGetAdvancedResponseInfo**(`data`?): `SerpYahooOrganicTaskGetAdvancedResponseInfo`
...
> `static` **fromJS**(`data`): `SerpYahooOrganicTaskGetAdvancedResponseInfo`

Defined in: main.ts:79424
