...
> **new DataforseoLabsGoogleRankedKeywordsLiveResponseInfo**(`data`?): `DataforseoLabsGoogleRankedKeywordsLiveResponseInfo`

Defined in: main.ts:112399
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleRankedKeywordsLiveResponseInfo`

Defined in: main.ts:112418
