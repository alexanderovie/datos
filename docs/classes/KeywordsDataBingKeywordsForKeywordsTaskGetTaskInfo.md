...
> **new KeywordsDataBingKeywordsForKeywordsTaskGetTaskInfo**(`data?`): `KeywordsDataBingKeywordsForKeywordsTaskGetTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForKeywordsTaskGetTaskInfo`

Defined in: main.ts:155627
