...
> **new SerpGoogleImagesTasksFixedTaskInfo**(`data?`): `SerpGoogleImagesTasksFixedTaskInfo`

Defined in: main.ts:53585
...
> `static` **fromJS**(`data`): `SerpGoogleImagesTasksFixedTaskInfo`

Defined in: main.ts:53604
