...
> **new OnPageLighthouseTaskGetJsonResponseInfo**(`data`?): `OnPageLighthouseTaskGetJsonResponseInfo`

Defined in: main.ts:187691
...
> `static` **fromJS**(`data`): `OnPageLighthouseTaskGetJsonResponseInfo`

Defined in: main.ts:187710
