...
> **new KeywordsDataGoogleTrendsLocationsCountryResponseInfo**(`data`?): `KeywordsDataGoogleTrendsLocationsCountryResponseInfo`

Defined in: main.ts:144787
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsLocationsCountryResponseInfo`

Defined in: main.ts:144806
