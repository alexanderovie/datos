...
> **new BacklinksReferringNetworksLiveItem**(`data`?): `BacklinksReferringNetworksLiveItem`
...
> `static` **fromJS**(`data`): `BacklinksReferringNetworksLiveItem`

Defined in: main.ts:168409
