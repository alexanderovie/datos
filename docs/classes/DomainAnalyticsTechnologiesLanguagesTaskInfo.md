...
> **new DomainAnalyticsTechnologiesLanguagesTaskInfo**(`data`?): `DomainAnalyticsTechnologiesLanguagesTaskInfo`

Defined in: main.ts:96706
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesLanguagesTaskInfo`

Defined in: main.ts:96725
