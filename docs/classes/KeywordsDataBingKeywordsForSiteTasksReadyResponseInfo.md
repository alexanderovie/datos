...
> **new KeywordsDataBingKeywordsForSiteTasksReadyResponseInfo**(`data`?): `KeywordsDataBingKeywordsForSiteTasksReadyResponseInfo`

Defined in: main.ts:153909
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForSiteTasksReadyResponseInfo`

Defined in: main.ts:153928
