...
> **new BusinessDataGoogleMyBusinessInfoTasksReadyResponseInfo**(`data?`): `BusinessDataGoogleMyBusinessInfoTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleMyBusinessInfoTasksReadyResponseInfo`

Defined in: main.ts:225798
