...
> **new DataforseoLabsGoogleSubdomainsLiveResponseInfo**(`data`?): `DataforseoLabsGoogleSubdomainsLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleSubdomainsLiveResponseInfo`

Defined in: main.ts:115040
