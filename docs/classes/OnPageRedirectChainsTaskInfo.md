...
> **new OnPageRedirectChainsTaskInfo**(`data?`): `OnPageRedirectChainsTaskInfo`

Defined in: main.ts:182536
...
> `static` **fromJS**(`data`): `OnPageRedirectChainsTaskInfo`
