...
> **new SerpYahooOrganicTaskGetRegularResultInfo**(`data`?): `SerpYahooOrganicTaskGetRegularResultInfo`

Defined in: main.ts:78953
...
> `static` **fromJS**(`data`): `SerpYahooOrganicTaskGetRegularResultInfo`
