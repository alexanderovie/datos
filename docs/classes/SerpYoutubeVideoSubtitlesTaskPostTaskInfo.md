...
> **new SerpYoutubeVideoSubtitlesTaskPostTaskInfo**(`data?`): `SerpYoutubeVideoSubtitlesTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoSubtitlesTaskPostTaskInfo`

Defined in: main.ts:74666
