...
> **new MerchantGoogleSellersTaskGetAdvancedTaskInfo**(`data?`): `MerchantGoogleSellersTaskGetAdvancedTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleSellersTaskGetAdvancedTaskInfo`
