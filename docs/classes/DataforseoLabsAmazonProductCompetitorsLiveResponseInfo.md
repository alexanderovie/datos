...
> **new DataforseoLabsAmazonProductCompetitorsLiveResponseInfo**(`data?`): `DataforseoLabsAmazonProductCompetitorsLiveResponseInfo`

Defined in: main.ts:126607
...
> `static` **fromJS**(`data`): `DataforseoLabsAmazonProductCompetitorsLiveResponseInfo`

Defined in: main.ts:126626
