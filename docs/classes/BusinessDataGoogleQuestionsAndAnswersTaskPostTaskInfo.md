...
> **new BusinessDataGoogleQuestionsAndAnswersTaskPostTaskInfo**(`data?`): `BusinessDataGoogleQuestionsAndAnswersTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleQuestionsAndAnswersTaskPostTaskInfo`
