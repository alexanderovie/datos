...
> **new MerchantGoogleLocationsResponseInfo**(`data?`): `MerchantGoogleLocationsResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleLocationsResponseInfo`
