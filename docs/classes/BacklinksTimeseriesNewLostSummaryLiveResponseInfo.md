...
> **new BacklinksTimeseriesNewLostSummaryLiveResponseInfo**(`data?`): `BacklinksTimeseriesNewLostSummaryLiveResponseInfo`

Defined in: main.ts:172503
...
> `static` **fromJS**(`data`): `BacklinksTimeseriesNewLostSummaryLiveResponseInfo`

Defined in: main.ts:172522
