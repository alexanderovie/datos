...
> **new SerpGoogleEventsTasksReadyResponseInfo**(`data?`): `SerpGoogleEventsTasksReadyResponseInfo`

Defined in: main.ts:51428
...
> `static` **fromJS**(`data`): `SerpGoogleEventsTasksReadyResponseInfo`
