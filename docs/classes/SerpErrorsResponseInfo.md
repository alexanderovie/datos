...
> **new SerpErrorsResponseInfo**(`data?`): `SerpErrorsResponseInfo`
...
> `static` **fromJS**(`data`): `SerpErrorsResponseInfo`

Defined in: main.ts:27895
