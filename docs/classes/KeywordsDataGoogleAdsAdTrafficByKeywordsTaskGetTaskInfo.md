...
> **new KeywordsDataGoogleAdsAdTrafficByKeywordsTaskGetTaskInfo**(`data?`): `KeywordsDataGoogleAdsAdTrafficByKeywordsTaskGetTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsAdTrafficByKeywordsTaskGetTaskInfo`

Defined in: main.ts:143893
