...
> **new MerchantGoogleSellersAdUrlResponseInfo**(`data?`): `MerchantGoogleSellersAdUrlResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleSellersAdUrlResponseInfo`

Defined in: main.ts:203340
