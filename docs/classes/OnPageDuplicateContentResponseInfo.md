...
> **new OnPageDuplicateContentResponseInfo**(`data?`): `OnPageDuplicateContentResponseInfo`

Defined in: main.ts:181577
...
> `static` **fromJS**(`data`): `OnPageDuplicateContentResponseInfo`

Defined in: main.ts:181596
