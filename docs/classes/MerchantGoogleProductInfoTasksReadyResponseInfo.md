...
> **new MerchantGoogleProductInfoTasksReadyResponseInfo**(`data?`): `MerchantGoogleProductInfoTasksReadyResponseInfo`

Defined in: main.ts:202577
...
> `static` **fromJS**(`data`): `MerchantGoogleProductInfoTasksReadyResponseInfo`
