...
> **new SerpBingLocalPackLiveHtmlResponseInfo**(`data`?): `SerpBingLocalPackLiveHtmlResponseInfo`

Defined in: main.ts:71742
...
> `static` **fromJS**(`data`): `SerpBingLocalPackLiveHtmlResponseInfo`
