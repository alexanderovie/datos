...
> **new BusinessDataTripadvisorReviewsTasksReadyTaskInfo**(`data?`): `BusinessDataTripadvisorReviewsTasksReadyTaskInfo`

Defined in: main.ts:241370
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorReviewsTasksReadyTaskInfo`

Defined in: main.ts:241389
