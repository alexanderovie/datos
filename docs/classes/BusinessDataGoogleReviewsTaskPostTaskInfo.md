...
> **new BusinessDataGoogleReviewsTaskPostTaskInfo**(`data?`): `BusinessDataGoogleReviewsTaskPostTaskInfo`

Defined in: main.ts:234089
...
> `static` **fromJS**(`data`): `BusinessDataGoogleReviewsTaskPostTaskInfo`
