...
> **new OnPageLighthouseTaskPostRequestInfo**(`data?`): `OnPageLighthouseTaskPostRequestInfo`
...
> `static` **fromJS**(`data`): `OnPageLighthouseTaskPostRequestInfo`

Defined in: main.ts:187636
