...
> **new MerchantAmazonAsinTaskGetHtmlTaskInfo**(`data?`): `MerchantAmazonAsinTaskGetHtmlTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonAsinTaskGetHtmlTaskInfo`
