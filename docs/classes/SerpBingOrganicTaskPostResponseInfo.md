...
> **new SerpBingOrganicTaskPostResponseInfo**(`data?`): `SerpBingOrganicTaskPostResponseInfo`

Defined in: main.ts:66786
...
> `static` **fromJS**(`data`): `SerpBingOrganicTaskPostResponseInfo`

Defined in: main.ts:66805
