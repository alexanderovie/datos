...
> **new SerpAiSummaryResponseInfo**(`data?`): `SerpAiSummaryResponseInfo`

Defined in: main.ts:28538
...
> `static` **fromJS**(`data`): `SerpAiSummaryResponseInfo`
