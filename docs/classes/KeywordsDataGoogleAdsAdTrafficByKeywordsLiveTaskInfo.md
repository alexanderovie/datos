...
[Documentation](../README.md) / KeywordsDataGoogleAdsAdTrafficByKeywordsLiveTaskInfo

# Class: KeywordsDataGoogleAdsAdTrafficByKeywordsLiveTaskInfo

Defined in: main.ts:144416
...
> **new KeywordsDataGoogleAdsAdTrafficByKeywordsLiveTaskInfo**(`data?`): `KeywordsDataGoogleAdsAdTrafficByKeywordsLiveTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsAdTrafficByKeywordsLiveTaskInfo`
