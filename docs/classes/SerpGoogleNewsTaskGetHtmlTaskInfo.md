...
> **new SerpGoogleNewsTaskGetHtmlTaskInfo**(`data?`): `SerpGoogleNewsTaskGetHtmlTaskInfo`

Defined in: main.ts:49685
...
> `static` **fromJS**(`data`): `SerpGoogleNewsTaskGetHtmlTaskInfo`
