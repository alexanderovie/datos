...
> **new SerpYoutubeVideoCommentsTaskGetAdvancedResponseInfo**(`data?`): `SerpYoutubeVideoCommentsTaskGetAdvancedResponseInfo`

Defined in: main.ts:77093
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoCommentsTaskGetAdvancedResponseInfo`

Defined in: main.ts:77112
