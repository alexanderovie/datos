...
> **new SerpGoogleAdsAdvertisersTaskPostResponseInfo**(`data`?): `SerpGoogleAdsAdvertisersTaskPostResponseInfo`

Defined in: main.ts:63483
...
> `static` **fromJS**(`data`): `SerpGoogleAdsAdvertisersTaskPostResponseInfo`

Defined in: main.ts:63502
