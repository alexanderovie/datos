...
> **new KeywordsDataBingKeywordPerformanceLocationsAndLanguagesTaskInfo**(`data?`): `KeywordsDataBingKeywordPerformanceLocationsAndLanguagesTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordPerformanceLocationsAndLanguagesTaskInfo`

Defined in: main.ts:156403
