...
> **new BusinessDataGoogleLanguagesResponseInfo**(`data`?): `BusinessDataGoogleLanguagesResponseInfo`

Defined in: main.ts:224705
...
> `static` **fromJS**(`data`): `BusinessDataGoogleLanguagesResponseInfo`
