...
> **new BacklinksReferringNetworksLiveResponseInfo**(`data?`): `BacklinksReferringNetworksLiveResponseInfo`
...
> `static` **fromJS**(`data`): `BacklinksReferringNetworksLiveResponseInfo`

Defined in: main.ts:169004
