...
> **new ContentGenerationGrammarRulesResponseInfo**(`data?`): `ContentGenerationGrammarRulesResponseInfo`
...
> `static` **fromJS**(`data`): `ContentGenerationGrammarRulesResponseInfo`

Defined in: main.ts:195592
