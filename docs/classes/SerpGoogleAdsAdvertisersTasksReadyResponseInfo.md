...
> **new SerpGoogleAdsAdvertisersTasksReadyResponseInfo**(`data`?): `SerpGoogleAdsAdvertisersTasksReadyResponseInfo`

Defined in: main.ts:63695
...
> `static` **fromJS**(`data`): `SerpGoogleAdsAdvertisersTasksReadyResponseInfo`
