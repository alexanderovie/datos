...
> **new DataforseoLabsGoogleTopSearchesLiveResponseInfo**(`data`?): `DataforseoLabsGoogleTopSearchesLiveResponseInfo`

Defined in: main.ts:110649
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleTopSearchesLiveResponseInfo`

Defined in: main.ts:110668
