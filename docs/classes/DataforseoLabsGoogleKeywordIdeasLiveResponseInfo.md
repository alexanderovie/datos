...
> **new DataforseoLabsGoogleKeywordIdeasLiveResponseInfo**(`data?`): `DataforseoLabsGoogleKeywordIdeasLiveResponseInfo`

Defined in: main.ts:106671
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleKeywordIdeasLiveResponseInfo`

Defined in: main.ts:106690
