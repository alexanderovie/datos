...
### new BacklinksBulkReferringDomainsLiveResponseInfo()
...
> `static` **fromJS**(`data`): [`BacklinksBulkReferringDomainsLiveResponseInfo`](BacklinksBulkReferringDomainsLiveResponseInfo.md)

Defined in: main.ts:171125
