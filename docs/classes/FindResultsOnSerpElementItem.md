...
> **new FindResultsOnSerpElementItem**(`data`?): `FindResultsOnSerpElementItem`
...
> `static` **fromJS**(`data`): `FindResultsOnSerpElementItem`

Defined in: main.ts:37788
