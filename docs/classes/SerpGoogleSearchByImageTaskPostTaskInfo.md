...
> **new SerpGoogleSearchByImageTaskPostTaskInfo**(`data?`): `SerpGoogleSearchByImageTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleSearchByImageTaskPostTaskInfo`
