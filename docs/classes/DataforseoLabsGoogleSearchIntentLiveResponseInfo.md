...
> **new DataforseoLabsGoogleSearchIntentLiveResponseInfo**(`data?`): `DataforseoLabsGoogleSearchIntentLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleSearchIntentLiveResponseInfo`

Defined in: main.ts:107594
