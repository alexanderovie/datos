...
[Documentation](../README.md) / DataforseoLabsGoogleSearchIntentLiveResponseInfo
...
### new DataforseoLabsGoogleSearchIntentLiveResponseInfo()
...
> `static` **fromJS**(`data`): [`DataforseoLabsGoogleSearchIntentLiveResponseInfo`](DataforseoLabsGoogleSearchIntentLiveResponseInfo.md)
