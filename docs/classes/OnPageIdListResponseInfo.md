...
> **new OnPageIdListResponseInfo**(`data`?): `OnPageIdListResponseInfo`

Defined in: main.ts:175211
...
> `static` **fromJS**(`data`): `OnPageIdListResponseInfo`
