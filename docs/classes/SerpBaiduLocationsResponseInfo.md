...
> **new SerpBaiduLocationsResponseInfo**(`data?`): `SerpBaiduLocationsResponseInfo`

Defined in: main.ts:81469
...
> `static` **fromJS**(`data`): `SerpBaiduLocationsResponseInfo`
