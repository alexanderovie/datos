...
> **new MerchantAmazonSellersTasksReadyTaskInfo**(`data?`): `MerchantAmazonSellersTasksReadyTaskInfo`

Defined in: main.ts:208168
...
> `static` **fromJS**(`data`): `MerchantAmazonSellersTasksReadyTaskInfo`
