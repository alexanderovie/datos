...
> **new AppendixDayStatisticsRatesData**(`data?`): `AppendixDayStatisticsRatesData`

Defined in: main.ts:247095
...
> `static` **fromJS**(`data`): `AppendixDayStatisticsRatesData`
