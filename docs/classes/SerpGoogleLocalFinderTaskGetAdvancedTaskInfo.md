...
> **new SerpGoogleLocalFinderTaskGetAdvancedTaskInfo**(`data?`): `SerpGoogleLocalFinderTaskGetAdvancedTaskInfo`

Defined in: main.ts:46799
...
> `static` **fromJS**(`data`): `SerpGoogleLocalFinderTaskGetAdvancedTaskInfo`
