...
> **new DomainAnalyticsTechnologiesDomainTechnologiesLiveTaskInfo**(`data?`): `DomainAnalyticsTechnologiesDomainTechnologiesLiveTaskInfo`

Defined in: main.ts:100152
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesDomainTechnologiesLiveTaskInfo`
