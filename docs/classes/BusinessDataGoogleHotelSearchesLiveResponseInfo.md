...
> **new BusinessDataGoogleHotelSearchesLiveResponseInfo**(`data?`): `BusinessDataGoogleHotelSearchesLiveResponseInfo`

Defined in: main.ts:230597
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelSearchesLiveResponseInfo`

Defined in: main.ts:230616
