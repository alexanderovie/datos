...
> **new SerpGoogleDatasetInfoLiveAdvancedTaskInfo**(`data?`): `SerpGoogleDatasetInfoLiveAdvancedTaskInfo`

Defined in: main.ts:63032
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetInfoLiveAdvancedTaskInfo`

Defined in: main.ts:63051
