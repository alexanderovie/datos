...
> **new KeywordsDataDataforseoTrendsLocationsCountryTaskInfo**(`data?`): `KeywordsDataDataforseoTrendsLocationsCountryTaskInfo`

Defined in: main.ts:147706
...
> `static` **fromJS**(`data`): `KeywordsDataDataforseoTrendsLocationsCountryTaskInfo`
