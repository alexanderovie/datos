...
> **new DataforseoLabsAmazonBulkSearchVolumeLiveTaskInfo**(`data?`): `DataforseoLabsAmazonBulkSearchVolumeLiveTaskInfo`

Defined in: main.ts:124112
...
> `static` **fromJS**(`data`): `DataforseoLabsAmazonBulkSearchVolumeLiveTaskInfo`

Defined in: main.ts:124131
