...
> **new BacklinksHistoryLiveItem**(`data`?): `BacklinksHistoryLiveItem`

Defined in: main.ts:162853
...
> `static` **fromJS**(`data`): `BacklinksHistoryLiveItem`
