...
> **new SerpYahooOrganicLiveRegularResponseInfo**(`data`?): `SerpYahooOrganicLiveRegularResponseInfo`

Defined in: main.ts:80163
...
> `static` **fromJS**(`data`): `SerpYahooOrganicLiveRegularResponseInfo`
