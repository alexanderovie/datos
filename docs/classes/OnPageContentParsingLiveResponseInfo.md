...
> **new OnPageContentParsingLiveResponseInfo**(`data`?): `OnPageContentParsingLiveResponseInfo`

Defined in: main.ts:185931
...
> `static` **fromJS**(`data`): `OnPageContentParsingLiveResponseInfo`

Defined in: main.ts:185950
