...
> **new AppDataGoogleAppInfoTaskPostResponseInfo**(`data`?): `AppDataGoogleAppInfoTaskPostResponseInfo`

Defined in: main.ts:213509
...
> `static` **fromJS**(`data`): `AppDataGoogleAppInfoTaskPostResponseInfo`

Defined in: main.ts:213528
