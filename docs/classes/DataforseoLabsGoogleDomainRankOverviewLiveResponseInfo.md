...
> **new DataforseoLabsGoogleDomainRankOverviewLiveResponseInfo**(`data?`): `DataforseoLabsGoogleDomainRankOverviewLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleDomainRankOverviewLiveResponseInfo`
