...
> **new SerpGoogleOrganicLiveRegularTaskInfo**(`data?`): `SerpGoogleOrganicLiveRegularTaskInfo`

Defined in: main.ts:42097
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicLiveRegularTaskInfo`
