...
> **new SerpGoogleNewsTasksReadyTaskInfo**(`data?`): `SerpGoogleNewsTasksReadyTaskInfo`

Defined in: main.ts:48739
...
> `static` **fromJS**(`data`): `SerpGoogleNewsTasksReadyTaskInfo`

Defined in: main.ts:48758
