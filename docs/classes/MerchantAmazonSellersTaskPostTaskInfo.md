...
> **new MerchantAmazonSellersTaskPostTaskInfo**(`data`?): `MerchantAmazonSellersTaskPostTaskInfo`

Defined in: main.ts:207447
...
> `static` **fromJS**(`data`): `MerchantAmazonSellersTaskPostTaskInfo`

Defined in: main.ts:207462
