...
> **new SerpBaiduLocationsCountryResponseInfo**(`data`?): `SerpBaiduLocationsCountryResponseInfo`

Defined in: main.ts:81547
...
> `static` **fromJS**(`data`): `SerpBaiduLocationsCountryResponseInfo`

Defined in: main.ts:81566
