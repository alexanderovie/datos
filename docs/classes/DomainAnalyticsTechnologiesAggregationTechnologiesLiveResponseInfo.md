...
> **new DomainAnalyticsTechnologiesAggregationTechnologiesLiveResponseInfo**(`data`?): `DomainAnalyticsTechnologiesAggregationTechnologiesLiveResponseInfo`

Defined in: main.ts:97683
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesAggregationTechnologiesLiveResponseInfo`

Defined in: main.ts:97702
