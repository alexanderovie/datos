...
> **new KeywordsDataGoogleAdsSearchVolumeLiveResponseInfo**(`data?`): `KeywordsDataGoogleAdsSearchVolumeLiveResponseInfo`

Defined in: main.ts:140059
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsSearchVolumeLiveResponseInfo`
