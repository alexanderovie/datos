...
> **new BusinessDataTripadvisorSearchTaskGetResponseInfo**(`data?`): `BusinessDataTripadvisorSearchTaskGetResponseInfo`

Defined in: main.ts:240783
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorSearchTaskGetResponseInfo`

Defined in: main.ts:240802
