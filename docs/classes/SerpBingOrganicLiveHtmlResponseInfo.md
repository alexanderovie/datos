...
> **new SerpBingOrganicLiveHtmlResponseInfo**(`data`?): `SerpBingOrganicLiveHtmlResponseInfo`

Defined in: main.ts:69446
...
> `static` **fromJS**(`data`): `SerpBingOrganicLiveHtmlResponseInfo`

Defined in: main.ts:69465
