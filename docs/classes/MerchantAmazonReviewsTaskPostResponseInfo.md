...
> **new MerchantAmazonReviewsTaskPostResponseInfo**(`data?`): `MerchantAmazonReviewsTaskPostResponseInfo`

Defined in: main.ts:209407
...
> `static` **fromJS**(`data`): `MerchantAmazonReviewsTaskPostResponseInfo`

Defined in: main.ts:209426
