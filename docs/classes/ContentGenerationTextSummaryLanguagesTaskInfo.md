...
> **new ContentGenerationTextSummaryLanguagesTaskInfo**(`data?`): `ContentGenerationTextSummaryLanguagesTaskInfo`
...
> `static` **fromJS**(`data`): `ContentGenerationTextSummaryLanguagesTaskInfo`

Defined in: main.ts:196063
