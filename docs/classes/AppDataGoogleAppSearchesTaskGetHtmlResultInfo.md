...
> **new AppDataGoogleAppSearchesTaskGetHtmlResultInfo**(`data`?): `AppDataGoogleAppSearchesTaskGetHtmlResultInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleAppSearchesTaskGetHtmlResultInfo`
