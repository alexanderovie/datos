...
> **new MerchantGoogleProductsTaskGetAdvancedTaskInfo**(`data?`): `MerchantGoogleProductsTaskGetAdvancedTaskInfo`

Defined in: main.ts:199168
...
> `static` **fromJS**(`data`): `MerchantGoogleProductsTaskGetAdvancedTaskInfo`
