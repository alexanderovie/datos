...
> **new ContentAnalysisSummaryLiveResponseInfo**(`data`?): `ContentAnalysisSummaryLiveResponseInfo`

Defined in: main.ts:190527
...
> `static` **fromJS**(`data`): `ContentAnalysisSummaryLiveResponseInfo`

Defined in: main.ts:190546
