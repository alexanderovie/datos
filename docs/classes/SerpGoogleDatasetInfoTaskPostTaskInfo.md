...
> **new SerpGoogleDatasetInfoTaskPostTaskInfo**(`data?`): `SerpGoogleDatasetInfoTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetInfoTaskPostTaskInfo`

Defined in: main.ts:62004
