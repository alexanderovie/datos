...
> **new AppDataGoogleAppSearchesTasksReadyTaskInfo**(`data?`): `AppDataGoogleAppSearchesTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleAppSearchesTasksReadyTaskInfo`
