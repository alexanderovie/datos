...
> **new SerpGoogleOrganicTasksReadyResponseInfo**(`data`?): `SerpGoogleOrganicTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicTasksReadyResponseInfo`

Defined in: main.ts:29939
