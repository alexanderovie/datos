...
> **new DataforseoLabsGoogleCategoriesForDomainLiveResponseInfo**(`data?`): `DataforseoLabsGoogleCategoriesForDomainLiveResponseInfo`

Defined in: main.ts:108585
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleCategoriesForDomainLiveResponseInfo`

Defined in: main.ts:108604
