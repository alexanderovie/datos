...
> **new KeywordsDataGoogleTrendsExploreLiveResponseInfo**(`data?`): `KeywordsDataGoogleTrendsExploreLiveResponseInfo`

Defined in: main.ts:147329
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsExploreLiveResponseInfo`

Defined in: main.ts:147348
