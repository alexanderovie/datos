...
> **new SerpBingLocalPackLiveRegularResponseInfo**(`data?`): `SerpBingLocalPackLiveRegularResponseInfo`
...
> `static` **fromJS**(`data`): `SerpBingLocalPackLiveRegularResponseInfo`

Defined in: main.ts:71407
