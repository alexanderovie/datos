...
> **new KeywordsDataBingKeywordPerformanceTasksReadyTaskInfo**(`data`?): `KeywordsDataBingKeywordPerformanceTasksReadyTaskInfo`

Defined in: main.ts:156798
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordPerformanceTasksReadyTaskInfo`

Defined in: main.ts:156817
