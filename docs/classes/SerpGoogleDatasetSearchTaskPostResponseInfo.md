...
> **new SerpGoogleDatasetSearchTaskPostResponseInfo**(`data`?): `SerpGoogleDatasetSearchTaskPostResponseInfo`

Defined in: main.ts:60021
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetSearchTaskPostResponseInfo`

Defined in: main.ts:60040
