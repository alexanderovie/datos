...
> **new DataforseoLabsGoogleDomainIntersectionLiveResponseInfo**(`data?`): `DataforseoLabsGoogleDomainIntersectionLiveResponseInfo`

Defined in: main.ts:114533
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleDomainIntersectionLiveResponseInfo`
