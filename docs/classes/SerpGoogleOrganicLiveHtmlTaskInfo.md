...
> **new SerpGoogleOrganicLiveHtmlTaskInfo**(`data?`): `SerpGoogleOrganicLiveHtmlTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicLiveHtmlTaskInfo`

Defined in: main.ts:43348
