...
[Documentation](../README.md) / SerpYahooOrganicTaskGetHtmlTaskInfo
...
> **new SerpYahooOrganicTaskGetHtmlTaskInfo**(`data?`): `SerpYahooOrganicTaskGetHtmlTaskInfo`
...
> `static` **fromJS**(`data`): `SerpYahooOrganicTaskGetHtmlTaskInfo`
