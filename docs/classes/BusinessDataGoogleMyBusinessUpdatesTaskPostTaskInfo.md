...
> **new BusinessDataGoogleMyBusinessUpdatesTaskPostTaskInfo**(`data?`): `BusinessDataGoogleMyBusinessUpdatesTaskPostTaskInfo`

Defined in: main.ts:227703
...
> `static` **fromJS**(`data`): `BusinessDataGoogleMyBusinessUpdatesTaskPostTaskInfo`

Defined in: main.ts:227718
