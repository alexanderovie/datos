...
> **new SerpSeznamLocationsCountryResponseInfo**(`data?`): `SerpSeznamLocationsCountryResponseInfo`
...
> `static` **fromJS**(`data`): `SerpSeznamLocationsCountryResponseInfo`

Defined in: main.ts:85508
