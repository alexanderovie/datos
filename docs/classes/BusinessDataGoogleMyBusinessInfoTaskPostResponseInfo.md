...
> **new BusinessDataGoogleMyBusinessInfoTaskPostResponseInfo**(`data?`): `BusinessDataGoogleMyBusinessInfoTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleMyBusinessInfoTaskPostResponseInfo`

Defined in: main.ts:225604
