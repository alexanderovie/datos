...
> **new DataforseoLabsBingBulkKeywordDifficultyLiveTaskInfo**(`data?`): `DataforseoLabsBingBulkKeywordDifficultyLiveTaskInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsBingBulkKeywordDifficultyLiveTaskInfo`
