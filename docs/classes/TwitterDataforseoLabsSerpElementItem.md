...
> **new TwitterDataforseoLabsSerpElementItem**(`data?`): `TwitterDataforseoLabsSerpElementItem`

Defined in: main.ts:118330
...
> `static` **fromJS**(`data`): `TwitterDataforseoLabsSerpElementItem`

Defined in: main.ts:118352
