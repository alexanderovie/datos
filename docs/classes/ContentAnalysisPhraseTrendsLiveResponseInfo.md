...
> **new ContentAnalysisPhraseTrendsLiveResponseInfo**(`data`?): `ContentAnalysisPhraseTrendsLiveResponseInfo`

Defined in: main.ts:192105
...
> `static` **fromJS**(`data`): `ContentAnalysisPhraseTrendsLiveResponseInfo`

Defined in: main.ts:192124
