...
> **new MerchantGoogleProductsTaskPostResponseInfo**(`data`?): `MerchantGoogleProductsTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleProductsTaskPostResponseInfo`

Defined in: main.ts:197312
