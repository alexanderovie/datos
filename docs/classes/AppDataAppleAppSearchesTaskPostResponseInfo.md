...
> **new AppDataAppleAppSearchesTaskPostResponseInfo**(`data`?): `AppDataAppleAppSearchesTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `AppDataAppleAppSearchesTaskPostResponseInfo`

Defined in: main.ts:217342
