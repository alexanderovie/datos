...
> **new SerpGoogleDatasetInfoTaskPostResponseInfo**(`data`?): `SerpGoogleDatasetInfoTaskPostResponseInfo`

Defined in: main.ts:61923
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetInfoTaskPostResponseInfo`

Defined in: main.ts:61942
