...
> **new AppDataGoogleLanguagesResponseInfo**(`data`?): `AppDataGoogleLanguagesResponseInfo`

Defined in: main.ts:210991
...
> `static` **fromJS**(`data`): `AppDataGoogleLanguagesResponseInfo`
