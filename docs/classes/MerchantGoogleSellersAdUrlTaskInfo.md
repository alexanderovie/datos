...
> **new MerchantGoogleSellersAdUrlTaskInfo**(`data?`): `MerchantGoogleSellersAdUrlTaskInfo`

Defined in: main.ts:203266
...
> `static` **fromJS**(`data`): `MerchantGoogleSellersAdUrlTaskInfo`

Defined in: main.ts:203285
