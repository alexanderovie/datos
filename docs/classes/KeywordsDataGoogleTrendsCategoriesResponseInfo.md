...
> **new KeywordsDataGoogleTrendsCategoriesResponseInfo**(`data`?): `KeywordsDataGoogleTrendsCategoriesResponseInfo`

Defined in: main.ts:145139
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsCategoriesResponseInfo`

Defined in: main.ts:145158
