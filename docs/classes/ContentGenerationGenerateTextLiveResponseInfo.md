...
> **new ContentGenerationGenerateTextLiveResponseInfo**(`data?`): `ContentGenerationGenerateTextLiveResponseInfo`

Defined in: main.ts:194017
...
> `static` **fromJS**(`data`): `ContentGenerationGenerateTextLiveResponseInfo`

Defined in: main.ts:194036
