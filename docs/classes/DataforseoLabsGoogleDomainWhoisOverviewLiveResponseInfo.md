...
> **new DataforseoLabsGoogleDomainWhoisOverviewLiveResponseInfo**(`data`?): `DataforseoLabsGoogleDomainWhoisOverviewLiveResponseInfo`

Defined in: main.ts:111185
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleDomainWhoisOverviewLiveResponseInfo`

Defined in: main.ts:111204
