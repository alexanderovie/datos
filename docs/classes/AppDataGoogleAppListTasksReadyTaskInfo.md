...
> **new AppDataGoogleAppListTasksReadyTaskInfo**(`data?`): `AppDataGoogleAppListTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleAppListTasksReadyTaskInfo`

Defined in: main.ts:213241
