...
> **new SerpGoogleMapsTaskGetAdvancedResponseInfo**(`data?`): `SerpGoogleMapsTaskGetAdvancedResponseInfo`

Defined in: main.ts:45170
...
> `static` **fromJS**(`data`): `SerpGoogleMapsTaskGetAdvancedResponseInfo`

Defined in: main.ts:45189
