...
> **new AppDataAppleAppSearchesTaskGetAdvancedResponseInfo**(`data`?): `AppDataAppleAppSearchesTaskGetAdvancedResponseInfo`

Defined in: main.ts:217747
...
> `static` **fromJS**(`data`): `AppDataAppleAppSearchesTaskGetAdvancedResponseInfo`

Defined in: main.ts:217766
