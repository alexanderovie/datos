...
> **new KeywordsDataDataforseoTrendsSubregionInterestsLiveTaskInfo**(`data?`): `KeywordsDataDataforseoTrendsSubregionInterestsLiveTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataDataforseoTrendsSubregionInterestsLiveTaskInfo`
