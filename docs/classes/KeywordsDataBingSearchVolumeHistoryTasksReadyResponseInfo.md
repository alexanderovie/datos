...
> **new KeywordsDataBingSearchVolumeHistoryTasksReadyResponseInfo**(`data`?): `KeywordsDataBingSearchVolumeHistoryTasksReadyResponseInfo`

Defined in: main.ts:158443
...
> `static` **fromJS**(`data`): `KeywordsDataBingSearchVolumeHistoryTasksReadyResponseInfo`

Defined in: main.ts:158462
