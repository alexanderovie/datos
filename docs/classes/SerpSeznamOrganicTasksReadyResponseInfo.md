...
> **new SerpSeznamOrganicTasksReadyResponseInfo**(`data?`): `SerpSeznamOrganicTasksReadyResponseInfo`

Defined in: main.ts:86309
...
> `static` **fromJS**(`data`): `SerpSeznamOrganicTasksReadyResponseInfo`

Defined in: main.ts:86328
