...
> **new SerpBingOrganicTasksFixedTaskInfo**(`data`?): `SerpBingOrganicTasksFixedTaskInfo`

Defined in: main.ts:67041
...
> `static` **fromJS**(`data`): `SerpBingOrganicTasksFixedTaskInfo`

Defined in: main.ts:67060
