...
> **new SerpGoogleImagesLiveAdvancedResponseInfo**(`data`?): `SerpGoogleImagesLiveAdvancedResponseInfo`

Defined in: main.ts:54847
...
> `static` **fromJS**(`data`): `SerpGoogleImagesLiveAdvancedResponseInfo`

Defined in: main.ts:54866
