...
> **new MerchantAmazonReviewsTasksReadyTaskInfo**(`data?`): `MerchantAmazonReviewsTasksReadyTaskInfo`

Defined in: main.ts:209550
...
> `static` **fromJS**(`data`): `MerchantAmazonReviewsTasksReadyTaskInfo`
