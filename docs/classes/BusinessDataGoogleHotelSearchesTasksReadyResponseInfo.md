...
> **new BusinessDataGoogleHotelSearchesTasksReadyResponseInfo**(`data?`): `BusinessDataGoogleHotelSearchesTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelSearchesTasksReadyResponseInfo`

Defined in: main.ts:229186
