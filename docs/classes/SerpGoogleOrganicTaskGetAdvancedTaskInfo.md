...
> **new SerpGoogleOrganicTaskGetAdvancedTaskInfo**(`data?`): `SerpGoogleOrganicTaskGetAdvancedTaskInfo`

Defined in: main.ts:41229
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicTaskGetAdvancedTaskInfo`

Defined in: main.ts:41248
