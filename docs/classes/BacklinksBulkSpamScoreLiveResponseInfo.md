...
> **new BacklinksBulkSpamScoreLiveResponseInfo**(`data`?): `BacklinksBulkSpamScoreLiveResponseInfo`
...
> `static` **fromJS**(`data`): `BacklinksBulkSpamScoreLiveResponseInfo`

Defined in: main.ts:173176
