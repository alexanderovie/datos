...
> **new KeywordsDataBingKeywordsForSiteTaskPostResponseInfo**(`data?`): `KeywordsDataBingKeywordsForSiteTaskPostResponseInfo`

Defined in: main.ts:153841
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForSiteTaskPostResponseInfo`

Defined in: main.ts:153860
