...
> **new KeywordsDataGoogleTrendsExploreTaskGetTaskInfo**(`data?`): `KeywordsDataGoogleTrendsExploreTaskGetTaskInfo`

Defined in: main.ts:146228
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsExploreTaskGetTaskInfo`

Defined in: main.ts:146247
