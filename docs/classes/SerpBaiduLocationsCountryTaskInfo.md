...
> **new SerpBaiduLocationsCountryTaskInfo**(`data?`): `SerpBaiduLocationsCountryTaskInfo`
...
> `static` **fromJS**(`data`): `SerpBaiduLocationsCountryTaskInfo`

Defined in: main.ts:81623
