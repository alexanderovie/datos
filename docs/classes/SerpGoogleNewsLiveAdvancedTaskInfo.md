...
> **new SerpGoogleNewsLiveAdvancedTaskInfo**(`data?`): `SerpGoogleNewsLiveAdvancedTaskInfo`

Defined in: main.ts:50257
...
> `static` **fromJS**(`data`): `SerpGoogleNewsLiveAdvancedTaskInfo`
