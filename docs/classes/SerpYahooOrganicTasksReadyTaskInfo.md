...
[Documentation](../README.md) / SerpYahooOrganicTasksReadyTaskInfo

# Class: SerpYahooOrganicTasksReadyTaskInfo

Defined in: main.ts:78700
...
> **new SerpYahooOrganicTasksReadyTaskInfo**(`data?`): `SerpYahooOrganicTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `SerpYahooOrganicTasksReadyTaskInfo`
