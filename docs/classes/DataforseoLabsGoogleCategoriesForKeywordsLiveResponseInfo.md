...
> **new DataforseoLabsGoogleCategoriesForKeywordsLiveResponseInfo**(`data?`): `DataforseoLabsGoogleCategoriesForKeywordsLiveResponseInfo`

Defined in: main.ts:108947
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleCategoriesForKeywordsLiveResponseInfo`

Defined in: main.ts:108966
