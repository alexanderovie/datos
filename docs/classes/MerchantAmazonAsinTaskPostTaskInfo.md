...
[Documentation](../README.md) / MerchantAmazonAsinTaskPostTaskInfo
...
> **new MerchantAmazonAsinTaskPostTaskInfo**(`data?`): `MerchantAmazonAsinTaskPostTaskInfo`

Defined in: main.ts:205935
...
> `static` **fromJS**(`data`): `MerchantAmazonAsinTaskPostTaskInfo`

Defined in: main.ts:205950
