...
> **new DataforseoLabsGoogleRelatedKeywordsLiveResponseInfo**(`data`?): `DataforseoLabsGoogleRelatedKeywordsLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleRelatedKeywordsLiveResponseInfo`
