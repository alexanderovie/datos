...
> **new DataforseoLabsGoogleHistoricalRankOverviewLiveResponseInfo**(`data?`): `DataforseoLabsGoogleHistoricalRankOverviewLiveResponseInfo`

Defined in: main.ts:120741
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleHistoricalRankOverviewLiveResponseInfo`
