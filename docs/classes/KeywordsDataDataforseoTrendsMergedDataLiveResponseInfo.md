...
> **new KeywordsDataDataforseoTrendsMergedDataLiveResponseInfo**(`data?`): `KeywordsDataDataforseoTrendsMergedDataLiveResponseInfo`

Defined in: main.ts:150169
...
> `static` **fromJS**(`data`): `KeywordsDataDataforseoTrendsMergedDataLiveResponseInfo`
