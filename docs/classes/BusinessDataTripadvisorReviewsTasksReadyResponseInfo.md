...
> **new BusinessDataTripadvisorReviewsTasksReadyResponseInfo**(`data`?): `BusinessDataTripadvisorReviewsTasksReadyResponseInfo`

Defined in: main.ts:240895
...
> `static` **fromJS**(`data`): `BusinessDataTripadvisorReviewsTasksReadyResponseInfo`

Defined in: main.ts:240914
