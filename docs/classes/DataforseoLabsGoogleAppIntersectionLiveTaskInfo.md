...
> **new DataforseoLabsGoogleAppIntersectionLiveTaskInfo**(`data?`): `DataforseoLabsGoogleAppIntersectionLiveTaskInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleAppIntersectionLiveTaskInfo`

Defined in: main.ts:135079
