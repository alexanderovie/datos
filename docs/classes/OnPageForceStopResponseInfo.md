...
> **new OnPageForceStopResponseInfo**(`data`?): `OnPageForceStopResponseInfo`

Defined in: main.ts:175715
...
> `static` **fromJS**(`data`): `OnPageForceStopResponseInfo`
