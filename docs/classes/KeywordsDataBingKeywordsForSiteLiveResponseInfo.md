...
> **new KeywordsDataBingKeywordsForSiteLiveResponseInfo**(`data`?): `KeywordsDataBingKeywordsForSiteLiveResponseInfo`

Defined in: main.ts:154673
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForSiteLiveResponseInfo`

Defined in: main.ts:154692
