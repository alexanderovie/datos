...
> **new SerpBingLocalPackTaskGetHtmlResponseInfo**(`data`?): `SerpBingLocalPackTaskGetHtmlResponseInfo`

Defined in: main.ts:70774
...
> `static` **fromJS**(`data`): `SerpBingLocalPackTaskGetHtmlResponseInfo`

Defined in: main.ts:70793
