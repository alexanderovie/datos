...
> **new BacklinksPageIntersectionLiveResponseInfo**(`data?`): `BacklinksPageIntersectionLiveResponseInfo`

Defined in: main.ts:171511
...
> `static` **fromJS**(`data`): `BacklinksPageIntersectionLiveResponseInfo`
