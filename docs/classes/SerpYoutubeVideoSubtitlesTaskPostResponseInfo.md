...
> **new SerpYoutubeVideoSubtitlesTaskPostResponseInfo**(`data`?): `SerpYoutubeVideoSubtitlesTaskPostResponseInfo`

Defined in: main.ts:74587
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoSubtitlesTaskPostResponseInfo`

Defined in: main.ts:74606
