...
> **new BusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo**(`data?`): `BusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo`

Defined in: main.ts:224630
...
> `static` **fromJS**(`data`): `BusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo`

Defined in: main.ts:224649
