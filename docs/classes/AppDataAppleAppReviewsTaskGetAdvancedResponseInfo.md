...
> **new AppDataAppleAppReviewsTaskGetAdvancedResponseInfo**(`data?`): `AppDataAppleAppReviewsTaskGetAdvancedResponseInfo`

Defined in: main.ts:220947
...
> `static` **fromJS**(`data`): `AppDataAppleAppReviewsTaskGetAdvancedResponseInfo`
