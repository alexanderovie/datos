...
> **new DataforseoLabsGoogleBulkAppMetricsLiveResponseInfo**(`data?`): `DataforseoLabsGoogleBulkAppMetricsLiveResponseInfo`

Defined in: main.ts:133213
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleBulkAppMetricsLiveResponseInfo`
