...
> **new AppDataGoogleAppInfoTaskGetAdvancedResponseInfo**(`data?`): `AppDataGoogleAppInfoTaskGetAdvancedResponseInfo`

Defined in: main.ts:214813
...
> `static` **fromJS**(`data`): `AppDataGoogleAppInfoTaskGetAdvancedResponseInfo`

Defined in: main.ts:214832
