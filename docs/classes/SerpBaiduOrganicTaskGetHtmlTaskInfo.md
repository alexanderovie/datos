...
[Documentation](../README.md) / SerpBaiduOrganicTaskGetHtmlTaskInfo

# Class: SerpBaiduOrganicTaskGetHtmlTaskInfo

Defined in: main.ts:83500
...
> **new SerpBaiduOrganicTaskGetHtmlTaskInfo**(`data?`): `SerpBaiduOrganicTaskGetHtmlTaskInfo`
...
> `static` **fromJS**(`data`): `SerpBaiduOrganicTaskGetHtmlTaskInfo`
