...
> **new SerpGoogleFinanceQuoteTaskGetHtmlResponseInfo**(`data`?): `SerpGoogleFinanceQuoteTaskGetHtmlResponseInfo`

Defined in: main.ts:93215
...
> `static` **fromJS**(`data`): `SerpGoogleFinanceQuoteTaskGetHtmlResponseInfo`
