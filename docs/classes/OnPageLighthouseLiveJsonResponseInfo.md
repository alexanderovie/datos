...
> **new OnPageLighthouseLiveJsonResponseInfo**(`data`?): `OnPageLighthouseLiveJsonResponseInfo`

Defined in: main.ts:187993
...
> `static` **fromJS**(`data`): `OnPageLighthouseLiveJsonResponseInfo`

Defined in: main.ts:188012
