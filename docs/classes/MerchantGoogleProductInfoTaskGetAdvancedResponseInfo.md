...
> **new MerchantGoogleProductInfoTaskGetAdvancedResponseInfo**(`data?`): `MerchantGoogleProductInfoTaskGetAdvancedResponseInfo`

Defined in: main.ts:203139
...
> `static` **fromJS**(`data`): `MerchantGoogleProductInfoTaskGetAdvancedResponseInfo`
