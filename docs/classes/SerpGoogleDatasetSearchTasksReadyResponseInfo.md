...
> **new SerpGoogleDatasetSearchTasksReadyResponseInfo**(`data`?): `SerpGoogleDatasetSearchTasksReadyResponseInfo`

Defined in: main.ts:60233
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetSearchTasksReadyResponseInfo`

Defined in: main.ts:60252
