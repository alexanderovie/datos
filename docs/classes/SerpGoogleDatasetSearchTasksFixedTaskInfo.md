...
> **new SerpGoogleDatasetSearchTasksFixedTaskInfo**(`data?`): `SerpGoogleDatasetSearchTasksFixedTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetSearchTasksFixedTaskInfo`
