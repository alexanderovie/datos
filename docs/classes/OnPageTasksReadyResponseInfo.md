...
> **new OnPageTasksReadyResponseInfo**(`data`?): `OnPageTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `OnPageTasksReadyResponseInfo`

Defined in: main.ts:177070
