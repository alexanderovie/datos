...
> **new MerchantAmazonLocationsCountryTaskInfo**(`data?`): `MerchantAmazonLocationsCountryTaskInfo`

Defined in: main.ts:203650
...
> `static` **fromJS**(`data`): `MerchantAmazonLocationsCountryTaskInfo`

Defined in: main.ts:203669
