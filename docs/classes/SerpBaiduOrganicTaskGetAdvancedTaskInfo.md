...
> **new SerpBaiduOrganicTaskGetAdvancedTaskInfo**(`data?`): `SerpBaiduOrganicTaskGetAdvancedTaskInfo`

Defined in: main.ts:83288
...
> `static` **fromJS**(`data`): `SerpBaiduOrganicTaskGetAdvancedTaskInfo`

Defined in: main.ts:83307
