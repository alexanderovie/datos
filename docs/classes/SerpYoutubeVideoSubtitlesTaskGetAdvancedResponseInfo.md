...
> **new SerpYoutubeVideoSubtitlesTaskGetAdvancedResponseInfo**(`data`?): `SerpYoutubeVideoSubtitlesTaskGetAdvancedResponseInfo`

Defined in: main.ts:75367
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoSubtitlesTaskGetAdvancedResponseInfo`
