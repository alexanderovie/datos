...
> **new SerpGoogleSearchByImageTasksFixedResponseInfo**(`data?`): `SerpGoogleSearchByImageTasksFixedResponseInfo`

Defined in: main.ts:56301
...
> `static` **fromJS**(`data`): `SerpGoogleSearchByImageTasksFixedResponseInfo`
