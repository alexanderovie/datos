...
[Documentation](../README.md) / BusinessDataGoogleMyBusinessInfoTaskGetTaskInfo
...
> **new BusinessDataGoogleMyBusinessInfoTaskGetTaskInfo**(`data?`): `BusinessDataGoogleMyBusinessInfoTaskGetTaskInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleMyBusinessInfoTaskGetTaskInfo`
