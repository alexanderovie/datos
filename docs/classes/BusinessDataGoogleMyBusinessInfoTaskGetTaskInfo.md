...
### new BusinessDataGoogleMyBusinessInfoTaskGetTaskInfo()
...
> `static` **fromJS**(`data`): [`BusinessDataGoogleMyBusinessInfoTaskGetTaskInfo`](BusinessDataGoogleMyBusinessInfoTaskGetTaskInfo.md)
