...
> **new DataforseoLabsAmazonRankedKeywordsLiveResponseInfo**(`data?`): `DataforseoLabsAmazonRankedKeywordsLiveResponseInfo`

Defined in: main.ts:125501
...
> `static` **fromJS**(`data`): `DataforseoLabsAmazonRankedKeywordsLiveResponseInfo`

Defined in: main.ts:125520
