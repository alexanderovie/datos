...
> **new DataforseoLabsGoogleAppCompetitorsLiveTaskInfo**(`data?`): `DataforseoLabsGoogleAppCompetitorsLiveTaskInfo`

Defined in: main.ts:134484
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleAppCompetitorsLiveTaskInfo`
