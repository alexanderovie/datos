...
> **new MerchantAmazonReviewsTasksReadyResponseInfo**(`data?`): `MerchantAmazonReviewsTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonReviewsTasksReadyResponseInfo`
