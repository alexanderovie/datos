...
> **new BacklinksBulkBacklinksLiveResponseInfo**(`data`?): `BacklinksBulkBacklinksLiveResponseInfo`

Defined in: main.ts:172813
...
> `static` **fromJS**(`data`): `BacklinksBulkBacklinksLiveResponseInfo`

Defined in: main.ts:172832
