...
### new SerpGoogleFinanceQuoteLiveAdvancedResponseInfo()

> **new SerpGoogleFinanceQuoteLiveAdvancedResponseInfo**(`data`?): [`SerpGoogleFinanceQuoteLiveAdvancedResponseInfo`](SerpGoogleFinanceQuoteLiveAdvancedResponseInfo.md)
...
> `static` **fromJS**(`data`): [`SerpGoogleFinanceQuoteLiveAdvancedResponseInfo`](SerpGoogleFinanceQuoteLiveAdvancedResponseInfo.md)
