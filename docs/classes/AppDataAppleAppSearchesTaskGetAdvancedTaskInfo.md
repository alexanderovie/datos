...
> **new AppDataAppleAppSearchesTaskGetAdvancedTaskInfo**(`data?`): `AppDataAppleAppSearchesTaskGetAdvancedTaskInfo`

Defined in: main.ts:218222
...
> `static` **fromJS**(`data`): `AppDataAppleAppSearchesTaskGetAdvancedTaskInfo`

Defined in: main.ts:218241
