...
> **new DataforseoLabsGoogleBulkTrafficEstimationLiveResponseInfo**(`data`?): `DataforseoLabsGoogleBulkTrafficEstimationLiveResponseInfo`

Defined in: main.ts:121905
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleBulkTrafficEstimationLiveResponseInfo`
