...
> **new SerpGoogleOrganicTaskPostResponseInfo**(`data`?): `SerpGoogleOrganicTaskPostResponseInfo`

Defined in: main.ts:29708
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicTaskPostResponseInfo`

Defined in: main.ts:29727
