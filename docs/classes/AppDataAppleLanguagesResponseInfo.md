...
> **new AppDataAppleLanguagesResponseInfo**(`data?`): `AppDataAppleLanguagesResponseInfo`

Defined in: main.ts:217507
...
> `static` **fromJS**(`data`): `AppDataAppleLanguagesResponseInfo`

Defined in: main.ts:217526
