...
> **new MerchantGoogleProductSpecTasksReadyTaskInfo**(`data?`): `MerchantGoogleProductSpecTasksReadyTaskInfo`

Defined in: main.ts:201384
...
> `static` **fromJS**(`data`): `MerchantGoogleProductSpecTasksReadyTaskInfo`
