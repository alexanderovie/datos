...
> **new KeywordsDataBingSearchVolumeTasksReadyResponseInfo**(`data?`): `KeywordsDataBingSearchVolumeTasksReadyResponseInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataBingSearchVolumeTasksReadyResponseInfo`

Defined in: main.ts:151134
