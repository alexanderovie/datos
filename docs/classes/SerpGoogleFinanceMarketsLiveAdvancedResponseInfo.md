...
> **new SerpGoogleFinanceMarketsLiveAdvancedResponseInfo**(`data`?): `SerpGoogleFinanceMarketsLiveAdvancedResponseInfo`

Defined in: main.ts:91721
...
> `static` **fromJS**(`data`): `SerpGoogleFinanceMarketsLiveAdvancedResponseInfo`

Defined in: main.ts:91740
