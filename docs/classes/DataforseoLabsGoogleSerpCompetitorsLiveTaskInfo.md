...
> **new DataforseoLabsGoogleSerpCompetitorsLiveTaskInfo**(`data?`): `DataforseoLabsGoogleSerpCompetitorsLiveTaskInfo`

Defined in: main.ts:113126
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleSerpCompetitorsLiveTaskInfo`
