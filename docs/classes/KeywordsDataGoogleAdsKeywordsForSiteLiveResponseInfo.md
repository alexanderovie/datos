...
> **new KeywordsDataGoogleAdsKeywordsForSiteLiveResponseInfo**(`data`?): `KeywordsDataGoogleAdsKeywordsForSiteLiveResponseInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsKeywordsForSiteLiveResponseInfo`

Defined in: main.ts:141518
