...
> **new SerpGoogleNewsTaskGetAdvancedTaskInfo**(`data?`): `SerpGoogleNewsTaskGetAdvancedTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleNewsTaskGetAdvancedTaskInfo`

Defined in: main.ts:49486
