...
> **new MerchantGoogleProductSpecTaskPostTaskInfo**(`data?`): `MerchantGoogleProductSpecTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleProductSpecTaskPostTaskInfo`

Defined in: main.ts:201206
