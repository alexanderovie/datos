...
> **new KeywordsDataDataforseoTrendsLocationsCountryResponseInfo**(`data?`): `KeywordsDataDataforseoTrendsLocationsCountryResponseInfo`

Defined in: main.ts:147761
...
> `static` **fromJS**(`data`): `KeywordsDataDataforseoTrendsLocationsCountryResponseInfo`
