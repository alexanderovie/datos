...
> **new KeywordsDataBingSearchVolumeHistoryLiveResponseInfo**(`data`?): `KeywordsDataBingSearchVolumeHistoryLiveResponseInfo`

Defined in: main.ts:159279
...
> `static` **fromJS**(`data`): `KeywordsDataBingSearchVolumeHistoryLiveResponseInfo`

Defined in: main.ts:159298
