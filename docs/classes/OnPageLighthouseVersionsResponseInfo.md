...
> **new OnPageLighthouseVersionsResponseInfo**(`data`?): `OnPageLighthouseVersionsResponseInfo`

Defined in: main.ts:187059
...
> `static` **fromJS**(`data`): `OnPageLighthouseVersionsResponseInfo`
