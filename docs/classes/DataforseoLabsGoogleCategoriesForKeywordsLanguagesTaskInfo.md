...
> **new DataforseoLabsGoogleCategoriesForKeywordsLanguagesTaskInfo**(`data?`): `DataforseoLabsGoogleCategoriesForKeywordsLanguagesTaskInfo`

Defined in: main.ts:107686
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleCategoriesForKeywordsLanguagesTaskInfo`
