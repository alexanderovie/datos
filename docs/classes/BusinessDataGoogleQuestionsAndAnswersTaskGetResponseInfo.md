...
> **new BusinessDataGoogleQuestionsAndAnswersTaskGetResponseInfo**(`data?`): `BusinessDataGoogleQuestionsAndAnswersTaskGetResponseInfo`
...
> `static` **fromJS**(`data`): `BusinessDataGoogleQuestionsAndAnswersTaskGetResponseInfo`

Defined in: main.ts:237282
