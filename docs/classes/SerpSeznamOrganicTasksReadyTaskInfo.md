...
> **new SerpSeznamOrganicTasksReadyTaskInfo**(`data?`): `SerpSeznamOrganicTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `SerpSeznamOrganicTasksReadyTaskInfo`

Defined in: main.ts:86273
