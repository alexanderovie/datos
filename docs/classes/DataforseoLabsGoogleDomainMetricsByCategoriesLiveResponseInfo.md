...
> **new DataforseoLabsGoogleDomainMetricsByCategoriesLiveResponseInfo**(`data?`): `DataforseoLabsGoogleDomainMetricsByCategoriesLiveResponseInfo`

Defined in: main.ts:110253
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleDomainMetricsByCategoriesLiveResponseInfo`

Defined in: main.ts:110272
