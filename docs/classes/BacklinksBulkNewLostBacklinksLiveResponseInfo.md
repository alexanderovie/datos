...
> **new BacklinksBulkNewLostBacklinksLiveResponseInfo**(`data?`): `BacklinksBulkNewLostBacklinksLiveResponseInfo`

Defined in: main.ts:174277
...
> `static` **fromJS**(`data`): `BacklinksBulkNewLostBacklinksLiveResponseInfo`

Defined in: main.ts:174296
