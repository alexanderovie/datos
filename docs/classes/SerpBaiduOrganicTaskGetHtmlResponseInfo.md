...
> **new SerpBaiduOrganicTaskGetHtmlResponseInfo**(`data?`): `SerpBaiduOrganicTaskGetHtmlResponseInfo`

Defined in: main.ts:83561
...
> `static` **fromJS**(`data`): `SerpBaiduOrganicTaskGetHtmlResponseInfo`

Defined in: main.ts:83580
