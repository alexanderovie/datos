...
> **new KeywordsDataGoogleTrendsExploreTaskGetResponseInfo**(`data?`): `KeywordsDataGoogleTrendsExploreTaskGetResponseInfo`

Defined in: main.ts:146619
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsExploreTaskGetResponseInfo`
