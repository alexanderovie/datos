...
> **new MerchantGoogleProductSpecTaskGetAdvancedTaskInfo**(`data?`): `MerchantGoogleProductSpecTaskGetAdvancedTaskInfo`

Defined in: main.ts:201732
...
> `static` **fromJS**(`data`): `MerchantGoogleProductSpecTaskGetAdvancedTaskInfo`
