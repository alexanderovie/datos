...
> **new ContentAnalysisRatingDistributionLiveResponseInfo**(`data`?): `ContentAnalysisRatingDistributionLiveResponseInfo`

Defined in: main.ts:191501
...
> `static` **fromJS**(`data`): `ContentAnalysisRatingDistributionLiveResponseInfo`

Defined in: main.ts:191520
