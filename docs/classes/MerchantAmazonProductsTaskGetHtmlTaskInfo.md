...
> **new MerchantAmazonProductsTaskGetHtmlTaskInfo**(`data?`): `MerchantAmazonProductsTaskGetHtmlTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantAmazonProductsTaskGetHtmlTaskInfo`

Defined in: main.ts:205563
