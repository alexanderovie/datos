...
> **new DataforseoLabsGoogleKeywordIdeasLiveResultInfo**(`data`?): `DataforseoLabsGoogleKeywordIdeasLiveResultInfo`

Defined in: main.ts:106403
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleKeywordIdeasLiveResultInfo`
