...
> **new AppDataGoogleCategoriesTaskInfo**(`data?`): `AppDataGoogleCategoriesTaskInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleCategoriesTaskInfo`

Defined in: main.ts:210927
