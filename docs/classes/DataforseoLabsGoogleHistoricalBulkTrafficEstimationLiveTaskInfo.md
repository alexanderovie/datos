...
> **new DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveTaskInfo**(`data?`): `DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveTaskInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveTaskInfo`

Defined in: main.ts:122663
