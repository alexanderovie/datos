...
> **new KeywordsDataClickstreamDataGlobalSearchVolumeLiveResponseInfo**(`data?`): `KeywordsDataClickstreamDataGlobalSearchVolumeLiveResponseInfo`

Defined in: main.ts:160445
...
> `static` **fromJS**(`data`): `KeywordsDataClickstreamDataGlobalSearchVolumeLiveResponseInfo`

Defined in: main.ts:160464
