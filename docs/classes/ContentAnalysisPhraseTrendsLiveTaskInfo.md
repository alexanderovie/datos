...
> **new ContentAnalysisPhraseTrendsLiveTaskInfo**(`data`?): `ContentAnalysisPhraseTrendsLiveTaskInfo`

Defined in: main.ts:192050
...
> `static` **fromJS**(`data`): `ContentAnalysisPhraseTrendsLiveTaskInfo`

Defined in: main.ts:192069
