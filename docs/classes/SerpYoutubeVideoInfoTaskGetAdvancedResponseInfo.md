...
> **new SerpYoutubeVideoInfoTaskGetAdvancedResponseInfo**(`data`?): `SerpYoutubeVideoInfoTaskGetAdvancedResponseInfo`
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoInfoTaskGetAdvancedResponseInfo`

Defined in: main.ts:73834
