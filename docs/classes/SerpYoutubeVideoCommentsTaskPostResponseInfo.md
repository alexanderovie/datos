...
[Documentation](../README.md) / SerpYoutubeVideoCommentsTaskPostResponseInfo
...
> **new SerpYoutubeVideoCommentsTaskPostResponseInfo**(`data?`): `SerpYoutubeVideoCommentsTaskPostResponseInfo`

Defined in: main.ts:76307
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoCommentsTaskPostResponseInfo`

Defined in: main.ts:76326
