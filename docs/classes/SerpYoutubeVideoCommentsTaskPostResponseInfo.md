...
### new SerpYoutubeVideoCommentsTaskPostResponseInfo()
...
> `static` **fromJS**(`data`): [`SerpYoutubeVideoCommentsTaskPostResponseInfo`](SerpYoutubeVideoCommentsTaskPostResponseInfo.md)

Defined in: main.ts:75787
