...
> **new MerchantGoogleProductInfoTasksReadyTaskInfo**(`data?`): `MerchantGoogleProductInfoTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleProductInfoTasksReadyTaskInfo`

Defined in: main.ts:202541
