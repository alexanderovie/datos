...
> **new KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostResponseInfo**(`data`?): `KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostResponseInfo`

Defined in: main.ts:141911
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostResponseInfo`
