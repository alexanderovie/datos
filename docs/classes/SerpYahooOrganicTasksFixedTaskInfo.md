...
> **new SerpYahooOrganicTasksFixedTaskInfo**(`data?`): `SerpYahooOrganicTasksFixedTaskInfo`

Defined in: main.ts:78918
...
> `static` **fromJS**(`data`): `SerpYahooOrganicTasksFixedTaskInfo`

Defined in: main.ts:78937
