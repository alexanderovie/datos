...
> **new ContentGenerationGenerateSubTopicsLiveResponseInfo**(`data?`): `ContentGenerationGenerateSubTopicsLiveResponseInfo`

Defined in: main.ts:194561
...
> `static` **fromJS**(`data`): `ContentGenerationGenerateSubTopicsLiveResponseInfo`

Defined in: main.ts:194580
