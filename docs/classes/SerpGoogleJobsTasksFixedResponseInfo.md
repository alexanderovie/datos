...
> **new SerpGoogleJobsTasksFixedResponseInfo**(`data`?): `SerpGoogleJobsTasksFixedResponseInfo`

Defined in: main.ts:57289
...
> `static` **fromJS**(`data`): `SerpGoogleJobsTasksFixedResponseInfo`

Defined in: main.ts:57308
