...
> **new MerchantGoogleSellersTaskGetHtmlResponseInfo**(`data`?): `MerchantGoogleSellersTaskGetHtmlResponseInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleSellersTaskGetHtmlResponseInfo`

Defined in: main.ts:200328
