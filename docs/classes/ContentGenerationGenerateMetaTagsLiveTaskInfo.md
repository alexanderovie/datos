...
> **new ContentGenerationGenerateMetaTagsLiveTaskInfo**(`data?`): `ContentGenerationGenerateMetaTagsLiveTaskInfo`

Defined in: main.ts:194234
...
> `static` **fromJS**(`data`): `ContentGenerationGenerateMetaTagsLiveTaskInfo`

Defined in: main.ts:194253
