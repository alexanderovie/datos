...
> **new KeywordsDataGoogleAdsStatusTaskInfo**(`data?`): `KeywordsDataGoogleAdsStatusTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsStatusTaskInfo`

Defined in: main.ts:138053
