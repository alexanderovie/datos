...
> **new SerpGoogleFinanceMarketsLiveHtmlResponseInfo**(`data`?): `SerpGoogleFinanceMarketsLiveHtmlResponseInfo`

Defined in: main.ts:92093
...
> `static` **fromJS**(`data`): `SerpGoogleFinanceMarketsLiveHtmlResponseInfo`

Defined in: main.ts:92112
