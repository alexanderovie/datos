...
### new SerpGoogleFinanceMarketsTaskPostResponseInfo()

> **new SerpGoogleFinanceMarketsTaskPostResponseInfo**(`data`?): [`SerpGoogleFinanceMarketsTaskPostResponseInfo`](SerpGoogleFinanceMarketsTaskPostResponseInfo.md)
...
> `static` **fromJS**(`data`): [`SerpGoogleFinanceMarketsTaskPostResponseInfo`](SerpGoogleFinanceMarketsTaskPostResponseInfo.md)

Defined in: main.ts:90193
