...
> **new SerpIdListResponseInfo**(`data?`): `SerpIdListResponseInfo`

Defined in: main.ts:27534
...
> `static` **fromJS**(`data`): `SerpIdListResponseInfo`

Defined in: main.ts:27553
