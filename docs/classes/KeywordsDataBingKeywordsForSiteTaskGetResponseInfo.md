...
> **new KeywordsDataBingKeywordsForSiteTaskGetResponseInfo**(`data`?): `KeywordsDataBingKeywordsForSiteTaskGetResponseInfo`

Defined in: main.ts:154173
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForSiteTaskGetResponseInfo`
