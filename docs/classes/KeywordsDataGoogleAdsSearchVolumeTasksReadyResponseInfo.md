...
> **new KeywordsDataGoogleAdsSearchVolumeTasksReadyResponseInfo**(`data?`): `KeywordsDataGoogleAdsSearchVolumeTasksReadyResponseInfo`

Defined in: main.ts:139251
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsSearchVolumeTasksReadyResponseInfo`

Defined in: main.ts:139270
