...
> **new SerpYoutubeVideoInfoTasksFixedResponseInfo**(`data?`): `SerpYoutubeVideoInfoTasksFixedResponseInfo`

Defined in: main.ts:73182
...
> `static` **fromJS**(`data`): `SerpYoutubeVideoInfoTasksFixedResponseInfo`

Defined in: main.ts:73201
