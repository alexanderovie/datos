...
> **new OnPageContentParsingResponseInfo**(`data?`): `OnPageContentParsingResponseInfo`

Defined in: main.ts:185871
...
> `static` **fromJS**(`data`): `OnPageContentParsingResponseInfo`

Defined in: main.ts:185890
