...
> **new KeywordsDataBingAudienceEstimationIndustriesResponseInfo**(`data?`): `KeywordsDataBingAudienceEstimationIndustriesResponseInfo`

Defined in: main.ts:152211
...
> `static` **fromJS**(`data`): `KeywordsDataBingAudienceEstimationIndustriesResponseInfo`

Defined in: main.ts:152230
