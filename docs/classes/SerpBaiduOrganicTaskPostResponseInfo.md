...
> **new SerpBaiduOrganicTaskPostResponseInfo**(`data?`): `SerpBaiduOrganicTaskPostResponseInfo`

Defined in: main.ts:82253
...
> `static` **fromJS**(`data`): `SerpBaiduOrganicTaskPostResponseInfo`

Defined in: main.ts:82272
