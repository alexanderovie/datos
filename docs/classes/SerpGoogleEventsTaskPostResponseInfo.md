...
> **new SerpGoogleEventsTaskPostResponseInfo**(`data`?): `SerpGoogleEventsTaskPostResponseInfo`

Defined in: main.ts:51102
...
> `static` **fromJS**(`data`): `SerpGoogleEventsTaskPostResponseInfo`

Defined in: main.ts:51121
