...
> **new BusinessDataGoogleLocationsCountryTaskInfo**(`data?`): `BusinessDataGoogleLocationsCountryTaskInfo`

Defined in: main.ts:225014
...
> `static` **fromJS**(`data`): `BusinessDataGoogleLocationsCountryTaskInfo`
