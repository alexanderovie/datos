...
> **new SerpGoogleSearchByImageTasksReadyResponseInfo**(`data`?): `SerpGoogleSearchByImageTasksReadyResponseInfo`

Defined in: main.ts:55975
...
> `static` **fromJS**(`data`): `SerpGoogleSearchByImageTasksReadyResponseInfo`
