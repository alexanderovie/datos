...
> **new OnPageLighthouseTaskPostTaskInfo**(`data?`): `OnPageLighthouseTaskPostTaskInfo`

Defined in: main.ts:187759
...
> `static` **fromJS**(`data`): `OnPageLighthouseTaskPostTaskInfo`
