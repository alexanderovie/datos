...
> **new SerpYahooOrganicLiveAdvancedResultInfo**(`data`?): `SerpYahooOrganicLiveAdvancedResultInfo`

Defined in: main.ts:80518
...
> `static` **fromJS**(`data`): `SerpYahooOrganicLiveAdvancedResultInfo`

Defined in: main.ts:80557
