...
> **new SerpGoogleDatasetInfoTaskGetAdvancedTaskInfo**(`data?`): `SerpGoogleDatasetInfoTaskGetAdvancedTaskInfo`

Defined in: main.ts:62658
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetInfoTaskGetAdvancedTaskInfo`

Defined in: main.ts:62677
