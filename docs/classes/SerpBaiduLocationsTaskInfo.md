...
> **new SerpBaiduLocationsTaskInfo**(`data?`): `SerpBaiduLocationsTaskInfo`
...
> `static` **fromJS**(`data`): `SerpBaiduLocationsTaskInfo`

Defined in: main.ts:81433
