...
> **new BusinessDataGoogleHotelInfoLiveAdvancedResponseInfo**(`data`?): `BusinessDataGoogleHotelInfoLiveAdvancedResponseInfo`

Defined in: main.ts:232731
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelInfoLiveAdvancedResponseInfo`

Defined in: main.ts:232750
