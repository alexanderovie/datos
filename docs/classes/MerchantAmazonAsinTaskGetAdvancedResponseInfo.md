...
> **new MerchantAmazonAsinTaskGetAdvancedResponseInfo**(`data?`): `MerchantAmazonAsinTaskGetAdvancedResponseInfo`

Defined in: main.ts:207449
...
> `static` **fromJS**(`data`): `MerchantAmazonAsinTaskGetAdvancedResponseInfo`
