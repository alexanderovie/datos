...
> **new DataforseoLabsAmazonProductRankOverviewLiveResponseInfo**(`data?`): `DataforseoLabsAmazonProductRankOverviewLiveResponseInfo`

Defined in: main.ts:126059
...
> `static` **fromJS**(`data`): `DataforseoLabsAmazonProductRankOverviewLiveResponseInfo`

Defined in: main.ts:126078
