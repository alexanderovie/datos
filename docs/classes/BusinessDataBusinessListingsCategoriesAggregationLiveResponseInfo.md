...
> **new BusinessDataBusinessListingsCategoriesAggregationLiveResponseInfo**(`data`?): `BusinessDataBusinessListingsCategoriesAggregationLiveResponseInfo`

Defined in: main.ts:224155
...
> `static` **fromJS**(`data`): `BusinessDataBusinessListingsCategoriesAggregationLiveResponseInfo`
