...
> **new SerpGoogleDatasetInfoTasksFixedResponseInfo**(`data`?): `SerpGoogleDatasetInfoTasksFixedResponseInfo`

Defined in: main.ts:62347
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetInfoTasksFixedResponseInfo`

Defined in: main.ts:62366
