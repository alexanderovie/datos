...
> **new DataforseoLabsGoogleAppCompetitorsLiveResponseInfo**(`data?`): `DataforseoLabsGoogleAppCompetitorsLiveResponseInfo`

Defined in: main.ts:134539
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleAppCompetitorsLiveResponseInfo`

Defined in: main.ts:134558
