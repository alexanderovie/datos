...
> **new MerchantGoogleSellersTaskGetHtmlTaskInfo**(`data?`): `MerchantGoogleSellersTaskGetHtmlTaskInfo`

Defined in: main.ts:200784
...
> `static` **fromJS**(`data`): `MerchantGoogleSellersTaskGetHtmlTaskInfo`
