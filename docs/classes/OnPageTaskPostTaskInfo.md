...
> **new OnPageTaskPostTaskInfo**(`data?`): `OnPageTaskPostTaskInfo`

Defined in: main.ts:177233
...
> `static` **fromJS**(`data`): `OnPageTaskPostTaskInfo`
