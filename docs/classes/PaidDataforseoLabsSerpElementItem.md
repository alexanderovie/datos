...
> **new PaidDataforseoLabsSerpElementItem**(`data?`): `PaidDataforseoLabsSerpElementItem`

Defined in: main.ts:118813
...
> `static` **fromJS**(`data`): `PaidDataforseoLabsSerpElementItem`

Defined in: main.ts:118865
