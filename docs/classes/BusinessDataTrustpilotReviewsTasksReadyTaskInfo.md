...
[Documentation](../README.md) / BusinessDataTrustpilotReviewsTasksReadyTaskInfo
...
> **new BusinessDataTrustpilotReviewsTasksReadyTaskInfo**(`data?`): `BusinessDataTrustpilotReviewsTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `BusinessDataTrustpilotReviewsTasksReadyTaskInfo`
