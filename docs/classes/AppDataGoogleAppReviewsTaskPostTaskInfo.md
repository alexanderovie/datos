...
> **new AppDataGoogleAppReviewsTaskPostTaskInfo**(`data?`): `AppDataGoogleAppReviewsTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleAppReviewsTaskPostTaskInfo`

Defined in: main.ts:215372
