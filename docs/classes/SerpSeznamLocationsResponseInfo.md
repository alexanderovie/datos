...
> **new SerpSeznamLocationsResponseInfo**(`data?`): `SerpSeznamLocationsResponseInfo`

Defined in: main.ts:85301
...
> `static` **fromJS**(`data`): `SerpSeznamLocationsResponseInfo`

Defined in: main.ts:85320
