...
> **new KeywordsDataGoogleAdsSearchVolumeTaskGetTaskInfo**(`data?`): `KeywordsDataGoogleAdsSearchVolumeTaskGetTaskInfo`

Defined in: main.ts:139474
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsSearchVolumeTaskGetTaskInfo`
