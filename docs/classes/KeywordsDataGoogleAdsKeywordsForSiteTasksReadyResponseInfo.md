...
> **new KeywordsDataGoogleAdsKeywordsForSiteTasksReadyResponseInfo**(`data`?): `KeywordsDataGoogleAdsKeywordsForSiteTasksReadyResponseInfo`

Defined in: main.ts:140525
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsKeywordsForSiteTasksReadyResponseInfo`

Defined in: main.ts:140544
