...
> **new KeywordsDataBingKeywordsForSiteTaskPostTaskInfo**(`data?`): `KeywordsDataBingKeywordsForSiteTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordsForSiteTaskPostTaskInfo`

Defined in: main.ts:153808
