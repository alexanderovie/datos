...
> **new DataforseoLabsGoogleHistoricalSerpsLiveResponseInfo**(`data`?): `DataforseoLabsGoogleHistoricalSerpsLiveResponseInfo`
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleHistoricalSerpsLiveResponseInfo`

Defined in: main.ts:120136
