...
> **new DataforseoLabsBingSerpCompetitorsLiveResponseInfo**(`data?`): `DataforseoLabsBingSerpCompetitorsLiveResponseInfo`

Defined in: main.ts:132249
...
> `static` **fromJS**(`data`): `DataforseoLabsBingSerpCompetitorsLiveResponseInfo`

Defined in: main.ts:132268
