...
> **new BusinessDataTrustpilotReviewsTaskPostTaskInfo**(`data`?): `BusinessDataTrustpilotReviewsTaskPostTaskInfo`

Defined in: main.ts:238185
...
> `static` **fromJS**(`data`): `BusinessDataTrustpilotReviewsTaskPostTaskInfo`

Defined in: main.ts:238200
