...
> **new KeywordsDataDataforseoTrendsDemographyLiveResponseInfo**(`data?`): `KeywordsDataDataforseoTrendsDemographyLiveResponseInfo`

Defined in: main.ts:149715
...
> `static` **fromJS**(`data`): `KeywordsDataDataforseoTrendsDemographyLiveResponseInfo`
