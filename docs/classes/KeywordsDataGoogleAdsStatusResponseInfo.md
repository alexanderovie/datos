...
> **new KeywordsDataGoogleAdsStatusResponseInfo**(`data`?): `KeywordsDataGoogleAdsStatusResponseInfo`

Defined in: main.ts:137967
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleAdsStatusResponseInfo`
