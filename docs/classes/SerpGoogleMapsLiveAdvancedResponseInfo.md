...
> **new SerpGoogleMapsLiveAdvancedResponseInfo**(`data`?): `SerpGoogleMapsLiveAdvancedResponseInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleMapsLiveAdvancedResponseInfo`

Defined in: main.ts:45653
