...
> **new DataforseoLabsAmazonRelatedKeywordsLiveResponseInfo**(`data`?): `DataforseoLabsAmazonRelatedKeywordsLiveResponseInfo`

Defined in: main.ts:124553
...
> `static` **fromJS**(`data`): `DataforseoLabsAmazonRelatedKeywordsLiveResponseInfo`
