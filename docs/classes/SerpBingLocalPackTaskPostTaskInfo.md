...
> **new SerpBingLocalPackTaskPostTaskInfo**(`data?`): `SerpBingLocalPackTaskPostTaskInfo`
...
> `static` **fromJS**(`data`): `SerpBingLocalPackTaskPostTaskInfo`

Defined in: main.ts:69943
