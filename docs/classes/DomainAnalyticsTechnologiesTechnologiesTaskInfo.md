...
> **new DomainAnalyticsTechnologiesTechnologiesTaskInfo**(`data?`): `DomainAnalyticsTechnologiesTechnologiesTaskInfo`

Defined in: main.ts:97148
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesTechnologiesTaskInfo`
