...
> **new SerpGoogleLocalFinderTasksReadyTaskInfo**(`data?`): `SerpGoogleLocalFinderTasksReadyTaskInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleLocalFinderTasksReadyTaskInfo`

Defined in: main.ts:46340
