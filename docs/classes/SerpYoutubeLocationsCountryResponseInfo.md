...
> **new SerpYoutubeLocationsCountryResponseInfo**(`data`?): `SerpYoutubeLocationsCountryResponseInfo`

Defined in: main.ts:72138
...
> `static` **fromJS**(`data`): `SerpYoutubeLocationsCountryResponseInfo`

Defined in: main.ts:72157
