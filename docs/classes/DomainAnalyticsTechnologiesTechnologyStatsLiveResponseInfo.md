...
> **new DomainAnalyticsTechnologiesTechnologyStatsLiveResponseInfo**(`data`?): `DomainAnalyticsTechnologiesTechnologyStatsLiveResponseInfo`

Defined in: main.ts:98597
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesTechnologyStatsLiveResponseInfo`
