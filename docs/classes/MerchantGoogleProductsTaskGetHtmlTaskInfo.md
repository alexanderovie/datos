...
> **new MerchantGoogleProductsTaskGetHtmlTaskInfo**(`data?`): `MerchantGoogleProductsTaskGetHtmlTaskInfo`
...
> `static` **fromJS**(`data`): `MerchantGoogleProductsTaskGetHtmlTaskInfo`

Defined in: main.ts:199405
