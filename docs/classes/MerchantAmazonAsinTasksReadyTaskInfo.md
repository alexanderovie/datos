...
> **new MerchantAmazonAsinTasksReadyTaskInfo**(`data?`): `MerchantAmazonAsinTasksReadyTaskInfo`

Defined in: main.ts:206128
...
> `static` **fromJS**(`data`): `MerchantAmazonAsinTasksReadyTaskInfo`
