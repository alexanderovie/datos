...
> **new SerpGoogleDatasetInfoTaskGetAdvancedResponseInfo**(`data`?): `SerpGoogleDatasetInfoTaskGetAdvancedResponseInfo`
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetInfoTaskGetAdvancedResponseInfo`

Defined in: main.ts:62618
