...
### new AppDataGoogleAppListTaskGetAdvancedTaskInfo()
...
> `static` **fromJS**(`data`): [`AppDataGoogleAppListTaskGetAdvancedTaskInfo`](AppDataGoogleAppListTaskGetAdvancedTaskInfo.md)

Defined in: main.ts:210528
