...
> **new SerpGoogleOrganicTaskGetAdvancedResponseInfo**(`data`?): `SerpGoogleOrganicTaskGetAdvancedResponseInfo`

Defined in: main.ts:41182
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicTaskGetAdvancedResponseInfo`
