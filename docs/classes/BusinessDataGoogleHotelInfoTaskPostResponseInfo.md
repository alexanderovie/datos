...
> **new BusinessDataGoogleHotelInfoTaskPostResponseInfo**(`data`?): `BusinessDataGoogleHotelInfoTaskPostResponseInfo`

Defined in: main.ts:230521
...
> `static` **fromJS**(`data`): `BusinessDataGoogleHotelInfoTaskPostResponseInfo`
