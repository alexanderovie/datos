...
> **new KeywordsDataBingKeywordPerformanceTasksReadyResponseInfo**(`data?`): `KeywordsDataBingKeywordPerformanceTasksReadyResponseInfo`

Defined in: main.ts:156977
...
> `static` **fromJS**(`data`): `KeywordsDataBingKeywordPerformanceTasksReadyResponseInfo`
