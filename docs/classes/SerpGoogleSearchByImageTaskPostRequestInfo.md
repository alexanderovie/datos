...
> **new SerpGoogleSearchByImageTaskPostRequestInfo**(`data?`): `SerpGoogleSearchByImageTaskPostRequestInfo`

Defined in: main.ts:55617
...
> `static` **fromJS**(`data`): `SerpGoogleSearchByImageTaskPostRequestInfo`
