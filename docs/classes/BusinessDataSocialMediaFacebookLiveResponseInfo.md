...
> **new BusinessDataSocialMediaFacebookLiveResponseInfo**(`data?`): `BusinessDataSocialMediaFacebookLiveResponseInfo`

Defined in: main.ts:242413
...
> `static` **fromJS**(`data`): `BusinessDataSocialMediaFacebookLiveResponseInfo`

Defined in: main.ts:242432
