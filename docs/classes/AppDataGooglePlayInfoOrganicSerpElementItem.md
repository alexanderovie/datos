...
> **new AppDataGooglePlayInfoOrganicSerpElementItem**(`data?`): `AppDataGooglePlayInfoOrganicSerpElementItem`

Defined in: main.ts:214425
...
> `static` **fromJS**(`data`): `AppDataGooglePlayInfoOrganicSerpElementItem`
