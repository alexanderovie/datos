...
> **new KeywordsDataGoogleTrendsExploreLiveTaskInfo**(`data?`): `KeywordsDataGoogleTrendsExploreLiveTaskInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsExploreLiveTaskInfo`
