...
> **new KeywordsDataGoogleTrendsExploreTaskPostResponseInfo**(`data?`): `KeywordsDataGoogleTrendsExploreTaskPostResponseInfo`
...
> `static` **fromJS**(`data`): `KeywordsDataGoogleTrendsExploreTaskPostResponseInfo`

Defined in: main.ts:145716
