...
> **new SerpSeznamOrganicTaskGetAdvancedResponseInfo**(`data?`): `SerpSeznamOrganicTaskGetAdvancedResponseInfo`

Defined in: main.ts:87065
...
> `static` **fromJS**(`data`): `SerpSeznamOrganicTaskGetAdvancedResponseInfo`

Defined in: main.ts:87084
