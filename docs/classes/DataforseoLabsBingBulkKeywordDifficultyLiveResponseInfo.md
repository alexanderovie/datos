...
> **new DataforseoLabsBingBulkKeywordDifficultyLiveResponseInfo**(`data?`): `DataforseoLabsBingBulkKeywordDifficultyLiveResponseInfo`

Defined in: main.ts:127527
...
> `static` **fromJS**(`data`): `DataforseoLabsBingBulkKeywordDifficultyLiveResponseInfo`

Defined in: main.ts:127546
