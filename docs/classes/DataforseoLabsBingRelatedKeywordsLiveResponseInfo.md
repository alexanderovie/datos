...
> **new DataforseoLabsBingRelatedKeywordsLiveResponseInfo**(`data`?): `DataforseoLabsBingRelatedKeywordsLiveResponseInfo`

Defined in: main.ts:131077
...
> `static` **fromJS**(`data`): `DataforseoLabsBingRelatedKeywordsLiveResponseInfo`

Defined in: main.ts:131096
