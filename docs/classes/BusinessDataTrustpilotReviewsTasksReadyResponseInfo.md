...
> **new BusinessDataTrustpilotReviewsTasksReadyResponseInfo**(`data`?): `BusinessDataTrustpilotReviewsTasksReadyResponseInfo`

Defined in: main.ts:238427
...
> `static` **fromJS**(`data`): `BusinessDataTrustpilotReviewsTasksReadyResponseInfo`

Defined in: main.ts:238446
