...
> **new DataforseoLabsBingDomainIntersectionLiveResponseInfo**(`data`?): `DataforseoLabsBingDomainIntersectionLiveResponseInfo`

Defined in: main.ts:128911
...
> `static` **fromJS**(`data`): `DataforseoLabsBingDomainIntersectionLiveResponseInfo`

Defined in: main.ts:128930
