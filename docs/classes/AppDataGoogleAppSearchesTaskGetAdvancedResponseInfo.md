...
> **new AppDataGoogleAppSearchesTaskGetAdvancedResponseInfo**(`data?`): `AppDataGoogleAppSearchesTaskGetAdvancedResponseInfo`
...
> `static` **fromJS**(`data`): `AppDataGoogleAppSearchesTaskGetAdvancedResponseInfo`
