...
> **new SerpGoogleOrganicLiveRegularResponseInfo**(`data?`): `SerpGoogleOrganicLiveRegularResponseInfo`

Defined in: main.ts:42152
...
> `static` **fromJS**(`data`): `SerpGoogleOrganicLiveRegularResponseInfo`

Defined in: main.ts:42171
