...
> **new SerpGoogleDatasetInfoLiveAdvancedResponseInfo**(`data`?): `SerpGoogleDatasetInfoLiveAdvancedResponseInfo`

Defined in: main.ts:62973
...
> `static` **fromJS**(`data`): `SerpGoogleDatasetInfoLiveAdvancedResponseInfo`

Defined in: main.ts:62992
