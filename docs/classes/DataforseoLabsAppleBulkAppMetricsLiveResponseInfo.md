...
> **new DataforseoLabsAppleBulkAppMetricsLiveResponseInfo**(`data?`): `DataforseoLabsAppleBulkAppMetricsLiveResponseInfo`

Defined in: main.ts:135479
...
> `static` **fromJS**(`data`): `DataforseoLabsAppleBulkAppMetricsLiveResponseInfo`
