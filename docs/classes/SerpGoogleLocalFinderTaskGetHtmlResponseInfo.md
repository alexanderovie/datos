...
> **new SerpGoogleLocalFinderTaskGetHtmlResponseInfo**(`data`?): `SerpGoogleLocalFinderTaskGetHtmlResponseInfo`

Defined in: main.ts:46970
...
> `static` **fromJS**(`data`): `SerpGoogleLocalFinderTaskGetHtmlResponseInfo`

Defined in: main.ts:46989
