...
> **new DataforseoLabsGoogleDomainMetricsByCategoriesLiveTaskInfo**(`data?`): `DataforseoLabsGoogleDomainMetricsByCategoriesLiveTaskInfo`

Defined in: main.ts:110198
...
> `static` **fromJS**(`data`): `DataforseoLabsGoogleDomainMetricsByCategoriesLiveTaskInfo`
