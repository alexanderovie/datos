...
> **new DomainAnalyticsTechnologiesDomainsByTechnologyLiveTaskInfo**(`data?`): `DomainAnalyticsTechnologiesDomainsByTechnologyLiveTaskInfo`
...
> `static` **fromJS**(`data`): `DomainAnalyticsTechnologiesDomainsByTechnologyLiveTaskInfo`
