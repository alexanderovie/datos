...
|------------ | ------------- | ------------- | -------------|
**app_id** | **string** | ID of the returned app |[optional]|
...
**time_update** | **string** | date and time when SERP data was last updated<br>in the ISO 8601 format: “YYYY-MM-DDThh:mm:ss.sssssssZ”<br>example:<br>2023-05-23 10:16:19 +00:00 |[optional]|
