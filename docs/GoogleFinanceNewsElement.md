...
**image_url** | **string** | featured image URL<br>URL of the news article’s featured image |[optional]|
...
**quotes** | **BaseSerpApiGoogleFinanceElementItem[]** | market indexes quoted in the news article<br>information about market indexes quoted in the google_finance_news_element |[optional]|