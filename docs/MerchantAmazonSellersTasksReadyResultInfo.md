...
**endpoint_advanced** | **string** | URL for collecting the results of Amazon Sellers Advanced task |[optional]|
**endpoint_html** | **string** | URL for collecting the results of Amazon Sellers HTML task |[optional]|