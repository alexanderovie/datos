...
**items** | **BusinessDataGoogleExtendedReviewsTaskGetItem[]** | found reviews<br>you can get more results by using the depth parameter when setting a task |[optional]|