...
**offset** | **number** | offset in the results array of returned domains |[optional]|
**items** | **DomainAnalyticsTechnologiesAggregationTechnologiesLiveItem[]** | items array |[optional]|