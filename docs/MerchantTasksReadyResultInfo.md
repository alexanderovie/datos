...
**endpoint_advanced** | **string** | URL for collecting the results of the Amazon Reviews Advanced task |[optional]|
**endpoint_html** | **string** | URL for collecting the results of the Amazon Reviews HTML task |[optional]|