...
**reviews_count** | **number** | the total number of reviews<br>in this case, the value will be null as App Store does not indicate the total number of app reviews |[optional]|
...
**items** | **BaseAppDataSerpElementItem[]** | found reviews |[optional]|