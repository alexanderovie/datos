...
**contact_info** | **BusinessDataContactInfo[]** | available contacts of the business<br>list of contacts to interact with the business |[optional]|
...
**last_updated_time** | **string** | date and time when the data was last updated<br>in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”<br>example:<br>2023-01-26 09:03:15 +00:00 |[optional]|
**first_seen** | **string** | date and time when our crawler found the business listing element for the first time<br>in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”<br>example:<br>2023-03-11 10:04:11 +00:00 |[optional]|