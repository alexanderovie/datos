...
**endpoint_advanced** | **string** | URL for collecting the results of the Amazon ASIN Advanced task |[optional]|
**endpoint_html** | **string** | URL for collecting the results of the Amazon ASIN HTML task |[optional]|