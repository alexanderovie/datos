...
**year** | **number** | indicates the year for which the data is provided for<br>example:<br>2020 |[optional]|
**month** | **number** | indicates the month for which the data is provided for<br>example:<br>10 |[optional]|
