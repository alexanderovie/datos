...
**se_type** | **string** | type of search engine<br>can take the following values: shopping |[optional]|
**date_posted** | **string** | date when the task was posted (in the UTC format) |[optional]|
**tag** | **string** | user-defined task identifier |[optional]|
**endpoint_advanced** | **string** | URL for collecting the results of Google Shopping Sellers Advanced task |[optional]|
**endpoint_html** | **string** | URL for collecting the results of Google Shopping Sellers HTML task |[optional]|