...
**search_volume** | **string** | current search volume rate of a keyword |[optional]|
**is_normalized** | **string** | keyword info is normalized<br>if true, values are normalized with Bing data |[optional]|
