...
> `optional` **tasks**: [`BusinessDataBusinessListingsLocationsTaskInfo`](../classes/BusinessDataBusinessListingsLocationsTaskInfo.md)[]

Defined in: main.ts:222523
