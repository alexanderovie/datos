...
> `optional` **result**: [`KeywordsDataClickstreamDataGlobalSearchVolumeLiveResultInfo`](../classes/KeywordsDataClickstreamDataGlobalSearchVolumeLiveResultInfo.md)[]

Defined in: main.ts:160310
