...
> `optional` **result**: [`BusinessDataTripadvisorSearchTaskGetResultInfo`](../classes/BusinessDataTripadvisorSearchTaskGetResultInfo.md)[]

Defined in: main.ts:240242
