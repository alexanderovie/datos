...
> `optional` **tasks**: [`KeywordsDataGoogleTrendsExploreTasksReadyTaskInfo`](../classes/KeywordsDataGoogleTrendsExploreTasksReadyTaskInfo.md)[]

Defined in: main.ts:145809
