...
> `optional` **tasks**: [`BusinessDataTrustpilotSearchTaskPostTaskInfo`](../classes/BusinessDataTrustpilotSearchTaskPostTaskInfo.md)[]

Defined in: main.ts:235112
