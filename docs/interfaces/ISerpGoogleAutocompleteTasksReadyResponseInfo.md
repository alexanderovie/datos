...
> `optional` **tasks**: [`SerpGoogleAutocompleteTasksReadyTaskInfo`](../classes/SerpGoogleAutocompleteTasksReadyTaskInfo.md)[]

Defined in: main.ts:58699
