...
> `optional` **tasks**: [`DomainAnalyticsTechnologiesDomainsByTechnologyLiveTaskInfo`](../classes/DomainAnalyticsTechnologiesDomainsByTechnologyLiveTaskInfo.md)[]

Defined in: main.ts:97444
