...
> `optional` **result**: [`SerpGoogleOrganicTaskGetRegularResultInfo`](../classes/SerpGoogleOrganicTaskGetRegularResultInfo.md)[]

Defined in: main.ts:31253
