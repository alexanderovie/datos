...
[Documentation](../README.md) / IOnPageIdListResponseInfo

# Interface: IOnPageIdListResponseInfo
...
> `optional` **tasks**: [`OnPageIdListTaskInfo`](../classes/OnPageIdListTaskInfo.md)[]

Defined in: main.ts:172846
