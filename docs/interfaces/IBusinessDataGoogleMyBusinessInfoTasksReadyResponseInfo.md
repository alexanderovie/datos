...
> `optional` **tasks**: [`BusinessDataGoogleMyBusinessInfoTasksReadyTaskInfo`](../classes/BusinessDataGoogleMyBusinessInfoTasksReadyTaskInfo.md)[]

Defined in: main.ts:225293
