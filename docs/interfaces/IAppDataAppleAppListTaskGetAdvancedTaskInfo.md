...
> `optional` **result**: [`AppDataAppleAppListTaskGetAdvancedResultInfo`](../classes/AppDataAppleAppListTaskGetAdvancedResultInfo.md)[]

Defined in: main.ts:219518
