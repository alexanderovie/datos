...
> `optional` **result**: [`KeywordsDataBingKeywordsForSiteTasksReadyResultInfo`](../classes/KeywordsDataBingKeywordsForSiteTasksReadyResultInfo.md)[]

Defined in: main.ts:153898
