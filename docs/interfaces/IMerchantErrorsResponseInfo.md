...
[Documentation](../README.md) / IMerchantErrorsResponseInfo

# Interface: IMerchantErrorsResponseInfo
...
> `optional` **tasks**: [`MerchantErrorsTaskInfo`](../classes/MerchantErrorsTaskInfo.md)[]
