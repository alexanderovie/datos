...
[Documentation](../README.md) / IOnPageResourcesTaskInfo

# Interface: IOnPageResourcesTaskInfo
...
> `optional` **result**: [`OnPageResourcesResultInfo`](../classes/OnPageResourcesResultInfo.md)[]

Defined in: main.ts:180184
