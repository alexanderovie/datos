...
[Documentation](../README.md) / IBacklinksIndexTaskInfo

# Interface: IBacklinksIndexTaskInfo
...
> `optional` **result**: [`BacklinksIndexResultInfo`](../classes/BacklinksIndexResultInfo.md)[]
