...
unique task identifier in our system in the UUID format */
    ...
    constructor(data?: IKeywordsDataBingKeywordPerformanceTasksReadyResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataBingKeywordPerformanceTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataBingKeywordPerformanceTasksReadyResultInfo();
        result.init(data);
        return result;
    }
