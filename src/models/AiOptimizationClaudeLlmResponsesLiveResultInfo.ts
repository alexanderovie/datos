...
export interface IAiOptimizationClaudeLlmResponsesLiveResultInfo   {
...
export class AiOptimizationClaudeLlmResponsesLiveResultInfo  implements IAiOptimizationClaudeLlmResponsesLiveResultInfo {
...
contains structured AI response data */
    ...
    constructor(data?: IAiOptimizationClaudeLlmResponsesLiveResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationClaudeLlmResponsesLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationClaudeLlmResponsesLiveResultInfo();
        result.init(data);
        return result;
    }
