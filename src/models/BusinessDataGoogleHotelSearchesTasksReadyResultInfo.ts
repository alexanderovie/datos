...
can take the following values: google */
    ...
    constructor(data?: IBusinessDataGoogleHotelSearchesTasksReadyResultInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleHotelSearchesTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleHotelSearchesTasksReadyResultInfo();
        result.init(data);
        return result;
    }
