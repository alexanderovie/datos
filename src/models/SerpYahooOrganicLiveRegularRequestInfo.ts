...
export interface ISerpYahooOrganicLiveRegularRequestInfo   {
...
export class SerpYahooOrganicLiveRegularRequestInfo  implements ISerpYahooOrganicLiveRegularRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpYahooOrganicLiveRegularRequestInfo) {
    ...
    static fromJS(data: any): SerpYahooOrganicLiveRegularRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooOrganicLiveRegularRequestInfo();
        result.init(data);
        return result;
    }
