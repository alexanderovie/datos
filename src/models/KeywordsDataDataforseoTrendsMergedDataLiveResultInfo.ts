...
values in this array represent percentages relative to the maximum value within each region */
    ...
    constructor(data?: IKeywordsDataDataforseoTrendsMergedDataLiveResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(BaseKeywordDataDataforseoTrendsItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): KeywordsDataDataforseoTrendsMergedDataLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataDataforseoTrendsMergedDataLiveResultInfo();
        result.init(data);
        return result;
    }
