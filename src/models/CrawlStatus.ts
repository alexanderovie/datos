...
export class CrawlStatus  implements ICrawlStatus {
...
indicates the max_crawl_pages limit you specified when setting a task */
    ...
    static fromJS(data: any): CrawlStatus {
        data = typeof data === 'object' ? data : {};


        let result = new CrawlStatus();
        result.init(data);
        return result;
    }
