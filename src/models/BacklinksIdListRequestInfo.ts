...
export interface IBacklinksIdListRequestInfo   {
...
export class BacklinksIdListRequestInfo  implements IBacklinksIdListRequestInfo {
...
default value: false */
    ...
    constructor(data?: IBacklinksIdListRequestInfo) {
    ...
    static fromJS(data: any): BacklinksIdListRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksIdListRequestInfo();
        result.init(data);
        return result;
    }
