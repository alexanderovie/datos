...
export interface ISerpGoogleAdsAdvertisersTasksReadyTaskInfo  extends IBaseResponseTaskInfo    {
        ...
        /** array of results */
        result?: SerpGoogleAdsAdvertisersTasksReadyResultInfo[] | undefined
...
export class SerpGoogleAdsAdvertisersTasksReadyTaskInfo  extends BaseResponseTaskInfo   implements ISerpGoogleAdsAdvertisersTasksReadyTaskInfo {
    ...
    constructor(data?: ISerpGoogleAdsAdvertisersTasksReadyTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(SerpGoogleAdsAdvertisersTasksReadyResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): SerpGoogleAdsAdvertisersTasksReadyTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAdsAdvertisersTasksReadyTaskInfo();
        result.init(data);
        return result;
    }
