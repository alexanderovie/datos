export interface IAppDataGoogleAppInfoTaskPostRequestInfo   {
...
i.a., the # character will be encoded into %23 */
    ...
    constructor(data?: IAppDataGoogleAppInfoTaskPostRequestInfo) {
    ...
    static fromJS(data: any): AppDataGoogleAppInfoTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppInfoTaskPostRequestInfo();
        result.init(data);
        return result;
    }
