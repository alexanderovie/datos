export interface IKeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IKeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
