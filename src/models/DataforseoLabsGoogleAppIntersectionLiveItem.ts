...
depending on the number of specified app IDs, it can contain from 1 to 20 arrays named respectively */
        intersection_result?: { [key: string]: AppDataGooglePlaySearchOrganicSerpElementItem; } | undefined

    [key: string]: any;

    }

export class DataforseoLabsGoogleAppIntersectionLiveItem  implements IDataforseoLabsGoogleAppIntersectionLiveItem {
...
depending on the number of specified app IDs, it can contain from 1 to 20 arrays named respectively */
    ...
    constructor(data?: IDataforseoLabsGoogleAppIntersectionLiveItem) {
    ...
    static fromJS(data: any): DataforseoLabsGoogleAppIntersectionLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsGoogleAppIntersectionLiveItem();
        result.init(data);
        return result;
    }
