...
export class SerpGoogleAdsSearchTaskGetAdvancedResultInfo  implements ISerpGoogleAdsSearchTaskGetAdvancedResultInfo {
...
ads_search */
    ...
    constructor(data?: ISerpGoogleAdsSearchTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAdsSearchTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAdsSearchTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
