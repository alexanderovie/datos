...
export class SerpBingOrganicTaskGetRegularResultInfo  implements ISerpBingOrganicTaskGetRegularResultInfo {
...
array of 8 search queries related to the keyword */
    ...
    constructor(data?: ISerpBingOrganicTaskGetRegularResultInfo) {
    ...
    static fromJS(data: any): SerpBingOrganicTaskGetRegularResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingOrganicTaskGetRegularResultInfo();
        result.init(data);
        return result;
    }
