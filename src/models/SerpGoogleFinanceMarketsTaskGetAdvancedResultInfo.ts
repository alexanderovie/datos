...
export class SerpGoogleFinanceMarketsTaskGetAdvancedResultInfo  implements ISerpGoogleFinanceMarketsTaskGetAdvancedResultInfo {
...
possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element */
    ...
    constructor(data?: ISerpGoogleFinanceMarketsTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleFinanceMarketsTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleFinanceMarketsTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
