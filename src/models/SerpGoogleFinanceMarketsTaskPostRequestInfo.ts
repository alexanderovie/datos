export interface ISerpGoogleFinanceMarketsTaskPostRequestInfo   {
...
export class SerpGoogleFinanceMarketsTaskPostRequestInfo  implements ISerpGoogleFinanceMarketsTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    constructor(data?: ISerpGoogleFinanceMarketsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleFinanceMarketsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleFinanceMarketsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
