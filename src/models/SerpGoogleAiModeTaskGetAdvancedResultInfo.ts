...
import { AiModeAiOverview, IAiModeAiOverview } from "./AiModeAiOverview";


export interface ISerpGoogleAiModeTaskGetAdvancedResultInfo   {
...
ai_overview */
        ...
        items?: AiModeAiOverview[] | undefined

    [key: string]: any;

    }

export class SerpGoogleAiModeTaskGetAdvancedResultInfo  implements ISerpGoogleAiModeTaskGetAdvancedResultInfo {
...
ai_overview */
    ...
    constructor(data?: ISerpGoogleAiModeTaskGetAdvancedResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(AiModeAiOverview.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): SerpGoogleAiModeTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAiModeTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
