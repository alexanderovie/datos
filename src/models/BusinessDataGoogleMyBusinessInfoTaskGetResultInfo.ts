...
export class BusinessDataGoogleMyBusinessInfoTaskGetResultInfo  implements IBusinessDataGoogleMyBusinessInfoTaskGetResultInfo {
...
the number of items in the items array */
    ...
    constructor(data?: IBusinessDataGoogleMyBusinessInfoTaskGetResultInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleMyBusinessInfoTaskGetResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleMyBusinessInfoTaskGetResultInfo();
        result.init(data);
        return result;
    }
