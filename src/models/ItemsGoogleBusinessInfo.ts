...
export class ItemsGoogleBusinessInfo  implements IItemsGoogleBusinessInfo {
...
includes information about businesses that are located within the target business establishment and have the same address */
    ...
    constructor(data?: IItemsGoogleBusinessInfo) {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.popular_times = data["popular_times"];
    ...
    static fromJS(data: any): ItemsGoogleBusinessInfo {
        data = typeof data === 'object' ? data : {};


        let result = new ItemsGoogleBusinessInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["popular_times"] = this.popular_times;
