export interface IDataforseoLabsAppleKeywordsForAppLiveRequestInfo   {
...
export class DataforseoLabsAppleKeywordsForAppLiveRequestInfo  implements IDataforseoLabsAppleKeywordsForAppLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsAppleKeywordsForAppLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsAppleKeywordsForAppLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsAppleKeywordsForAppLiveRequestInfo();
        result.init(data);
        return result;
    }
