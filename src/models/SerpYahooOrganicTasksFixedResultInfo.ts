export interface ISerpYahooOrganicTasksFixedResultInfo   {
...
export class SerpYahooOrganicTasksFixedResultInfo  implements ISerpYahooOrganicTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpYahooOrganicTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpYahooOrganicTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooOrganicTasksFixedResultInfo();
        result.init(data);
        return result;
    }
