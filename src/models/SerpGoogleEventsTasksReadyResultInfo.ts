...
export interface ISerpGoogleEventsTasksReadyResultInfo   {
...
export class SerpGoogleEventsTasksReadyResultInfo  implements ISerpGoogleEventsTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleEventsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleEventsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleEventsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
