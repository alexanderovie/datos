...
export interface IDataforseoLabsAppleKeywordsForAppLiveResultInfo   {
        ...
        items?: DataforseoLabsAppleKeywordsForAppLiveItem[] | undefined

    [key: string]: any;

    }

export class DataforseoLabsAppleKeywordsForAppLiveResultInfo  implements IDataforseoLabsAppleKeywordsForAppLiveResultInfo {
    ...
    static fromJS(data: any): DataforseoLabsAppleKeywordsForAppLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsAppleKeywordsForAppLiveResultInfo();
        result.init(data);
        return result;
    }
