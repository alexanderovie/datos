...
export class MerchantGoogleLocationsResultInfo  implements IMerchantGoogleLocationsResultInfo {
    ...
    constructor(data?: IMerchantGoogleLocationsResultInfo) {
    ...
    static fromJS(data: any): MerchantGoogleLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantGoogleLocationsResultInfo();
        result.init(data);
        return result;
    }
