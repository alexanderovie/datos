export interface IBacklinksBulkNewLostReferringDomainsLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBacklinksBulkNewLostReferringDomainsLiveRequestInfo) {
    ...
    static fromJS(data: any): BacklinksBulkNewLostReferringDomainsLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksBulkNewLostReferringDomainsLiveRequestInfo();
        result.init(data);
        return result;
    }
