...
export class BusinessDataGoogleQuestionsAndAnswersLiveResultInfo  implements IBusinessDataGoogleQuestionsAndAnswersLiveResultInfo {
...
possible item types google_business_answer_element */
    ...
    constructor(data?: IBusinessDataGoogleQuestionsAndAnswersLiveResultInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleQuestionsAndAnswersLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleQuestionsAndAnswersLiveResultInfo();
        result.init(data);
        return result;
    }
