...
google_jobs_item */
    ...
    constructor(data?: ISerpGoogleJobsTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleJobsTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleJobsTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
