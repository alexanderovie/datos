...
export interface ISerpGoogleAutocompleteTasksFixedTaskInfo  extends IBaseResponseTaskInfo    {
        ...
        /** array of results */
        result?: SerpGoogleAutocompleteTasksFixedResultInfo[] | undefined
...
export class SerpGoogleAutocompleteTasksFixedTaskInfo  extends BaseResponseTaskInfo   implements ISerpGoogleAutocompleteTasksFixedTaskInfo {
    ...
    constructor(data?: ISerpGoogleAutocompleteTasksFixedTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(SerpGoogleAutocompleteTasksFixedResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): SerpGoogleAutocompleteTasksFixedTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAutocompleteTasksFixedTaskInfo();
        result.init(data);
        return result;
    }
