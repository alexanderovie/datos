export interface ISerpBingLocalPackTasksFixedResultInfo   {
...
export class SerpBingLocalPackTasksFixedResultInfo  implements ISerpBingLocalPackTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpBingLocalPackTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpBingLocalPackTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingLocalPackTasksFixedResultInfo();
        result.init(data);
        return result;
    }
