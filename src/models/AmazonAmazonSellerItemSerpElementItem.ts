...
export interface IAmazonAmazonSellerItemSerpElementItem  extends IBaseAmazonSerpElementItem    {
...
export class AmazonAmazonSellerItemSerpElementItem  extends BaseAmazonSerpElementItem   implements IAmazonAmazonSellerItemSerpElementItem {
...
delivery information including free and fast delivery date ranges */
    ...
    constructor(data?: IAmazonAmazonSellerItemSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): AmazonAmazonSellerItemSerpElementItem {
