...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsGoogleHistoricalRankOverviewLiveRequestInfo();
        result.init(data);
        return result;
    }
