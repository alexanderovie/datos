...
export interface IDomainAnalyticsTechnologiesDomainTechnologiesLiveResultInfo   {
...
export class DomainAnalyticsTechnologiesDomainTechnologiesLiveResultInfo  implements IDomainAnalyticsTechnologiesDomainTechnologiesLiveResultInfo {
...
see the full list of available technologies structured by groups and categories */
    ...
    constructor(data?: IDomainAnalyticsTechnologiesDomainTechnologiesLiveResultInfo) {
    ...
    static fromJS(data: any): DomainAnalyticsTechnologiesDomainTechnologiesLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DomainAnalyticsTechnologiesDomainTechnologiesLiveResultInfo();
        result.init(data);
        return result;
    }
