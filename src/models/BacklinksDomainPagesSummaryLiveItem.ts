export interface IBacklinksDomainPagesSummaryLiveItem   {
...
export class BacklinksDomainPagesSummaryLiveItem  implements IBacklinksDomainPagesSummaryLiveItem {
...
indicates ISO country codes of the domains where the referring links are located and the link count per each country */
    ...
    static fromJS(data: any): BacklinksDomainPagesSummaryLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksDomainPagesSummaryLiveItem();
        result.init(data);
        return result;
    }
