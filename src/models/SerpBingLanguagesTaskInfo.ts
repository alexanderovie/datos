...
export class SerpBingLanguagesTaskInfo  extends BaseResponseTaskInfo   implements ISerpBingLanguagesTaskInfo {
    ...
    constructor(data?: ISerpBingLanguagesTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(SerpBingLanguagesResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): SerpBingLanguagesTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingLanguagesTaskInfo();
        result.init(data);
        return result;
    }
