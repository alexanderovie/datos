export interface ISerpGoogleFinanceMarketsTasksReadyResultInfo   {
...
export class SerpGoogleFinanceMarketsTasksReadyResultInfo  implements ISerpGoogleFinanceMarketsTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleFinanceMarketsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleFinanceMarketsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleFinanceMarketsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
