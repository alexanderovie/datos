...
export class SerpGoogleAutocompleteTaskGetAdvancedResultInfo  implements ISerpGoogleAutocompleteTaskGetAdvancedResultInfo {
...
autocomplete */
    ...
    constructor(data?: ISerpGoogleAutocompleteTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAutocompleteTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAutocompleteTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
