export interface IBusinessDataGoogleExtendedReviewsTaskPostRequestInfo   {
...
learn more on our Help Center */
    ...
    constructor(data?: IBusinessDataGoogleExtendedReviewsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleExtendedReviewsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleExtendedReviewsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
