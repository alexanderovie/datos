...
export interface ISerpSeznamOrganicTasksReadyResultInfo   {
...
export class SerpSeznamOrganicTasksReadyResultInfo  implements ISerpSeznamOrganicTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpSeznamOrganicTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpSeznamOrganicTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpSeznamOrganicTasksReadyResultInfo();
        result.init(data);
        return result;
    }
