...
export class AppendixWebhookResendResponseInfo  extends BaseResponseInfo   implements IAppendixWebhookResendResponseInfo {
    ...
    constructor(data?: IAppendixWebhookResendResponseInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["tasks"])) {
                ...
                for (let item of data["tasks"]) {
                    this.tasks.push(AppendixWebhookResendTaskInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): AppendixWebhookResendResponseInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppendixWebhookResendResponseInfo();
        result.init(data);
        return result;
    }
