export interface IContentAnalysisIdListRequestInfo   {
...
default value: false */
    ...
    constructor(data?: IContentAnalysisIdListRequestInfo) {
    ...
    static fromJS(data: any): ContentAnalysisIdListRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new ContentAnalysisIdListRequestInfo();
        result.init(data);
        return result;
    }
