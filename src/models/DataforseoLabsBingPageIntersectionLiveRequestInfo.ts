export interface IDataforseoLabsBingPageIntersectionLiveRequestInfo   {
...
export class DataforseoLabsBingPageIntersectionLiveRequestInfo  implements IDataforseoLabsBingPageIntersectionLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsBingPageIntersectionLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsBingPageIntersectionLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsBingPageIntersectionLiveRequestInfo();
        result.init(data);
        return result;
    }
