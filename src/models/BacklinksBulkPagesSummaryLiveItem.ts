export interface IBacklinksBulkPagesSummaryLiveItem   {
...
export class BacklinksBulkPagesSummaryLiveItem  implements IBacklinksBulkPagesSummaryLiveItem {
...
indicates ISO country codes of the domains where the referring links are located and the link count per each country */
    ...
    constructor(data?: IBacklinksBulkPagesSummaryLiveItem) {
    ...
    static fromJS(data: any): BacklinksBulkPagesSummaryLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksBulkPagesSummaryLiveItem();
        result.init(data);
        return result;
    }
