...
export interface IAmazonAmazonSerpSerpElementItem  extends IBaseAmazonSerpElementItem    {
...
export class AmazonAmazonSerpSerpElementItem  extends BaseAmazonSerpElementItem   implements IAmazonAmazonSerpSerpElementItem {
...
B07G82D89J */
    ...
    constructor(data?: IAmazonAmazonSerpSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): AmazonAmazonSerpSerpElementItem {
