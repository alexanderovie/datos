...
export interface ISerpGoogleAdsSearchLocationsResultInfo   {
...
export class SerpGoogleAdsSearchLocationsResultInfo  implements ISerpGoogleAdsSearchLocationsResultInfo {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpGoogleAdsSearchLocationsResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAdsSearchLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAdsSearchLocationsResultInfo();
        result.init(data);
        return result;
    }
