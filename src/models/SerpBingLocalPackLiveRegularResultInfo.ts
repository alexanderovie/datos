...
export interface ISerpBingLocalPackLiveRegularResultInfo   {
...
export class SerpBingLocalPackLiveRegularResultInfo  implements ISerpBingLocalPackLiveRegularResultInfo {
...
local_pack */
    ...
    constructor(data?: ISerpBingLocalPackLiveRegularResultInfo) {
    ...
    static fromJS(data: any): SerpBingLocalPackLiveRegularResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingLocalPackLiveRegularResultInfo();
        result.init(data);
        return result;
    }
