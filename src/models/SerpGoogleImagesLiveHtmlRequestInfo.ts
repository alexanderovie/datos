export interface ISerpGoogleImagesLiveHtmlRequestInfo   {
...
export class SerpGoogleImagesLiveHtmlRequestInfo  implements ISerpGoogleImagesLiveHtmlRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpGoogleImagesLiveHtmlRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleImagesLiveHtmlRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleImagesLiveHtmlRequestInfo();
        result.init(data);
        return result;
    }
