...
export class SerpGoogleFinanceExploreLiveAdvancedRequestInfo  implements ISerpGoogleFinanceExploreLiveAdvancedRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpGoogleFinanceExploreLiveAdvancedRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleFinanceExploreLiveAdvancedRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleFinanceExploreLiveAdvancedRequestInfo();
        result.init(data);
        return result;
    }
