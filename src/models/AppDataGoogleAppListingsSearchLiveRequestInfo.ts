...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IAppDataGoogleAppListingsSearchLiveRequestInfo) {
    ...
    static fromJS(data: any): AppDataGoogleAppListingsSearchLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppListingsSearchLiveRequestInfo();
        result.init(data);
        return result;
    }
