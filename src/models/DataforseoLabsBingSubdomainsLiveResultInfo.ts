...
export class DataforseoLabsBingSubdomainsLiveResultInfo  implements IDataforseoLabsBingSubdomainsLiveResultInfo {
    ...
    constructor(data?: IDataforseoLabsBingSubdomainsLiveResultInfo) {
    ...
    static fromJS(data: any): DataforseoLabsBingSubdomainsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsBingSubdomainsLiveResultInfo();
        result.init(data);
        return result;
    }
