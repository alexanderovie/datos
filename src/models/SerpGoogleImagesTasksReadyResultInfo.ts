export interface ISerpGoogleImagesTasksReadyResultInfo   {
...
export class SerpGoogleImagesTasksReadyResultInfo  implements ISerpGoogleImagesTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleImagesTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleImagesTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleImagesTasksReadyResultInfo();
        result.init(data);
        return result;
    }
