...
'location_name_parent': 'Lower Austria,Austria' */
    ...
    constructor(data?: IBusinessDataGoogleLocationsCountryResultInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleLocationsCountryResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleLocationsCountryResultInfo();
        result.init(data);
        return result;
    }
