export interface IMerchantErrorsRequestInfo   {
...
export class MerchantErrorsRequestInfo  implements IMerchantErrorsRequestInfo {
...
2021-11-15 13:57:46 +00:00 */
    ...
    constructor(data?: IMerchantErrorsRequestInfo) {
    ...
    static fromJS(data: any): MerchantErrorsRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantErrorsRequestInfo();
        result.init(data);
        return result;
    }
