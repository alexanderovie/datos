...
top_stories, news_search */
    ...
    constructor(data?: ISerpGoogleNewsTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleNewsTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleNewsTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
