...
export interface IScholarlyArticlesSerpElementItem  extends IBaseSerpElementItem    {
...
export class ScholarlyArticlesSerpElementItem  extends BaseSerpElementItem   implements IScholarlyArticlesSerpElementItem {
