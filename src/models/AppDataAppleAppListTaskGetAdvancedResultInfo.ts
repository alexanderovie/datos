...
export class AppDataAppleAppListTaskGetAdvancedResultInfo  implements IAppDataAppleAppListTaskGetAdvancedResultInfo {
...
you can get more results by using the depth parameter when setting a task */
    ...
    constructor(data?: IAppDataAppleAppListTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): AppDataAppleAppListTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataAppleAppListTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
