...
export interface ISerpGoogleMapsTaskPostRequestInfo   {
...
export class SerpGoogleMapsTaskPostRequestInfo  implements ISerpGoogleMapsTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    constructor(data?: ISerpGoogleMapsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleMapsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleMapsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
