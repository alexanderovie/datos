...
export interface IKeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo   {
...
export class KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo  implements IKeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo {
...
if there is no data, the value is null */
    ...
    constructor(data?: IKeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo();
        result.init(data);
        return result;
    }
