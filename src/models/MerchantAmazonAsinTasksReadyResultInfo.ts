export interface IMerchantAmazonAsinTasksReadyResultInfo   {
...
export class MerchantAmazonAsinTasksReadyResultInfo  implements IMerchantAmazonAsinTasksReadyResultInfo {
...
can take the following values: shopping */
    ...
    constructor(data?: IMerchantAmazonAsinTasksReadyResultInfo) {
    ...
    static fromJS(data: any): MerchantAmazonAsinTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonAsinTasksReadyResultInfo();
        result.init(data);
        return result;
    }
