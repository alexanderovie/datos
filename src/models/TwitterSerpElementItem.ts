...
export interface ITwitterSerpElementItem  extends IBaseSerpElementItem    {
...
export class TwitterSerpElementItem  extends BaseSerpElementItem   implements ITwitterSerpElementItem {
