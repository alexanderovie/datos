...
2019-11-15 12:57:46 +00:00 */
    ...
    constructor(data?: ISerpGoogleAiModeLiveHtmlResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAiModeLiveHtmlResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAiModeLiveHtmlResultInfo();
        result.init(data);
        return result;
    }
