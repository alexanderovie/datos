...
export interface ISerpGoogleLanguagesTaskInfo  extends IBaseResponseTaskInfo    {
        ...
        /** array of results */
        result?: SerpGoogleLanguagesResultInfo[] | undefined
...
export class SerpGoogleLanguagesTaskInfo  extends BaseResponseTaskInfo   implements ISerpGoogleLanguagesTaskInfo {
    ...
    constructor(data?: ISerpGoogleLanguagesTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(SerpGoogleLanguagesResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): SerpGoogleLanguagesTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLanguagesTaskInfo();
        result.init(data);
        return result;
    }
