...
export class SerpGoogleFinanceTickerSearchLiveAdvancedResultInfo  implements ISerpGoogleFinanceTickerSearchLiveAdvancedResultInfo {
...
possible type of items: google_finance_market_index, google_finance_asset_pair, google_finance_market_instrument */
    ...
    static fromJS(data: any): SerpGoogleFinanceTickerSearchLiveAdvancedResultInfo {
        ...
        let result = new SerpGoogleFinanceTickerSearchLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
