...
if true, you can use the Standard (POST-GET) data retrieval method with the AI model */
    ...
    constructor(data?: IAiOptimizationGeminiLlmResponsesModelsResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationGeminiLlmResponsesModelsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationGeminiLlmResponsesModelsResultInfo();
        result.init(data);
        return result;
    }
