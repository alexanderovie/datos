...
export class BacklinksPageIntersectionLiveResponseInfo  extends BaseResponseInfo   implements IBacklinksPageIntersectionLiveResponseInfo {
    ...
    constructor(data?: IBacklinksPageIntersectionLiveResponseInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["tasks"])) {
                ...
                for (let item of data["tasks"]) {
                    this.tasks.push(BacklinksPageIntersectionLiveTaskInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): BacklinksPageIntersectionLiveResponseInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksPageIntersectionLiveResponseInfo();
        result.init(data);
        return result;
    }
