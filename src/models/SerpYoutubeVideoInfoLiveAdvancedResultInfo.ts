...
export class SerpYoutubeVideoInfoLiveAdvancedResultInfo  implements ISerpYoutubeVideoInfoLiveAdvancedResultInfo {
...
youtube_video_info */
    ...
    constructor(data?: ISerpYoutubeVideoInfoLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeVideoInfoLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeVideoInfoLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
