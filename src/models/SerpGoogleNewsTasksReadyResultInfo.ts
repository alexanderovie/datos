export interface ISerpGoogleNewsTasksReadyResultInfo   {
...
export class SerpGoogleNewsTasksReadyResultInfo  implements ISerpGoogleNewsTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleNewsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleNewsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleNewsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
