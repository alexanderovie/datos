import { SerpGoogleFinanceTickerSearchTasksReadyResultInfo, ISerpGoogleFinanceTickerSearchTasksReadyResultInfo } from "./SerpGoogleFinanceTickerSearchTasksReadyResultInfo";
...
export interface ISerpGoogleFinanceTickerSearchTasksReadyTaskInfo  extends IBaseResponseTaskInfo    {
        ...
        /** array of results */
        result?: SerpGoogleFinanceTickerSearchTasksReadyResultInfo[] | undefined
...
export class SerpGoogleFinanceTickerSearchTasksReadyTaskInfo  extends BaseResponseTaskInfo   implements ISerpGoogleFinanceTickerSearchTasksReadyTaskInfo {
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(SerpGoogleFinanceTickerSearchTasksReadyResultInfo.fromJS(item));
                }
            }
        }
    }
    ...
    static fromJS(data: any): SerpGoogleFinanceTickerSearchTasksReadyTaskInfo {
        ...
        let result = new SerpGoogleFinanceTickerSearchTasksReadyTaskInfo();
        result.init(data);
        return result;
    }
