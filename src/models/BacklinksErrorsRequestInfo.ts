...
export interface IBacklinksErrorsRequestInfo   {
...
export class BacklinksErrorsRequestInfo  implements IBacklinksErrorsRequestInfo {
...
2021-11-15 13:57:46 +00:00 */
    ...
    constructor(data?: IBacklinksErrorsRequestInfo) {
    ...
    static fromJS(data: any): BacklinksErrorsRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksErrorsRequestInfo();
        result.init(data);
        return result;
    }
