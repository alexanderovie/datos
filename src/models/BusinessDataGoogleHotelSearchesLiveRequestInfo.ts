export interface IBusinessDataGoogleHotelSearchesLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBusinessDataGoogleHotelSearchesLiveRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleHotelSearchesLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleHotelSearchesLiveRequestInfo();
        result.init(data);
        return result;
    }
