...
export interface ISerpGoogleDatasetAdvancedItem   {
...
export class SerpGoogleDatasetAdvancedItem  implements ISerpGoogleDatasetAdvancedItem {
...
for example: Africa, Global */
    ...
    constructor(data?: ISerpGoogleDatasetAdvancedItem) {
    ...
    static fromJS(data: any): SerpGoogleDatasetAdvancedItem {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleDatasetAdvancedItem();
        result.init(data);
        return result;
    }
