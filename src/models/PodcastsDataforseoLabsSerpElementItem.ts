...
export interface IPodcastsDataforseoLabsSerpElementItem  extends IBaseDataforseoLabsSerpElementItem    {
...
export class PodcastsDataforseoLabsSerpElementItem  extends BaseDataforseoLabsSerpElementItem   implements IPodcastsDataforseoLabsSerpElementItem {
    ...
    static fromJS(data: any): PodcastsDataforseoLabsSerpElementItem {
