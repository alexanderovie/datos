...
export class DataforseoLabsGoogleCategoriesForKeywordsLanguagesResultInfo  implements IDataforseoLabsGoogleCategoriesForKeywordsLanguagesResultInfo {
    ...
    static fromJS(data: any): DataforseoLabsGoogleCategoriesForKeywordsLanguagesResultInfo {
        ...
        let result = new DataforseoLabsGoogleCategoriesForKeywordsLanguagesResultInfo();
        result.init(data);
        return result;
    }
