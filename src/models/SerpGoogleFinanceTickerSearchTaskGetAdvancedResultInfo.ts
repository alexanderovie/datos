...
possible type of items: google_finance_market_index, google_finance_asset_pair, google_finance_market_instrument */
        items?: BaseSerpApiGoogleFinanceTickerSearchElementItem[]

    [key: string]: any;

    }

export class SerpGoogleFinanceTickerSearchTaskGetAdvancedResultInfo  implements ISerpGoogleFinanceTickerSearchTaskGetAdvancedResultInfo {
...
possible type of items: google_finance_market_index, google_finance_asset_pair, google_finance_market_instrument */
    ...
    static fromJS(data: any): SerpGoogleFinanceTickerSearchTaskGetAdvancedResultInfo {
        ...
        let result = new SerpGoogleFinanceTickerSearchTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
