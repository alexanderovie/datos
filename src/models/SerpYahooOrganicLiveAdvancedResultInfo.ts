...
export interface ISerpYahooOrganicLiveAdvancedResultInfo   {
...
export class SerpYahooOrganicLiveAdvancedResultInfo  implements ISerpYahooOrganicLiveAdvancedResultInfo {
...
if there are none, equals null */
    ...
    constructor(data?: ISerpYahooOrganicLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpYahooOrganicLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooOrganicLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
