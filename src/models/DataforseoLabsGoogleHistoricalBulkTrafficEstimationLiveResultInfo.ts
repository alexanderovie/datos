...
if there is no data, then the value is null */
        ...
        items?: DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveItem[]
...
if there is no data, then the value is null */
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveItem.fromJS(item));
                }
            }
        }
    }
    ...
    static fromJS(data: any): DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResultInfo {
        ...
        let result = new DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResultInfo();
        result.init(data);
        return result;
    }
