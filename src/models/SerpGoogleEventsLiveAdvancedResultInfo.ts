...
export interface ISerpGoogleEventsLiveAdvancedResultInfo   {
...
export class SerpGoogleEventsLiveAdvancedResultInfo  implements ISerpGoogleEventsLiveAdvancedResultInfo {
...
this search engine does not indicate the total number of results */
    ...
    constructor(data?: ISerpGoogleEventsLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleEventsLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleEventsLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
