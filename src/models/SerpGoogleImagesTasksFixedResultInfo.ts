export interface ISerpGoogleImagesTasksFixedResultInfo   {
...
export class SerpGoogleImagesTasksFixedResultInfo  implements ISerpGoogleImagesTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleImagesTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleImagesTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleImagesTasksFixedResultInfo();
        result.init(data);
        return result;
    }
