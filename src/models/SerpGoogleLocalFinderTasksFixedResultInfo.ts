...
export interface ISerpGoogleLocalFinderTasksFixedResultInfo   {
...
export class SerpGoogleLocalFinderTasksFixedResultInfo  implements ISerpGoogleLocalFinderTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleLocalFinderTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleLocalFinderTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLocalFinderTasksFixedResultInfo();
        result.init(data);
        return result;
    }
