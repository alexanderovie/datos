...
export class SerpYahooOrganicTaskGetRegularResultInfo  implements ISerpYahooOrganicTaskGetRegularResultInfo {
...
to get all items (including SERP features and rich snippets) found in the returned SERP, please refer to the Yahoo Organiс Advanced SERP endpoint */
    ...
    constructor(data?: ISerpYahooOrganicTaskGetRegularResultInfo) {
    ...
    static fromJS(data: any): SerpYahooOrganicTaskGetRegularResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooOrganicTaskGetRegularResultInfo();
        result.init(data);
        return result;
    }
