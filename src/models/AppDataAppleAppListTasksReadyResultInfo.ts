...
export interface IAppDataAppleAppListTasksReadyResultInfo   {
...
export class AppDataAppleAppListTasksReadyResultInfo  implements IAppDataAppleAppListTasksReadyResultInfo {
...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataAppleAppListTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataAppleAppListTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataAppleAppListTasksReadyResultInfo();
        result.init(data);
        return result;
    }
