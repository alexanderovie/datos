...
export interface ISerpGoogleDatasetInfoTasksReadyResultInfo   {
...
export class SerpGoogleDatasetInfoTasksReadyResultInfo  implements ISerpGoogleDatasetInfoTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleDatasetInfoTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleDatasetInfoTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleDatasetInfoTasksReadyResultInfo();
        result.init(data);
        return result;
    }
