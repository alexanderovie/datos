...
export interface ISerpGoogleSearchByImageTasksReadyResultInfo   {
...
export class SerpGoogleSearchByImageTasksReadyResultInfo  implements ISerpGoogleSearchByImageTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleSearchByImageTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleSearchByImageTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleSearchByImageTasksReadyResultInfo();
        result.init(data);
        return result;
    }
