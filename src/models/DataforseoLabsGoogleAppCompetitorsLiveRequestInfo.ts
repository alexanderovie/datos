export interface IDataforseoLabsGoogleAppCompetitorsLiveRequestInfo   {
...
export class DataforseoLabsGoogleAppCompetitorsLiveRequestInfo  implements IDataforseoLabsGoogleAppCompetitorsLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsGoogleAppCompetitorsLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsGoogleAppCompetitorsLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsGoogleAppCompetitorsLiveRequestInfo();
        result.init(data);
        return result;
    }
