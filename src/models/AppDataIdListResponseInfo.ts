...
export interface IAppDataIdListResponseInfo  extends IBaseResponseInfo    {
        ...
        /** array of tasks */
        tasks?: AppDataIdListTaskInfo[] | undefined
...
export class AppDataIdListResponseInfo  extends BaseResponseInfo   implements IAppDataIdListResponseInfo {
    ...
    constructor(data?: IAppDataIdListResponseInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["tasks"])) {
                ...
                for (let item of data["tasks"]) {
                    this.tasks.push(AppDataIdListTaskInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): AppDataIdListResponseInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataIdListResponseInfo();
        result.init(data);
        return result;
    }
