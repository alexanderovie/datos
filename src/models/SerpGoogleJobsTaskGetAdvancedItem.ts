...
export interface ISerpGoogleJobsTaskGetAdvancedItem   {
...
export class SerpGoogleJobsTaskGetAdvancedItem  implements ISerpGoogleJobsTaskGetAdvancedItem {
...
in this case, will equal null */
    ...
    constructor(data?: ISerpGoogleJobsTaskGetAdvancedItem) {
    ...
    static fromJS(data: any): SerpGoogleJobsTaskGetAdvancedItem {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleJobsTaskGetAdvancedItem();
        result.init(data);
        return result;
    }
