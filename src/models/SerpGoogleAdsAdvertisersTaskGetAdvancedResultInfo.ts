...
ads_muti_account_advertiser, ads_advertiser, ads_domain */
        ...
        items?: BaseSerpApiAdsAdvertiserElementItem[]

    [key: string]: any;

    }

export class SerpGoogleAdsAdvertisersTaskGetAdvancedResultInfo  implements ISerpGoogleAdsAdvertisersTaskGetAdvancedResultInfo {
...
ads_muti_account_advertiser, ads_advertiser, ads_domain */
    ...
    constructor(data?: ISerpGoogleAdsAdvertisersTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAdsAdvertisersTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAdsAdvertisersTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
