...
to get all items (inlcuding SERP features and rich snippets) found in the returned SERP, please refer to the Seznam Organiс Advanced SERP endpoint */
    ...
    constructor(data?: ISerpSeznamOrganicTaskGetRegularResultInfo) {
    ...
    static fromJS(data: any): SerpSeznamOrganicTaskGetRegularResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpSeznamOrganicTaskGetRegularResultInfo();
        result.init(data);
        return result;
    }
