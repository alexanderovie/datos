...
in this case, the value will be null */
    ...
    constructor(data?: IAppDataGoogleAppSearchesTaskPostTaskInfo) {
    super(data);
    ...
    static fromJS(data: any): AppDataGoogleAppSearchesTaskPostTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppSearchesTaskPostTaskInfo();
        result.init(data);
        return result;
    }
