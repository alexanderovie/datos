...
export interface IDataforseoLabsAppleKeywordsForAppLiveTaskInfo  extends IBaseResponseTaskInfo    {
        ...
        /** array of results */
        result?: DataforseoLabsAppleKeywordsForAppLiveResultInfo[] | undefined
...
export class DataforseoLabsAppleKeywordsForAppLiveTaskInfo  extends BaseResponseTaskInfo   implements IDataforseoLabsAppleKeywordsForAppLiveTaskInfo {
    ...
    constructor(data?: IDataforseoLabsAppleKeywordsForAppLiveTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(DataforseoLabsAppleKeywordsForAppLiveResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): DataforseoLabsAppleKeywordsForAppLiveTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsAppleKeywordsForAppLiveTaskInfo();
        result.init(data);
        return result;
    }
