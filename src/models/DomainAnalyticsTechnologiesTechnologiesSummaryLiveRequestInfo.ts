...
export interface IDomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo) {
    ...
    static fromJS(data: any): DomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo();
        result.init(data);
        return result;
    }
