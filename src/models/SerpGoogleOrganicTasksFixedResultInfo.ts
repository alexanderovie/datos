export interface ISerpGoogleOrganicTasksFixedResultInfo   {
...
export class SerpGoogleOrganicTasksFixedResultInfo  implements ISerpGoogleOrganicTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleOrganicTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleOrganicTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleOrganicTasksFixedResultInfo();
        result.init(data);
        return result;
    }
