...
export interface IMultiCarouselDataforseoLabsSerpElementItem  extends IBaseDataforseoLabsSerpElementItem    {
...
export class MultiCarouselDataforseoLabsSerpElementItem  extends BaseDataforseoLabsSerpElementItem   implements IMultiCarouselDataforseoLabsSerpElementItem {
    ...
    static fromJS(data: any): MultiCarouselDataforseoLabsSerpElementItem {
