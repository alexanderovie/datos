export interface IDomainAnalyticsErrorsResultInfo   {
...
export class DomainAnalyticsErrorsResultInfo  implements IDomainAnalyticsErrorsResultInfo {
...
server response */
    ...
    constructor(data?: IDomainAnalyticsErrorsResultInfo) {
    ...
    static fromJS(data: any): DomainAnalyticsErrorsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DomainAnalyticsErrorsResultInfo();
        result.init(data);
        return result;
    }
