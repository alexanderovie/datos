...
export class ContentGenerationGenerateLiveResultInfo  implements IContentGenerationGenerateLiveResultInfo {
...
supplement_token values are unique for each subsequent task */
    ...
    constructor(data?: IContentGenerationGenerateLiveResultInfo) {
    ...
    static fromJS(data: any): ContentGenerationGenerateLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new ContentGenerationGenerateLiveResultInfo();
        result.init(data);
        return result;
    }
