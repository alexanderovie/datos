...
export interface IImageResourceElementItem  extends IBaseOnPageResourceItemInfo    {
...
export class ImageResourceElementItem  extends BaseOnPageResourceItemInfo   implements IImageResourceElementItem {
...
any, none, image, sitemap, robots, script, stylesheet, redirect, html, text, other, font */
    ...
    constructor(data?: IImageResourceElementItem) {
    super(data);
    ...
    static fromJS(data: any): ImageResourceElementItem {
