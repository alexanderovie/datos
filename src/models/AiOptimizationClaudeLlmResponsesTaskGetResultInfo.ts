...
export interface IAiOptimizationClaudeLlmResponsesTaskGetResultInfo   {
...
export class AiOptimizationClaudeLlmResponsesTaskGetResultInfo  implements IAiOptimizationClaudeLlmResponsesTaskGetResultInfo {
...
contains structured AI response data */
    ...
    constructor(data?: IAiOptimizationClaudeLlmResponsesTaskGetResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationClaudeLlmResponsesTaskGetResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationClaudeLlmResponsesTaskGetResultInfo();
        result.init(data);
        return result;
    }
