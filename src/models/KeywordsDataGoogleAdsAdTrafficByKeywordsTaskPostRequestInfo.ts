export interface IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo   {
...
export class KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo  implements IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
