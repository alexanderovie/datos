export interface IAiOptimizationPerplexityLlmResponsesModelsResultInfo   {
...
if true, you can use the Standard (POST-GET) data retrieval method with the AI model */
    ...
    constructor(data?: IAiOptimizationPerplexityLlmResponsesModelsResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationPerplexityLlmResponsesModelsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationPerplexityLlmResponsesModelsResultInfo();
        result.init(data);
        return result;
    }
