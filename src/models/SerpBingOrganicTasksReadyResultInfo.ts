export interface ISerpBingOrganicTasksReadyResultInfo   {
...
export class SerpBingOrganicTasksReadyResultInfo  implements ISerpBingOrganicTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpBingOrganicTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpBingOrganicTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingOrganicTasksReadyResultInfo();
        result.init(data);
        return result;
    }
