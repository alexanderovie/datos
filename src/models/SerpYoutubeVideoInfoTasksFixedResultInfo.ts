export interface ISerpYoutubeVideoInfoTasksFixedResultInfo   {
...
export class SerpYoutubeVideoInfoTasksFixedResultInfo  implements ISerpYoutubeVideoInfoTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpYoutubeVideoInfoTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeVideoInfoTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeVideoInfoTasksFixedResultInfo();
        result.init(data);
        return result;
    }
