export interface IKeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IKeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): KeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
