...
export class SerpGoogleDatasetSearchTaskGetAdvancedResultInfo  implements ISerpGoogleDatasetSearchTaskGetAdvancedResultInfo {
...
possible item type: dataset */
    ...
    constructor(data?: ISerpGoogleDatasetSearchTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleDatasetSearchTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleDatasetSearchTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
