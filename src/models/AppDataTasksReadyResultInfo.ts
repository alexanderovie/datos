export interface IAppDataTasksReadyResultInfo   {
...
export class AppDataTasksReadyResultInfo  implements IAppDataTasksReadyResultInfo {
...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataTasksReadyResultInfo();
        result.init(data);
        return result;
    }
