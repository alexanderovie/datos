export interface ISerpBingLocationsCountryResultInfo   {
...
export class SerpBingLocationsCountryResultInfo  implements ISerpBingLocationsCountryResultInfo {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpBingLocationsCountryResultInfo) {
    ...
    static fromJS(data: any): SerpBingLocationsCountryResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingLocationsCountryResultInfo();
        result.init(data);
        return result;
    }
