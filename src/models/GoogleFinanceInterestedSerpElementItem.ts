...
export interface IGoogleFinanceInterestedSerpElementItem  extends IBaseGoogleFinanceSerpElementItem    {
...
export class GoogleFinanceInterestedSerpElementItem  extends BaseGoogleFinanceSerpElementItem   implements IGoogleFinanceInterestedSerpElementItem {
...
possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element */
    ...
    constructor(data?: IGoogleFinanceInterestedSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): GoogleFinanceInterestedSerpElementItem {
