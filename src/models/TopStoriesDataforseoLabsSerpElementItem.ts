...
export interface ITopStoriesDataforseoLabsSerpElementItem  extends IBaseDataforseoLabsSerpElementItem    {
...
export class TopStoriesDataforseoLabsSerpElementItem  extends BaseDataforseoLabsSerpElementItem   implements ITopStoriesDataforseoLabsSerpElementItem {
    ...
    static fromJS(data: any): TopStoriesDataforseoLabsSerpElementItem {
