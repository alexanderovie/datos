...
export class DataforseoLabsGoogleKeywordOverviewLiveItem  implements IDataforseoLabsGoogleKeywordOverviewLiveItem {
...
learn about search intent in this help center article */
    ...
    static fromJS(data: any): DataforseoLabsGoogleKeywordOverviewLiveItem {
        ...
        let result = new DataforseoLabsGoogleKeywordOverviewLiveItem();
        result.init(data);
        return result;
    }
