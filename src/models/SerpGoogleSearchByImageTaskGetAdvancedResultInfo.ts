...
import { BaseSerpApiGoogleSearchByImagesElementItem, IBaseSerpApiGoogleSearchByImagesElementItem } from "./BaseSerpApiGoogleSearchByImagesElementItem";


export interface ISerpGoogleSearchByImageTaskGetAdvancedResultInfo   {
...
images */
        ...
        items?: BaseSerpApiGoogleSearchByImagesElementItem[] | undefined

    [key: string]: any;

    }

export class SerpGoogleSearchByImageTaskGetAdvancedResultInfo  implements ISerpGoogleSearchByImageTaskGetAdvancedResultInfo {
...
images */
    ...
    constructor(data?: ISerpGoogleSearchByImageTaskGetAdvancedResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(BaseSerpApiGoogleSearchByImagesElementItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): SerpGoogleSearchByImageTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleSearchByImageTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
