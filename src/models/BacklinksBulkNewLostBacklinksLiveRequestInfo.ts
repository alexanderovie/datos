export interface IBacklinksBulkNewLostBacklinksLiveRequestInfo   {
...
export class BacklinksBulkNewLostBacklinksLiveRequestInfo  implements IBacklinksBulkNewLostBacklinksLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBacklinksBulkNewLostBacklinksLiveRequestInfo) {
    ...
    static fromJS(data: any): BacklinksBulkNewLostBacklinksLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksBulkNewLostBacklinksLiveRequestInfo();
        result.init(data);
        return result;
    }
