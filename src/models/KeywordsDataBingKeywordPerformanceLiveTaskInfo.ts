...
export interface IKeywordsDataBingKeywordPerformanceLiveTaskInfo  extends IBaseResponseTaskInfo    {
        ...
        /** array of results */
        result?: KeywordsDataBingKeywordPerformanceLiveResultInfo[] | undefined
...
export class KeywordsDataBingKeywordPerformanceLiveTaskInfo  extends BaseResponseTaskInfo   implements IKeywordsDataBingKeywordPerformanceLiveTaskInfo {
    ...
    constructor(data?: IKeywordsDataBingKeywordPerformanceLiveTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(KeywordsDataBingKeywordPerformanceLiveResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): KeywordsDataBingKeywordPerformanceLiveTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataBingKeywordPerformanceLiveTaskInfo();
        result.init(data);
        return result;
    }
