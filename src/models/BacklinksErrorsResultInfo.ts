...
export interface IBacklinksErrorsResultInfo   {
...
export class BacklinksErrorsResultInfo  implements IBacklinksErrorsResultInfo {
...
server response */
    ...
    constructor(data?: IBacklinksErrorsResultInfo) {
    ...
    static fromJS(data: any): BacklinksErrorsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksErrorsResultInfo();
        result.init(data);
        return result;
    }
