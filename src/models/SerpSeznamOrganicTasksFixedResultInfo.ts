export interface ISerpSeznamOrganicTasksFixedResultInfo   {
...
export class SerpSeznamOrganicTasksFixedResultInfo  implements ISerpSeznamOrganicTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpSeznamOrganicTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpSeznamOrganicTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpSeznamOrganicTasksFixedResultInfo();
        result.init(data);
        return result;
    }
