...
export interface ISerpGoogleDatasetInfoLiveAdvancedResultInfo   {
...
export class SerpGoogleDatasetInfoLiveAdvancedResultInfo  implements ISerpGoogleDatasetInfoLiveAdvancedResultInfo {
...
possible item type: dataset */
    ...
    constructor(data?: ISerpGoogleDatasetInfoLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleDatasetInfoLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleDatasetInfoLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
