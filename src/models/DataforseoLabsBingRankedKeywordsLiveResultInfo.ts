...
ranking data is provided by the rank_absolute parameters that indicate the result’s position among all SERP elements */
        metrics_absolute?: { [key: string]: DataforseoLabsMetricsInfo; }
        
        /** contains ranked keywords and related data */
        items?: DataforseoLabsRankedKeywordsLiveItem[]

    [key: string]: any;

    }

export class DataforseoLabsBingRankedKeywordsLiveResultInfo  implements IDataforseoLabsBingRankedKeywordsLiveResultInfo {
...
ranking data is provided by the rank_absolute parameters that indicate the result’s position among all SERP elements */
    ...
    static fromJS(data: any): DataforseoLabsBingRankedKeywordsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsBingRankedKeywordsLiveResultInfo();
        result.init(data);
        return result;
    }
