...
this search engine does not indicate the total number of results */
    ...
    constructor(data?: ISerpGoogleEventsTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleEventsTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleEventsTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
