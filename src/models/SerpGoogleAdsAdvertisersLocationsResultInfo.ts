export interface ISerpGoogleAdsAdvertisersLocationsResultInfo   {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpGoogleAdsAdvertisersLocationsResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAdsAdvertisersLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAdsAdvertisersLocationsResultInfo();
        result.init(data);
        return result;
    }
