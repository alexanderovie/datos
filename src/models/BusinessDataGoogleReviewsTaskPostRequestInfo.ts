export interface IBusinessDataGoogleReviewsTaskPostRequestInfo   {
...
learn more on our Help Center */
    ...
    constructor(data?: IBusinessDataGoogleReviewsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleReviewsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleReviewsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
