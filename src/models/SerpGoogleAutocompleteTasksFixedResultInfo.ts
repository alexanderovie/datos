...
export interface ISerpGoogleAutocompleteTasksFixedResultInfo   {
...
export class SerpGoogleAutocompleteTasksFixedResultInfo  implements ISerpGoogleAutocompleteTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleAutocompleteTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAutocompleteTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAutocompleteTasksFixedResultInfo();
        result.init(data);
        return result;
    }
