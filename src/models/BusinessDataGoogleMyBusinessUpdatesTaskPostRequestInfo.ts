export interface IBusinessDataGoogleMyBusinessUpdatesTaskPostRequestInfo   {
...
learn more on our Help Center */
    ...
    constructor(data?: IBusinessDataGoogleMyBusinessUpdatesTaskPostRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleMyBusinessUpdatesTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleMyBusinessUpdatesTaskPostRequestInfo();
        result.init(data);
        return result;
    }
