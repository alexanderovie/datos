...
export interface IBusinessDataGoogleQuestionsAndAnswersLiveRequestInfo   {
...
export class BusinessDataGoogleQuestionsAndAnswersLiveRequestInfo  implements IBusinessDataGoogleQuestionsAndAnswersLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBusinessDataGoogleQuestionsAndAnswersLiveRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleQuestionsAndAnswersLiveRequestInfo {
