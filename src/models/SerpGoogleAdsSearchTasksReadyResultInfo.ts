...
export interface ISerpGoogleAdsSearchTasksReadyResultInfo   {
...
export class SerpGoogleAdsSearchTasksReadyResultInfo  implements ISerpGoogleAdsSearchTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleAdsSearchTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAdsSearchTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAdsSearchTasksReadyResultInfo();
        result.init(data);
        return result;
    }
