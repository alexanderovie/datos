...
export interface IDataforseoLabsGoogleRelevantPagesLiveRequestInfo   {
...
export class DataforseoLabsGoogleRelevantPagesLiveRequestInfo  implements IDataforseoLabsGoogleRelevantPagesLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsGoogleRelevantPagesLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsGoogleRelevantPagesLiveRequestInfo {
