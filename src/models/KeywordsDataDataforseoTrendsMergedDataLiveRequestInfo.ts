export interface IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo) {
    ...
    static fromJS(data: any): KeywordsDataDataforseoTrendsMergedDataLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataDataforseoTrendsMergedDataLiveRequestInfo();
        result.init(data);
        return result;
    }
