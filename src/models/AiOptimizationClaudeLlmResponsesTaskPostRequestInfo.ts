...
export interface IAiOptimizationClaudeLlmResponsesTaskPostRequestInfo   {
...
export class AiOptimizationClaudeLlmResponsesTaskPostRequestInfo  implements IAiOptimizationClaudeLlmResponsesTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    constructor(data?: IAiOptimizationClaudeLlmResponsesTaskPostRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationClaudeLlmResponsesTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationClaudeLlmResponsesTaskPostRequestInfo();
        result.init(data);
        return result;
    }
