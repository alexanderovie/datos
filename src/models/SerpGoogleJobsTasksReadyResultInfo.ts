export interface ISerpGoogleJobsTasksReadyResultInfo   {
...
export class SerpGoogleJobsTasksReadyResultInfo  implements ISerpGoogleJobsTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleJobsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleJobsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleJobsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
