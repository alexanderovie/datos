...
export class AiModeAiOverview  implements IAiModeAiOverview {
...
equals null if calculate_rectangles in the POST request is not set to true */
    ...
    constructor(data?: IAiModeAiOverview) {
    ...
    static fromJS(data: any): AiModeAiOverview {
        data = typeof data === 'object' ? data : {};


        let result = new AiModeAiOverview();
        result.init(data);
        return result;
    }
