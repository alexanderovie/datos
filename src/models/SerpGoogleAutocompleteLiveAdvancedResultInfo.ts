...
export interface ISerpGoogleAutocompleteLiveAdvancedResultInfo   {
...
export class SerpGoogleAutocompleteLiveAdvancedResultInfo  implements ISerpGoogleAutocompleteLiveAdvancedResultInfo {
...
autocomplete */
    ...
    constructor(data?: ISerpGoogleAutocompleteLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAutocompleteLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAutocompleteLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
