...
export interface IEventsSerpElementItem  extends IBaseSerpElementItem    {
...
export class EventsSerpElementItem  extends BaseSerpElementItem   implements IEventsSerpElementItem {
