...
import { BusinessDataGoogleExtendedReviewsTaskGetItem, IBusinessDataGoogleExtendedReviewsTaskGetItem } from "./BusinessDataGoogleExtendedReviewsTaskGetItem";
...
you can get more results by using the depth parameter when setting a task */
        ...
        /** found reviews
you can get more results by using the depth parameter when setting a task */
        items?: BusinessDataGoogleExtendedReviewsTaskGetItem[] | undefined
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(BusinessDataGoogleExtendedReviewsTaskGetItem.fromJS(item));
                }
            }
        }
    }
