...
export class BusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo  extends BaseResponseTaskInfo   implements IBusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo {
    ...
    constructor(data?: IBusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(BusinessDataBusinessListingsCategoriesAggregationLiveResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): BusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataBusinessListingsCategoriesAggregationLiveTaskInfo();
        result.init(data);
        return result;
    }
