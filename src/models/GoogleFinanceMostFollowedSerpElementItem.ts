...
export interface IGoogleFinanceMostFollowedSerpElementItem  extends IBaseGoogleFinanceSerpElementItem    {
...
export class GoogleFinanceMostFollowedSerpElementItem  extends BaseGoogleFinanceSerpElementItem   implements IGoogleFinanceMostFollowedSerpElementItem {
...
possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element */
    ...
    constructor(data?: IGoogleFinanceMostFollowedSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): GoogleFinanceMostFollowedSerpElementItem {
