...
export interface ISerpBaiduOrganicTaskGetRegularResultInfo   {
...
export class SerpBaiduOrganicTaskGetRegularResultInfo  implements ISerpBaiduOrganicTaskGetRegularResultInfo {
...
organic, paid */
    ...
    constructor(data?: ISerpBaiduOrganicTaskGetRegularResultInfo) {
    ...
    static fromJS(data: any): SerpBaiduOrganicTaskGetRegularResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBaiduOrganicTaskGetRegularResultInfo();
        result.init(data);
        return result;
    }
