...
export class SerpYoutubeLocationsCountryResultInfo  implements ISerpYoutubeLocationsCountryResultInfo {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpYoutubeLocationsCountryResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeLocationsCountryResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeLocationsCountryResultInfo();
        result.init(data);
        return result;
    }
