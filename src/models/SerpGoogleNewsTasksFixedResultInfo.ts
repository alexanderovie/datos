export interface ISerpGoogleNewsTasksFixedResultInfo   {
...
export class SerpGoogleNewsTasksFixedResultInfo  implements ISerpGoogleNewsTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleNewsTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleNewsTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleNewsTasksFixedResultInfo();
        result.init(data);
        return result;
    }
