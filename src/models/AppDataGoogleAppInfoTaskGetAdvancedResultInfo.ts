...
export class AppDataGoogleAppInfoTaskGetAdvancedResultInfo  implements IAppDataGoogleAppInfoTaskGetAdvancedResultInfo {
...
2019-11-15 12:57:46 +00:00 */
    ...
    constructor(data?: IAppDataGoogleAppInfoTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): AppDataGoogleAppInfoTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppInfoTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
