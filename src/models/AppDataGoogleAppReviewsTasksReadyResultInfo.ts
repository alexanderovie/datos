...
export interface IAppDataGoogleAppReviewsTasksReadyResultInfo   {
...
export class AppDataGoogleAppReviewsTasksReadyResultInfo  implements IAppDataGoogleAppReviewsTasksReadyResultInfo {
...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataGoogleAppReviewsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataGoogleAppReviewsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppReviewsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
