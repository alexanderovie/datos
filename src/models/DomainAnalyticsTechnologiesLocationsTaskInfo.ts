...
export class DomainAnalyticsTechnologiesLocationsTaskInfo  extends BaseResponseTaskInfo   implements IDomainAnalyticsTechnologiesLocationsTaskInfo {
    ...
    constructor(data?: IDomainAnalyticsTechnologiesLocationsTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(DomainAnalyticsTechnologiesLocationsResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): DomainAnalyticsTechnologiesLocationsTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DomainAnalyticsTechnologiesLocationsTaskInfo();
        result.init(data);
        return result;
    }
