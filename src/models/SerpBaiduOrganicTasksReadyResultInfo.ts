export interface ISerpBaiduOrganicTasksReadyResultInfo   {
...
export class SerpBaiduOrganicTasksReadyResultInfo  implements ISerpBaiduOrganicTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpBaiduOrganicTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpBaiduOrganicTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBaiduOrganicTasksReadyResultInfo();
        result.init(data);
        return result;
    }
