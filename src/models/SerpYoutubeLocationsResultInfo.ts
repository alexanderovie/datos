export interface ISerpYoutubeLocationsResultInfo   {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpYoutubeLocationsResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeLocationsResultInfo();
        result.init(data);
        return result;
    }
