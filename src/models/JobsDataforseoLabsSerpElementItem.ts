...
export interface IJobsDataforseoLabsSerpElementItem  extends IBaseDataforseoLabsSerpElementItem    {
...
export class JobsDataforseoLabsSerpElementItem  extends BaseDataforseoLabsSerpElementItem   implements IJobsDataforseoLabsSerpElementItem {
    ...
    static fromJS(data: any): JobsDataforseoLabsSerpElementItem {
