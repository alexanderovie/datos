...
if there is no data, then the value is null */
        ...
        items?: DataforseoLabsAmazonRankedKeywordsLiveItem[] | undefined
...
if there is no data, then the value is null */
    ...
    constructor(data?: IDataforseoLabsAmazonRankedKeywordsLiveResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(DataforseoLabsAmazonRankedKeywordsLiveItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): DataforseoLabsAmazonRankedKeywordsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsAmazonRankedKeywordsLiveResultInfo();
        result.init(data);
        return result;
    }
