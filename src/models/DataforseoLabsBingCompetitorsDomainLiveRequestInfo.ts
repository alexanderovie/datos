export interface IDataforseoLabsBingCompetitorsDomainLiveRequestInfo   {
...
export class DataforseoLabsBingCompetitorsDomainLiveRequestInfo  implements IDataforseoLabsBingCompetitorsDomainLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsBingCompetitorsDomainLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsBingCompetitorsDomainLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsBingCompetitorsDomainLiveRequestInfo();
        result.init(data);
        return result;
    }
