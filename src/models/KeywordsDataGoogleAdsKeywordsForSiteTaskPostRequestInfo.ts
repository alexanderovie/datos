export interface IKeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo   {
...
export class KeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo  implements IKeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IKeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo();
        result.init(data);
        return result;
    }
