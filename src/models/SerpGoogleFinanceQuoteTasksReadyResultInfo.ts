export interface ISerpGoogleFinanceQuoteTasksReadyResultInfo   {
...
export class SerpGoogleFinanceQuoteTasksReadyResultInfo  implements ISerpGoogleFinanceQuoteTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleFinanceQuoteTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleFinanceQuoteTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleFinanceQuoteTasksReadyResultInfo();
        result.init(data);
        return result;
    }
