...
export class DataforseoLabsGoogleSubdomainsLiveResultInfo  implements IDataforseoLabsGoogleSubdomainsLiveResultInfo {
    ...
    constructor(data?: IDataforseoLabsGoogleSubdomainsLiveResultInfo) {
    ...
    static fromJS(data: any): DataforseoLabsGoogleSubdomainsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsGoogleSubdomainsLiveResultInfo();
        result.init(data);
        return result;
    }
