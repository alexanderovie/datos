export interface IKeywordsDataDataforseoTrendsLocationsCountryResultInfo   {
...
export class KeywordsDataDataforseoTrendsLocationsCountryResultInfo  implements IKeywordsDataDataforseoTrendsLocationsCountryResultInfo {
...
you can use this field for matching obtained results with the location_code parameter specified in the request */
    ...
    constructor(data?: IKeywordsDataDataforseoTrendsLocationsCountryResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataDataforseoTrendsLocationsCountryResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataDataforseoTrendsLocationsCountryResultInfo();
        result.init(data);
        return result;
    }
