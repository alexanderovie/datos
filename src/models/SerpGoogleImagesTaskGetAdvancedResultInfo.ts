...
carousel, images_search, related_searches */
        ...
        items?: BaseSerpApiGoogleImagesElementItem[]
...
carousel, images_search, related_searches */
    ...
    constructor(data?: ISerpGoogleImagesTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleImagesTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleImagesTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
