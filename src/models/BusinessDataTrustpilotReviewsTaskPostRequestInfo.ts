export interface IBusinessDataTrustpilotReviewsTaskPostRequestInfo   {
...
learn more on our Help Center */
    ...
    constructor(data?: IBusinessDataTrustpilotReviewsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataTrustpilotReviewsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataTrustpilotReviewsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
