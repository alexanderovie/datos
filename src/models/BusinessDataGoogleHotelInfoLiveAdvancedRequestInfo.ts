export interface IBusinessDataGoogleHotelInfoLiveAdvancedRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBusinessDataGoogleHotelInfoLiveAdvancedRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleHotelInfoLiveAdvancedRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleHotelInfoLiveAdvancedRequestInfo();
        result.init(data);
        return result;
    }
