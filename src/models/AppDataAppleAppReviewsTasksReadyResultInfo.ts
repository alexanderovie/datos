export interface IAppDataAppleAppReviewsTasksReadyResultInfo   {
...
export class AppDataAppleAppReviewsTasksReadyResultInfo  implements IAppDataAppleAppReviewsTasksReadyResultInfo {
...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataAppleAppReviewsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataAppleAppReviewsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataAppleAppReviewsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
