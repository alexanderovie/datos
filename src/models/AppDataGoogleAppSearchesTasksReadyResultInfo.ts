export interface IAppDataGoogleAppSearchesTasksReadyResultInfo   {
...
export class AppDataGoogleAppSearchesTasksReadyResultInfo  implements IAppDataGoogleAppSearchesTasksReadyResultInfo {
...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataGoogleAppSearchesTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataGoogleAppSearchesTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppSearchesTasksReadyResultInfo();
        result.init(data);
        return result;
    }
