export interface ISerpSeznamLocationsResultInfo   {
...
export class SerpSeznamLocationsResultInfo  implements ISerpSeznamLocationsResultInfo {
...
don’t match locations by location_code_parent because the results for Region and Country-level results for most countries are not supported by Baidu SERP API */
    ...
    constructor(data?: ISerpSeznamLocationsResultInfo) {
    ...
    static fromJS(data: any): SerpSeznamLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpSeznamLocationsResultInfo();
        result.init(data);
        return result;
    }
