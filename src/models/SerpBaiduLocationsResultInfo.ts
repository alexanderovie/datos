export interface ISerpBaiduLocationsResultInfo   {
...
export class SerpBaiduLocationsResultInfo  implements ISerpBaiduLocationsResultInfo {
...
only City is supported for all countries except China (where Country is also supported) */
    ...
    constructor(data?: ISerpBaiduLocationsResultInfo) {
    ...
    static fromJS(data: any): SerpBaiduLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBaiduLocationsResultInfo();
        result.init(data);
        return result;
    }
