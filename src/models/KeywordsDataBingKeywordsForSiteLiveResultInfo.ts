...
export class KeywordsDataBingKeywordsForSiteLiveResultInfo  implements IKeywordsDataBingKeywordsForSiteLiveResultInfo {
...
if there is no data, then the value is null */
    ...
    constructor(data?: IKeywordsDataBingKeywordsForSiteLiveResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataBingKeywordsForSiteLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataBingKeywordsForSiteLiveResultInfo();
        result.init(data);
        return result;
    }
