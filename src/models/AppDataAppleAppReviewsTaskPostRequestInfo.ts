...
export interface IAppDataAppleAppReviewsTaskPostRequestInfo   {
...
learn more on our Help Center */
    ...
    constructor(data?: IAppDataAppleAppReviewsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): AppDataAppleAppReviewsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataAppleAppReviewsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
