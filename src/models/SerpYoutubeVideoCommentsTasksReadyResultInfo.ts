...
export interface ISerpYoutubeVideoCommentsTasksReadyResultInfo   {
...
export class SerpYoutubeVideoCommentsTasksReadyResultInfo  implements ISerpYoutubeVideoCommentsTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpYoutubeVideoCommentsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeVideoCommentsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeVideoCommentsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
