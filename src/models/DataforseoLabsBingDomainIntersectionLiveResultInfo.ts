...
export interface IDataforseoLabsBingDomainIntersectionLiveResultInfo   {
...
export class DataforseoLabsBingDomainIntersectionLiveResultInfo  implements IDataforseoLabsBingDomainIntersectionLiveResultInfo {
...
for this endpoint, the field equals bing */
    ...
    constructor(data?: IDataforseoLabsBingDomainIntersectionLiveResultInfo) {
    ...
    static fromJS(data: any): DataforseoLabsBingDomainIntersectionLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsBingDomainIntersectionLiveResultInfo();
        result.init(data);
        return result;
    }
