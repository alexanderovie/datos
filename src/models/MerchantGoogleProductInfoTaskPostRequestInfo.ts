...
learn more on our Help Center */
    ...
    constructor(data?: IMerchantGoogleProductInfoTaskPostRequestInfo) {
    ...
    static fromJS(data: any): MerchantGoogleProductInfoTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantGoogleProductInfoTaskPostRequestInfo();
        result.init(data);
        return result;
    }
