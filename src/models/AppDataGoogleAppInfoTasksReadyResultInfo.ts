...
export class AppDataGoogleAppInfoTasksReadyResultInfo  implements IAppDataGoogleAppInfoTasksReadyResultInfo {
...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataGoogleAppInfoTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataGoogleAppInfoTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppInfoTasksReadyResultInfo();
        result.init(data);
        return result;
    }
