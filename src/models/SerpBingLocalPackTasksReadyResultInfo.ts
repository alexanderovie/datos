...
export interface ISerpBingLocalPackTasksReadyResultInfo   {
...
export class SerpBingLocalPackTasksReadyResultInfo  implements ISerpBingLocalPackTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpBingLocalPackTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpBingLocalPackTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingLocalPackTasksReadyResultInfo();
        result.init(data);
        return result;
    }
