export interface ISerpGoogleEventsTasksFixedResultInfo   {
...
export class SerpGoogleEventsTasksFixedResultInfo  implements ISerpGoogleEventsTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleEventsTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleEventsTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleEventsTasksFixedResultInfo();
        result.init(data);
        return result;
    }
