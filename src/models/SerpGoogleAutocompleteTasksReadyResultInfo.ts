export interface ISerpGoogleAutocompleteTasksReadyResultInfo   {
...
export class SerpGoogleAutocompleteTasksReadyResultInfo  implements ISerpGoogleAutocompleteTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleAutocompleteTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAutocompleteTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAutocompleteTasksReadyResultInfo();
        result.init(data);
        return result;
    }
