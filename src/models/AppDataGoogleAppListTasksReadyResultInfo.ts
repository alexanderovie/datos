...
export interface IAppDataGoogleAppListTasksReadyResultInfo   {
...
export class AppDataGoogleAppListTasksReadyResultInfo  implements IAppDataGoogleAppListTasksReadyResultInfo {
...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataGoogleAppListTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataGoogleAppListTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleAppListTasksReadyResultInfo();
        result.init(data);
        return result;
    }
