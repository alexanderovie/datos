export interface IMerchantAmazonReviewsTasksReadyResultInfo   {
...
export class MerchantAmazonReviewsTasksReadyResultInfo  implements IMerchantAmazonReviewsTasksReadyResultInfo {
...
unique task identifier in our system in the UUID format */
    ...
    constructor(data?: IMerchantAmazonReviewsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): MerchantAmazonReviewsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonReviewsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
