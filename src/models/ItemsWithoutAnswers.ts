...
export interface IItemsWithoutAnswers   {
...
export class ItemsWithoutAnswers  implements IItemsWithoutAnswers {
...
items within google_business_question_item */
    ...
    constructor(data?: IItemsWithoutAnswers) {
    ...
    static fromJS(data: any): ItemsWithoutAnswers {
        data = typeof data === 'object' ? data : {};


        let result = new ItemsWithoutAnswers();
        result.init(data);
        return result;
    }
