export interface IBusinessDataErrorsResultInfo   {
...
export class BusinessDataErrorsResultInfo  implements IBusinessDataErrorsResultInfo {
...
server response */
    ...
    constructor(data?: IBusinessDataErrorsResultInfo) {
    ...
    static fromJS(data: any): BusinessDataErrorsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataErrorsResultInfo();
        result.init(data);
        return result;
    }
