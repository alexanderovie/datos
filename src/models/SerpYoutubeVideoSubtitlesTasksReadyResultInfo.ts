export interface ISerpYoutubeVideoSubtitlesTasksReadyResultInfo   {
...
export class SerpYoutubeVideoSubtitlesTasksReadyResultInfo  implements ISerpYoutubeVideoSubtitlesTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpYoutubeVideoSubtitlesTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeVideoSubtitlesTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeVideoSubtitlesTasksReadyResultInfo();
        result.init(data);
        return result;
    }
