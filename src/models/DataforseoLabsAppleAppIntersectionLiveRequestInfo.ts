export interface IDataforseoLabsAppleAppIntersectionLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsAppleAppIntersectionLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsAppleAppIntersectionLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsAppleAppIntersectionLiveRequestInfo();
        result.init(data);
        return result;
    }
