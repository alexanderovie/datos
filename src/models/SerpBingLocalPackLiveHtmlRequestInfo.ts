...
export interface ISerpBingLocalPackLiveHtmlRequestInfo   {
...
export class SerpBingLocalPackLiveHtmlRequestInfo  implements ISerpBingLocalPackLiveHtmlRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpBingLocalPackLiveHtmlRequestInfo) {
    ...
    static fromJS(data: any): SerpBingLocalPackLiveHtmlRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingLocalPackLiveHtmlRequestInfo();
        result.init(data);
        return result;
    }
