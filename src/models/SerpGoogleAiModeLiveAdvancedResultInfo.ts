...
ai_overview */
    ...
    constructor(data?: ISerpGoogleAiModeLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAiModeLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAiModeLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
