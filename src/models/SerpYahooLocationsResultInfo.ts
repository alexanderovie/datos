...
export class SerpYahooLocationsResultInfo  implements ISerpYahooLocationsResultInfo {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpYahooLocationsResultInfo) {
    ...
    static fromJS(data: any): SerpYahooLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooLocationsResultInfo();
        result.init(data);
        return result;
    }
