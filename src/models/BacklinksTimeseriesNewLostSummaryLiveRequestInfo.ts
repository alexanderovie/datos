...
export interface IBacklinksTimeseriesNewLostSummaryLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBacklinksTimeseriesNewLostSummaryLiveRequestInfo) {
    ...
    static fromJS(data: any): BacklinksTimeseriesNewLostSummaryLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksTimeseriesNewLostSummaryLiveRequestInfo();
        result.init(data);
        return result;
    }
