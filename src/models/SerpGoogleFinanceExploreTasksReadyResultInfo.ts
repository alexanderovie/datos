export interface ISerpGoogleFinanceExploreTasksReadyResultInfo   {
...
export class SerpGoogleFinanceExploreTasksReadyResultInfo  implements ISerpGoogleFinanceExploreTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleFinanceExploreTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleFinanceExploreTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleFinanceExploreTasksReadyResultInfo();
        result.init(data);
        return result;
    }
