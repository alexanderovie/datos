...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IAiOptimizationPerplexityLlmResponsesLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationPerplexityLlmResponsesLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationPerplexityLlmResponsesLiveRequestInfo();
        result.init(data);
        return result;
    }
