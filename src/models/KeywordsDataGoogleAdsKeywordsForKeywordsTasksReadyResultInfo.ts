...
unique task identifier in our system in the UUID format */
    ...
    constructor(data?: IKeywordsDataGoogleAdsKeywordsForKeywordsTasksReadyResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsKeywordsForKeywordsTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsKeywordsForKeywordsTasksReadyResultInfo();
        result.init(data);
        return result;
    }
