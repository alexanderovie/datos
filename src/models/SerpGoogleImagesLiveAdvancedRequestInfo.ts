export interface ISerpGoogleImagesLiveAdvancedRequestInfo   {
...
export class SerpGoogleImagesLiveAdvancedRequestInfo  implements ISerpGoogleImagesLiveAdvancedRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpGoogleImagesLiveAdvancedRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleImagesLiveAdvancedRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleImagesLiveAdvancedRequestInfo();
        result.init(data);
        return result;
    }
