export interface IBusinessDataGoogleMyBusinessInfoTaskPostRequestInfo   {
...
export class BusinessDataGoogleMyBusinessInfoTaskPostRequestInfo  implements IBusinessDataGoogleMyBusinessInfoTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    constructor(data?: IBusinessDataGoogleMyBusinessInfoTaskPostRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleMyBusinessInfoTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleMyBusinessInfoTaskPostRequestInfo();
        result.init(data);
        return result;
    }
