...
if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection */
        ...
        includes_non_news_search_results?: boolean
...
top_stories, news_search */
        ...
        items?: BaseSerpApiGoogleNewsElementItem[]

    [key: string]: any;

    }

export class SerpGoogleNewsLiveAdvancedResultInfo  implements ISerpGoogleNewsLiveAdvancedResultInfo {
...
top_stories, news_search */
    ...
    init(data?: any) {
        if (data) {
            ...
            this.includes_non_news_search_results = data["includes_non_news_search_results"];
    ...
    static fromJS(data: any): SerpGoogleNewsLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleNewsLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["includes_non_news_search_results"] = this.includes_non_news_search_results;
