export interface ISerpGoogleAdsAdvertisersTasksReadyResultInfo   {
...
export class SerpGoogleAdsAdvertisersTasksReadyResultInfo  implements ISerpGoogleAdsAdvertisersTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleAdsAdvertisersTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAdsAdvertisersTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAdsAdvertisersTasksReadyResultInfo();
        result.init(data);
        return result;
    }
