export interface IMerchantAmazonProductsTaskPostRequestInfo   {
...
learn more on our Help Center */
    ...
    constructor(data?: IMerchantAmazonProductsTaskPostRequestInfo) {
    ...
    static fromJS(data: any): MerchantAmazonProductsTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonProductsTaskPostRequestInfo();
        result.init(data);
        return result;
    }
