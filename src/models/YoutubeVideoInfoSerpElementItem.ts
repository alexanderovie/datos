...
export interface IYoutubeVideoInfoSerpElementItem  extends IBaseYoutubeSerpElementItem    {
...
export class YoutubeVideoInfoSerpElementItem  extends BaseYoutubeSerpElementItem   implements IYoutubeVideoInfoSerpElementItem {
...
2022-11-15 12:57:46 +00:00 */
    ...
    constructor(data?: IYoutubeVideoInfoSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): YoutubeVideoInfoSerpElementItem {
