...
export interface ISerpNaverOrganicTaskGetRegularResultInfo   {
...
export class SerpNaverOrganicTaskGetRegularResultInfo  implements ISerpNaverOrganicTaskGetRegularResultInfo {
...
to get all items (inlcuding SERP features and rich snippets) found in the returned SERP, please refer to the Naver Organiс Advanced SERP endpoint */
    ...
    constructor(data?: ISerpNaverOrganicTaskGetRegularResultInfo) {
    ...
    static fromJS(data: any): SerpNaverOrganicTaskGetRegularResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpNaverOrganicTaskGetRegularResultInfo();
        result.init(data);
        return result;
    }
