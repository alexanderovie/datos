...
can take the following values: trustpilot */
    ...
    constructor(data?: IBusinessDataTrustpilotSearchTasksReadyResultInfo) {
    ...
    static fromJS(data: any): BusinessDataTrustpilotSearchTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataTrustpilotSearchTasksReadyResultInfo();
        result.init(data);
        return result;
    }
