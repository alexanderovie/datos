...
export interface IDomainAnalyticsWhoisOverviewLiveResponseInfo  extends IBaseResponseInfo    {
        ...
        /** array of tasks */
        tasks?: DomainAnalyticsWhoisOverviewLiveTaskInfo[] | undefined
...
export class DomainAnalyticsWhoisOverviewLiveResponseInfo  extends BaseResponseInfo   implements IDomainAnalyticsWhoisOverviewLiveResponseInfo {
    ...
    constructor(data?: IDomainAnalyticsWhoisOverviewLiveResponseInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["tasks"])) {
                ...
                for (let item of data["tasks"]) {
                    this.tasks.push(DomainAnalyticsWhoisOverviewLiveTaskInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): DomainAnalyticsWhoisOverviewLiveResponseInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DomainAnalyticsWhoisOverviewLiveResponseInfo();
        result.init(data);
        return result;
    }
