...
export class BacklinksReferringNetworksLiveResultInfo  implements IBacklinksReferringNetworksLiveResultInfo {
    ...
    constructor(data?: IBacklinksReferringNetworksLiveResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(BacklinksReferringNetworksLiveItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): BacklinksReferringNetworksLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksReferringNetworksLiveResultInfo();
        result.init(data);
        return result;
    }
