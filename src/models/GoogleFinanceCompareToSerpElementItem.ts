...
export interface IGoogleFinanceCompareToSerpElementItem  extends IBaseGoogleFinanceSerpElementItem    {
...
export class GoogleFinanceCompareToSerpElementItem  extends BaseGoogleFinanceSerpElementItem   implements IGoogleFinanceCompareToSerpElementItem {
...
possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element */
    ...
    constructor(data?: IGoogleFinanceCompareToSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): GoogleFinanceCompareToSerpElementItem {
