export interface IDataforseoLabsBingSubdomainsLiveRequestInfo   {
...
export class DataforseoLabsBingSubdomainsLiveRequestInfo  implements IDataforseoLabsBingSubdomainsLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsBingSubdomainsLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsBingSubdomainsLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsBingSubdomainsLiveRequestInfo();
        result.init(data);
        return result;
    }
