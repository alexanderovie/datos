export interface IOnPageIdListRequestInfo   {
...
export class OnPageIdListRequestInfo  implements IOnPageIdListRequestInfo {
...
default value: false */
    ...
    constructor(data?: IOnPageIdListRequestInfo) {
    ...
    static fromJS(data: any): OnPageIdListRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new OnPageIdListRequestInfo();
        result.init(data);
        return result;
    }
