export interface IBacklinksDomainPagesSummaryLiveRequestInfo   {
...
export class BacklinksDomainPagesSummaryLiveRequestInfo  implements IBacklinksDomainPagesSummaryLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBacklinksDomainPagesSummaryLiveRequestInfo) {
    ...
    static fromJS(data: any): BacklinksDomainPagesSummaryLiveRequestInfo {
