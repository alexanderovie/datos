export interface IMerchantIdListRequestInfo   {
...
export class MerchantIdListRequestInfo  implements IMerchantIdListRequestInfo {
...
default value: false */
    ...
    constructor(data?: IMerchantIdListRequestInfo) {
    ...
    static fromJS(data: any): MerchantIdListRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantIdListRequestInfo();
        result.init(data);
        return result;
    }
