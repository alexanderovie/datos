...
export class KeywordsDataGoogleAdsKeywordsForSiteTaskGetResultInfo  implements IKeywordsDataGoogleAdsKeywordsForSiteTaskGetResultInfo {
...
if there is no data, the value is null */
    ...
    constructor(data?: IKeywordsDataGoogleAdsKeywordsForSiteTaskGetResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsKeywordsForSiteTaskGetResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsKeywordsForSiteTaskGetResultInfo();
        result.init(data);
        return result;
    }
