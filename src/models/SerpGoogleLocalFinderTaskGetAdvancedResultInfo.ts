...
export interface ISerpGoogleLocalFinderTaskGetAdvancedResultInfo   {
...
local_pack */
    ...
    constructor(data?: ISerpGoogleLocalFinderTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleLocalFinderTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLocalFinderTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
