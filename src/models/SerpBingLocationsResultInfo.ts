export interface ISerpBingLocationsResultInfo   {
...
export class SerpBingLocationsResultInfo  implements ISerpBingLocationsResultInfo {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpBingLocationsResultInfo) {
    ...
    static fromJS(data: any): SerpBingLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingLocationsResultInfo();
        result.init(data);
        return result;
    }
