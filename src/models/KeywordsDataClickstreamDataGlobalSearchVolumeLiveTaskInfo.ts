...
export interface IKeywordsDataClickstreamDataGlobalSearchVolumeLiveTaskInfo  extends IBaseResponseTaskInfo    {
        ...
        /** array of results */
        result?: KeywordsDataClickstreamDataGlobalSearchVolumeLiveResultInfo[] | undefined
...
export class KeywordsDataClickstreamDataGlobalSearchVolumeLiveTaskInfo  extends BaseResponseTaskInfo   implements IKeywordsDataClickstreamDataGlobalSearchVolumeLiveTaskInfo {
    ...
    constructor(data?: IKeywordsDataClickstreamDataGlobalSearchVolumeLiveTaskInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(KeywordsDataClickstreamDataGlobalSearchVolumeLiveResultInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): KeywordsDataClickstreamDataGlobalSearchVolumeLiveTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataClickstreamDataGlobalSearchVolumeLiveTaskInfo();
        result.init(data);
        return result;
    }
