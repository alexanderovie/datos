export interface ISerpGoogleDatasetSearchTasksFixedResultInfo   {
...
export class SerpGoogleDatasetSearchTasksFixedResultInfo  implements ISerpGoogleDatasetSearchTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleDatasetSearchTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleDatasetSearchTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleDatasetSearchTasksFixedResultInfo();
        result.init(data);
        return result;
    }
