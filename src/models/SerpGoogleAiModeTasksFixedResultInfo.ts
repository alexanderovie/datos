export interface ISerpGoogleAiModeTasksFixedResultInfo   {
...
export class SerpGoogleAiModeTasksFixedResultInfo  implements ISerpGoogleAiModeTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleAiModeTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAiModeTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAiModeTasksFixedResultInfo();
        result.init(data);
        return result;
    }
