...
export interface IAnswerBoxSerpElementItem  extends IBaseSerpElementItem    {
...
export class AnswerBoxSerpElementItem  extends BaseSerpElementItem   implements IAnswerBoxSerpElementItem {
