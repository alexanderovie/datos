...
export class SerpGoogleFinanceQuoteLiveAdvancedTaskInfo  extends BaseResponseTaskInfo   implements ISerpGoogleFinanceQuoteLiveAdvancedTaskInfo {
        ...
        if (data) {
            ...
            if (Array.isArray(data["result"])) {
                ...
                for (let item of data["result"]) {
                    this.result.push(SerpGoogleFinanceQuoteLiveAdvancedResultInfo.fromJS(item));
                }
            }
        }
    }
    ...
    static fromJS(data: any): SerpGoogleFinanceQuoteLiveAdvancedTaskInfo {
        ...
        let result = new SerpGoogleFinanceQuoteLiveAdvancedTaskInfo();
        result.init(data);
        return result;
    }
