...
export interface IKeywordsDataBingKeywordsForKeywordsTaskGetResultInfo   {
...
export class KeywordsDataBingKeywordsForKeywordsTaskGetResultInfo  implements IKeywordsDataBingKeywordsForKeywordsTaskGetResultInfo {
...
if there is no data, then the value is null */
    ...
    constructor(data?: IKeywordsDataBingKeywordsForKeywordsTaskGetResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataBingKeywordsForKeywordsTaskGetResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataBingKeywordsForKeywordsTaskGetResultInfo();
        result.init(data);
        return result;
    }
