...
export class KeywordsDataDataforseoTrendsLocationsResultInfo  implements IKeywordsDataDataforseoTrendsLocationsResultInfo {
...
you can use this field for matching obtained results with the location_code parameter specified in the request */
    ...
    constructor(data?: IKeywordsDataDataforseoTrendsLocationsResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataDataforseoTrendsLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataDataforseoTrendsLocationsResultInfo();
        result.init(data);
        return result;
    }
