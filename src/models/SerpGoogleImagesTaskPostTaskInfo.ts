...
in this case, the value will be null */
    ...
    constructor(data?: ISerpGoogleImagesTaskPostTaskInfo) {
    super(data);
    ...
    static fromJS(data: any): SerpGoogleImagesTaskPostTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleImagesTaskPostTaskInfo();
        result.init(data);
        return result;
    }
