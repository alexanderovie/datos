...
note: HTML is not available for this endpoint, the value will be null */
    ...
    constructor(data?: IMerchantGoogleProductInfoTasksReadyResultInfo) {
    ...
    static fromJS(data: any): MerchantGoogleProductInfoTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantGoogleProductInfoTasksReadyResultInfo();
        result.init(data);
        return result;
    }
