...
export class SerpYahooOrganicTasksReadyResultInfo  implements ISerpYahooOrganicTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpYahooOrganicTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpYahooOrganicTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooOrganicTasksReadyResultInfo();
        result.init(data);
        return result;
    }
