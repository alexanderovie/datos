...
export class SerpGoogleFinanceTickerSearchTasksReadyResultInfo  implements ISerpGoogleFinanceTickerSearchTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    static fromJS(data: any): SerpGoogleFinanceTickerSearchTasksReadyResultInfo {
        ...
        let result = new SerpGoogleFinanceTickerSearchTasksReadyResultInfo();
        result.init(data);
        return result;
    }
