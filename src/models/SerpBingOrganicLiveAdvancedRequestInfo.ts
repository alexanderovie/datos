export interface ISerpBingOrganicLiveAdvancedRequestInfo   {
...
export class SerpBingOrganicLiveAdvancedRequestInfo  implements ISerpBingOrganicLiveAdvancedRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpBingOrganicLiveAdvancedRequestInfo) {
    ...
    static fromJS(data: any): SerpBingOrganicLiveAdvancedRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingOrganicLiveAdvancedRequestInfo();
        result.init(data);
        return result;
    }
