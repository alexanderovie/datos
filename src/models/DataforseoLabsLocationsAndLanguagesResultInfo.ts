...
contains the languages which are supported for a specific location */
    ...
    constructor(data?: IDataforseoLabsLocationsAndLanguagesResultInfo) {
    ...
    static fromJS(data: any): DataforseoLabsLocationsAndLanguagesResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsLocationsAndLanguagesResultInfo();
        result.init(data);
        return result;
    }
