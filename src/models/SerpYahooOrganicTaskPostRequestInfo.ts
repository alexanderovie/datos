export interface ISerpYahooOrganicTaskPostRequestInfo   {
...
export class SerpYahooOrganicTaskPostRequestInfo  implements ISerpYahooOrganicTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    constructor(data?: ISerpYahooOrganicTaskPostRequestInfo) {
    ...
    static fromJS(data: any): SerpYahooOrganicTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooOrganicTaskPostRequestInfo();
        result.init(data);
        return result;
    }
