...
export class KeywordsDataBingSearchVolumeHistoryTasksReadyResultInfo  implements IKeywordsDataBingSearchVolumeHistoryTasksReadyResultInfo {
...
unique task identifier in our system in the UUID format */
    ...
    static fromJS(data: any): KeywordsDataBingSearchVolumeHistoryTasksReadyResultInfo {
        ...
        let result = new KeywordsDataBingSearchVolumeHistoryTasksReadyResultInfo();
        result.init(data);
        return result;
    }
