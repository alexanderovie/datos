...
import { LocalPackSerpElementItem, ILocalPackSerpElementItem } from "./BaseSerpApiElementItem";
...
local_pack */
        ...
        items?: LocalPackSerpElementItem[] | undefined

    [key: string]: any;

    }

export class SerpGoogleLocalFinderLiveAdvancedResultInfo  implements ISerpGoogleLocalFinderLiveAdvancedResultInfo {
...
local_pack */
    ...
    constructor(data?: ISerpGoogleLocalFinderLiveAdvancedResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(LocalPackSerpElementItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): SerpGoogleLocalFinderLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLocalFinderLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
