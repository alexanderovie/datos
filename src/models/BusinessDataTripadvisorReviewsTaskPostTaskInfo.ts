...
in this case, the value will be null */
    ...
    constructor(data?: IBusinessDataTripadvisorReviewsTaskPostTaskInfo) {
    super(data);
    ...
    static fromJS(data: any): BusinessDataTripadvisorReviewsTaskPostTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataTripadvisorReviewsTaskPostTaskInfo();
        result.init(data);
        return result;
    }
