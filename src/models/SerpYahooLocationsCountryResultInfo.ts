...
export interface ISerpYahooLocationsCountryResultInfo   {
...
export class SerpYahooLocationsCountryResultInfo  implements ISerpYahooLocationsCountryResultInfo {
...
'location_name': 'Lower Austria,Austria' */
    ...
    constructor(data?: ISerpYahooLocationsCountryResultInfo) {
    ...
    static fromJS(data: any): SerpYahooLocationsCountryResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYahooLocationsCountryResultInfo();
        result.init(data);
        return result;
    }
