...
export class MerchantGoogleProductsTaskGetAdvancedResultInfo  implements IMerchantGoogleProductsTaskGetAdvancedResultInfo {
...
if there are none, equals null */
    ...
    constructor(data?: IMerchantGoogleProductsTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): MerchantGoogleProductsTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantGoogleProductsTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
