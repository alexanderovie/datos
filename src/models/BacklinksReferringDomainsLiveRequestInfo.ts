...
export class BacklinksReferringDomainsLiveRequestInfo  implements IBacklinksReferringDomainsLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBacklinksReferringDomainsLiveRequestInfo) {
    ...
    static fromJS(data: any): BacklinksReferringDomainsLiveRequestInfo {
