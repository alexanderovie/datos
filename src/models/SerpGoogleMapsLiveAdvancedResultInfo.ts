...
maps_search, maps_paid_item */
        ...
        items?: BaseSerpApiGoogleMapsElementItem[]

    [key: string]: any;

    }

export class SerpGoogleMapsLiveAdvancedResultInfo  implements ISerpGoogleMapsLiveAdvancedResultInfo {
...
maps_search, maps_paid_item */
    ...
    constructor(data?: ISerpGoogleMapsLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleMapsLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleMapsLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
