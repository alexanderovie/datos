...
if there is no data the value is null */
    ...
    constructor(data?: IKeywordsDataBingKeywordsForSiteTaskGetResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataBingKeywordsForSiteTaskGetResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataBingKeywordsForSiteTaskGetResultInfo();
        result.init(data);
        return result;
    }
