...
export interface IGoogleFlightsDataforseoLabsSerpElementItem  extends IBaseDataforseoLabsSerpElementItem    {
...
export class GoogleFlightsDataforseoLabsSerpElementItem  extends BaseDataforseoLabsSerpElementItem   implements IGoogleFlightsDataforseoLabsSerpElementItem {
    ...
    static fromJS(data: any): GoogleFlightsDataforseoLabsSerpElementItem {
