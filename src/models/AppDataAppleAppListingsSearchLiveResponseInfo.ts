...
export class AppDataAppleAppListingsSearchLiveResponseInfo  extends BaseResponseInfo   implements IAppDataAppleAppListingsSearchLiveResponseInfo {
    ...
    constructor(data?: IAppDataAppleAppListingsSearchLiveResponseInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["tasks"])) {
                ...
                for (let item of data["tasks"]) {
                    this.tasks.push(AppDataAppleAppListingsSearchLiveTaskInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): AppDataAppleAppListingsSearchLiveResponseInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataAppleAppListingsSearchLiveResponseInfo();
        result.init(data);
        return result;
    }
