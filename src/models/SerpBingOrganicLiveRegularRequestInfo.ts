...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpBingOrganicLiveRegularRequestInfo) {
    ...
    static fromJS(data: any): SerpBingOrganicLiveRegularRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingOrganicLiveRegularRequestInfo();
        result.init(data);
        return result;
    }
