...
if HTML tasks are not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: IAppDataAppleAppInfoTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AppDataAppleAppInfoTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataAppleAppInfoTasksReadyResultInfo();
        result.init(data);
        return result;
    }
