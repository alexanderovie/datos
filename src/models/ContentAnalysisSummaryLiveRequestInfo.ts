export interface IContentAnalysisSummaryLiveRequestInfo   {
...
export class ContentAnalysisSummaryLiveRequestInfo  implements IContentAnalysisSummaryLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IContentAnalysisSummaryLiveRequestInfo) {
    ...
    static fromJS(data: any): ContentAnalysisSummaryLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new ContentAnalysisSummaryLiveRequestInfo();
        result.init(data);
        return result;
    }
