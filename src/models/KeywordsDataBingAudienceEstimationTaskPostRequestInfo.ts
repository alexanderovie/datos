export interface IKeywordsDataBingAudienceEstimationTaskPostRequestInfo   {
...
export class KeywordsDataBingAudienceEstimationTaskPostRequestInfo  implements IKeywordsDataBingAudienceEstimationTaskPostRequestInfo {
...
example: 806300451 */
    ...
    constructor(data?: IKeywordsDataBingAudienceEstimationTaskPostRequestInfo) {
    ...
    static fromJS(data: any): KeywordsDataBingAudienceEstimationTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataBingAudienceEstimationTaskPostRequestInfo();
        result.init(data);
        return result;
    }
