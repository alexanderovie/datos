export interface ISerpBaiduOrganicTasksFixedResultInfo   {
...
export class SerpBaiduOrganicTasksFixedResultInfo  implements ISerpBaiduOrganicTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpBaiduOrganicTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpBaiduOrganicTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBaiduOrganicTasksFixedResultInfo();
        result.init(data);
        return result;
    }
