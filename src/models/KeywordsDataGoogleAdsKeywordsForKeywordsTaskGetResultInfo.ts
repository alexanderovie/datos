...
export class KeywordsDataGoogleAdsKeywordsForKeywordsTaskGetResultInfo  implements IKeywordsDataGoogleAdsKeywordsForKeywordsTaskGetResultInfo {
...
if there is no data, the value is null */
    ...
    constructor(data?: IKeywordsDataGoogleAdsKeywordsForKeywordsTaskGetResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsKeywordsForKeywordsTaskGetResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsKeywordsForKeywordsTaskGetResultInfo();
        result.init(data);
        return result;
    }
