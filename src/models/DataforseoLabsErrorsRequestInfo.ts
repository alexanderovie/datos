export interface IDataforseoLabsErrorsRequestInfo   {
...
export class DataforseoLabsErrorsRequestInfo  implements IDataforseoLabsErrorsRequestInfo {
...
2021-11-15 13:57:46 +00:00 */
    ...
    constructor(data?: IDataforseoLabsErrorsRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsErrorsRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsErrorsRequestInfo();
        result.init(data);
        return result;
    }
