export interface ISerpBingOrganicLiveHtmlRequestInfo   {
...
export class SerpBingOrganicLiveHtmlRequestInfo  implements ISerpBingOrganicLiveHtmlRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpBingOrganicLiveHtmlRequestInfo) {
    ...
    static fromJS(data: any): SerpBingOrganicLiveHtmlRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingOrganicLiveHtmlRequestInfo();
        result.init(data);
        return result;
    }
