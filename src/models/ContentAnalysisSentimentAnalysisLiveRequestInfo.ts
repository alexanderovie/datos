export interface IContentAnalysisSentimentAnalysisLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IContentAnalysisSentimentAnalysisLiveRequestInfo) {
    ...
    static fromJS(data: any): ContentAnalysisSentimentAnalysisLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new ContentAnalysisSentimentAnalysisLiveRequestInfo();
        result.init(data);
        return result;
    }
