...
export class DataforseoLabsAppleAppCompetitorsLiveResponseInfo  extends BaseResponseInfo   implements IDataforseoLabsAppleAppCompetitorsLiveResponseInfo {
    ...
    constructor(data?: IDataforseoLabsAppleAppCompetitorsLiveResponseInfo) {
    super(data);
        ...
        if (data) {
            ...
            if (Array.isArray(data["tasks"])) {
                ...
                for (let item of data["tasks"]) {
                    this.tasks.push(DataforseoLabsAppleAppCompetitorsLiveTaskInfo.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): DataforseoLabsAppleAppCompetitorsLiveResponseInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsAppleAppCompetitorsLiveResponseInfo();
        result.init(data);
        return result;
    }
