export interface IKeywordsDataGoogleAdsSearchVolumeTaskPostRequestInfo   {
...
you will find the specified tag value in the data array of the response */
    ...
    constructor(data?: IKeywordsDataGoogleAdsSearchVolumeTaskPostRequestInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsSearchVolumeTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsSearchVolumeTaskPostRequestInfo();
        result.init(data);
        return result;
    }
