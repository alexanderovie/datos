export interface IBusinessDataGoogleMyBusinessInfoLiveRequestInfo   {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBusinessDataGoogleMyBusinessInfoLiveRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataGoogleMyBusinessInfoLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataGoogleMyBusinessInfoLiveRequestInfo();
        result.init(data);
        return result;
    }
