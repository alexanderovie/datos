...
export class SerpBingOrganicLiveRegularResultInfo  implements ISerpBingOrganicLiveRegularResultInfo {
...
array of 8 search queries related to the keyword */
    ...
    static fromJS(data: any): SerpBingOrganicLiveRegularResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingOrganicLiveRegularResultInfo();
        result.init(data);
        return result;
    }
