...
export class GoogleExtendedReviewsSearch  implements IGoogleExtendedReviewsSearch {
...
contains information about the source where the review was posted */
    ...
    constructor(data?: IGoogleExtendedReviewsSearch) {
    ...
    static fromJS(data: any): GoogleExtendedReviewsSearch {
        data = typeof data === 'object' ? data : {};


        let result = new GoogleExtendedReviewsSearch();
        result.init(data);
        return result;
    }
