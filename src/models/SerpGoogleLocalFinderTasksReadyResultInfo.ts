...
export interface ISerpGoogleLocalFinderTasksReadyResultInfo   {
...
export class SerpGoogleLocalFinderTasksReadyResultInfo  implements ISerpGoogleLocalFinderTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleLocalFinderTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleLocalFinderTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLocalFinderTasksReadyResultInfo();
        result.init(data);
        return result;
    }
