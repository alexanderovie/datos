...
the list of supported SERP elements can be found below */
        serp_item?: GooglePlaySearchOrganic
...
export class GooglePlayRankedSerpElementInfo  implements IGooglePlayRankedSerpElementInfo {
...
in this case, will equal null */
    ...
    constructor(data?: IGooglePlayRankedSerpElementInfo) {
    ...
    static fromJS(data: any): GooglePlayRankedSerpElementInfo {
        data = typeof data === 'object' ? data : {};


        let result = new GooglePlayRankedSerpElementInfo();
        result.init(data);
        return result;
    }
