...
export class SerpGoogleFinanceTickerSearchTaskPostRequestInfo  implements ISerpGoogleFinanceTickerSearchTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    static fromJS(data: any): SerpGoogleFinanceTickerSearchTaskPostRequestInfo {
        ...
        let result = new SerpGoogleFinanceTickerSearchTaskPostRequestInfo();
        result.init(data);
        return result;
    }
