...
export class DataforseoLabsGoogleCompetitorsDomainLiveResultInfo  implements IDataforseoLabsGoogleCompetitorsDomainLiveResultInfo {
    ...
    constructor(data?: IDataforseoLabsGoogleCompetitorsDomainLiveResultInfo) {
    ...
    static fromJS(data: any): DataforseoLabsGoogleCompetitorsDomainLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsGoogleCompetitorsDomainLiveResultInfo();
        result.init(data);
        return result;
    }
