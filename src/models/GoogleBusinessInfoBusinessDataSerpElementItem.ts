...
export interface IGoogleBusinessInfoBusinessDataSerpElementItem  extends IBaseBusinessDataSerpElementItem    {
...
export class GoogleBusinessInfoBusinessDataSerpElementItem  extends BaseBusinessDataSerpElementItem   implements IGoogleBusinessInfoBusinessDataSerpElementItem {
...
includes information about businesses that are located within the target business establishment and have the same address */
    ...
    constructor(data?: IGoogleBusinessInfoBusinessDataSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): GoogleBusinessInfoBusinessDataSerpElementItem {
