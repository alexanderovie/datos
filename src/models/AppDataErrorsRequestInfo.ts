export interface IAppDataErrorsRequestInfo   {
...
export class AppDataErrorsRequestInfo  implements IAppDataErrorsRequestInfo {
...
2021-11-15 13:57:46 +00:00 */
    ...
    constructor(data?: IAppDataErrorsRequestInfo) {
    ...
    static fromJS(data: any): AppDataErrorsRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataErrorsRequestInfo();
        result.init(data);
        return result;
    }
