export interface ISerpGoogleAiModeTasksReadyResultInfo   {
...
export class SerpGoogleAiModeTasksReadyResultInfo  implements ISerpGoogleAiModeTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleAiModeTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleAiModeTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleAiModeTasksReadyResultInfo();
        result.init(data);
        return result;
    }
