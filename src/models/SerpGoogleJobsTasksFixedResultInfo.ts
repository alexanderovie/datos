export interface ISerpGoogleJobsTasksFixedResultInfo   {
...
export class SerpGoogleJobsTasksFixedResultInfo  implements ISerpGoogleJobsTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleJobsTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleJobsTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleJobsTasksFixedResultInfo();
        result.init(data);
        return result;
    }
