...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDomainAnalyticsTechnologiesAggregationTechnologiesLiveRequestInfo) {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.internal_groups_list_limit = data["internal_groups_list_limit"];
            this.internal_categories_list_limit = data["internal_categories_list_limit"];
            this.internal_technologies_list_limit = data["internal_technologies_list_limit"];
    ...
    static fromJS(data: any): DomainAnalyticsTechnologiesAggregationTechnologiesLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DomainAnalyticsTechnologiesAggregationTechnologiesLiveRequestInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["internal_groups_list_limit"] = this.internal_groups_list_limit;
        data["internal_categories_list_limit"] = this.internal_categories_list_limit;
        data["internal_technologies_list_limit"] = this.internal_technologies_list_limit;
