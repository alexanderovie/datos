export interface ISerpGoogleMapsTasksFixedResultInfo   {
...
export class SerpGoogleMapsTasksFixedResultInfo  implements ISerpGoogleMapsTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleMapsTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleMapsTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleMapsTasksFixedResultInfo();
        result.init(data);
        return result;
    }
