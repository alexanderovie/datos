export interface IDataforseoLabsGoogleKeywordIdeasLiveRequestInfo   {
...
export class DataforseoLabsGoogleKeywordIdeasLiveRequestInfo  implements IDataforseoLabsGoogleKeywordIdeasLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IDataforseoLabsGoogleKeywordIdeasLiveRequestInfo) {
    ...
    static fromJS(data: any): DataforseoLabsGoogleKeywordIdeasLiveRequestInfo {
