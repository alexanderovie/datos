export interface IAppDataGoogleLocationsResultInfo   {
...
export class AppDataGoogleLocationsResultInfo  implements IAppDataGoogleLocationsResultInfo {
...
'location_name': 'England,United Kingdom' */
    ...
    constructor(data?: IAppDataGoogleLocationsResultInfo) {
    ...
    static fromJS(data: any): AppDataGoogleLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataGoogleLocationsResultInfo();
        result.init(data);
        return result;
    }
