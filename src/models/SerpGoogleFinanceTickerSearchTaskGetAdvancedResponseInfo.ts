...
export class SerpGoogleFinanceTickerSearchTaskGetAdvancedResponseInfo  extends BaseResponseInfo   implements ISerpGoogleFinanceTickerSearchTaskGetAdvancedResponseInfo {
        ...
        if (data) {
            ...
            if (Array.isArray(data["tasks"])) {
                ...
                for (let item of data["tasks"]) {
                    this.tasks.push(SerpGoogleFinanceTickerSearchTaskGetAdvancedTaskInfo.fromJS(item));
                }
            }
        }
    }
    ...
    static fromJS(data: any): SerpGoogleFinanceTickerSearchTaskGetAdvancedResponseInfo {
        ...
        let result = new SerpGoogleFinanceTickerSearchTaskGetAdvancedResponseInfo();
        result.init(data);
        return result;
    }
