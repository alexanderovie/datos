...
export interface ISerpSeznamOrganicTaskGetAdvancedResultInfo   {
...
export class SerpSeznamOrganicTaskGetAdvancedResultInfo  implements ISerpSeznamOrganicTaskGetAdvancedResultInfo {
...
if there are none, equals null */
    ...
    constructor(data?: ISerpSeznamOrganicTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpSeznamOrganicTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpSeznamOrganicTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
