export interface IBusinessDataErrorsRequestInfo   {
...
2021-11-15 13:57:46 +00:00 */
    ...
    constructor(data?: IBusinessDataErrorsRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataErrorsRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataErrorsRequestInfo();
        result.init(data);
        return result;
    }
