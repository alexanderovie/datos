...
export interface IBacklinksAnchorsLiveRequestInfo   {
...
export class BacklinksAnchorsLiveRequestInfo  implements IBacklinksAnchorsLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IBacklinksAnchorsLiveRequestInfo) {
    ...
    static fromJS(data: any): BacklinksAnchorsLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksAnchorsLiveRequestInfo();
        result.init(data);
        return result;
    }
