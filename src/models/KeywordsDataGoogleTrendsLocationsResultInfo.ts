export interface IKeywordsDataGoogleTrendsLocationsResultInfo   {
...
export class KeywordsDataGoogleTrendsLocationsResultInfo  implements IKeywordsDataGoogleTrendsLocationsResultInfo {
...
you can use this field for matching obtained results with the location_code parameter specified in the request */
    ...
    constructor(data?: IKeywordsDataGoogleTrendsLocationsResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleTrendsLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleTrendsLocationsResultInfo();
        result.init(data);
        return result;
    }
