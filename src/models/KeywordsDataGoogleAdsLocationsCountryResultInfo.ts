...
possible values according to Google’s target types */
    ...
    constructor(data?: IKeywordsDataGoogleAdsLocationsCountryResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsLocationsCountryResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsLocationsCountryResultInfo();
        result.init(data);
        return result;
    }
