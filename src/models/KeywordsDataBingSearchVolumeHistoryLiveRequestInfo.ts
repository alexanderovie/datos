...
export class KeywordsDataBingSearchVolumeHistoryLiveRequestInfo  implements IKeywordsDataBingSearchVolumeHistoryLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    static fromJS(data: any): KeywordsDataBingSearchVolumeHistoryLiveRequestInfo {
        ...
        let result = new KeywordsDataBingSearchVolumeHistoryLiveRequestInfo();
        result.init(data);
        return result;
    }
