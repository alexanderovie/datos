export interface IDomainAnalyticsErrorsRequestInfo   {
...
export class DomainAnalyticsErrorsRequestInfo  implements IDomainAnalyticsErrorsRequestInfo {
...
2021-11-15 13:57:46 +00:00 */
    ...
    constructor(data?: IDomainAnalyticsErrorsRequestInfo) {
    ...
    static fromJS(data: any): DomainAnalyticsErrorsRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DomainAnalyticsErrorsRequestInfo();
        result.init(data);
        return result;
    }
