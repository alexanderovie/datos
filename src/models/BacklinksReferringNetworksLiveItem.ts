...
export interface IBacklinksReferringNetworksLiveItem   {
...
export class BacklinksReferringNetworksLiveItem  implements IBacklinksReferringNetworksLiveItem {
...
indicates ISO country codes of the domains where the referring links are located and the link count per each country */
    ...
    constructor(data?: IBacklinksReferringNetworksLiveItem) {
    ...
    static fromJS(data: any): BacklinksReferringNetworksLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinksReferringNetworksLiveItem();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["type"] = this.type;
        data["network_address"] = this.network_address;
        data["rank"] = this.rank;
