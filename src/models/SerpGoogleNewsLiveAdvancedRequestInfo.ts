...
export interface ISerpGoogleNewsLiveAdvancedRequestInfo   {
...
export class SerpGoogleNewsLiveAdvancedRequestInfo  implements ISerpGoogleNewsLiveAdvancedRequestInfo {
...
Get the list of available parameters and additional details here. */
    ...
    constructor(data?: ISerpGoogleNewsLiveAdvancedRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleNewsLiveAdvancedRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleNewsLiveAdvancedRequestInfo();
        result.init(data);
        return result;
    }
