...
if there is no data, then the value is null */
    ...
    constructor(data?: IKeywordsDataGoogleAdsAdTrafficByKeywordsLiveResultInfo) {
    ...
    static fromJS(data: any): KeywordsDataGoogleAdsAdTrafficByKeywordsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new KeywordsDataGoogleAdsAdTrafficByKeywordsLiveResultInfo();
        result.init(data);
        return result;
    }
