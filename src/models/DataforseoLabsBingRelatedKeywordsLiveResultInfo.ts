...
export class DataforseoLabsBingRelatedKeywordsLiveResultInfo  implements IDataforseoLabsBingRelatedKeywordsLiveResultInfo {
...
fields in the array are identical to that of keyword_data */
    ...
    constructor(data?: IDataforseoLabsBingRelatedKeywordsLiveResultInfo) {
    ...
    static fromJS(data: any): DataforseoLabsBingRelatedKeywordsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new DataforseoLabsBingRelatedKeywordsLiveResultInfo();
        result.init(data);
        return result;
    }
