...
export interface ISerpGoogleOrganicTasksReadyResultInfo   {
...
export class SerpGoogleOrganicTasksReadyResultInfo  implements ISerpGoogleOrganicTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleOrganicTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleOrganicTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleOrganicTasksReadyResultInfo();
        result.init(data);
        return result;
    }
