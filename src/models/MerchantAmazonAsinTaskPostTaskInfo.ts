...
in this case, the value will be null */
    ...
    constructor(data?: IMerchantAmazonAsinTaskPostTaskInfo) {
    super(data);
    ...
    static fromJS(data: any): MerchantAmazonAsinTaskPostTaskInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonAsinTaskPostTaskInfo();
        result.init(data);
        return result;
    }
