...
export interface ISerpGoogleFinanceExploreLiveAdvancedResultInfo   {
...
export class SerpGoogleFinanceExploreLiveAdvancedResultInfo  implements ISerpGoogleFinanceExploreLiveAdvancedResultInfo {
...
possible type of items: google_finance_asset_pair_element, google_finance_market_instrument_element, google_finance_market_index_element */
    ...
    constructor(data?: ISerpGoogleFinanceExploreLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleFinanceExploreLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleFinanceExploreLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
