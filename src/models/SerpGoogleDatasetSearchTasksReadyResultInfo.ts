export interface ISerpGoogleDatasetSearchTasksReadyResultInfo   {
...
export class SerpGoogleDatasetSearchTasksReadyResultInfo  implements ISerpGoogleDatasetSearchTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleDatasetSearchTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleDatasetSearchTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleDatasetSearchTasksReadyResultInfo();
        result.init(data);
        return result;
    }
