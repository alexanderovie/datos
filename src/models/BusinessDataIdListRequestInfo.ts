...
export class BusinessDataIdListRequestInfo  implements IBusinessDataIdListRequestInfo {
...
default value: false */
    ...
    constructor(data?: IBusinessDataIdListRequestInfo) {
    ...
    static fromJS(data: any): BusinessDataIdListRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BusinessDataIdListRequestInfo();
        result.init(data);
        return result;
    }
