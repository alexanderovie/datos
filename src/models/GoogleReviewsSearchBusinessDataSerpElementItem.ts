...
export interface IGoogleReviewsSearchBusinessDataSerpElementItem  extends IBaseBusinessDataSerpElementItem    {
...
export class GoogleReviewsSearchBusinessDataSerpElementItem  extends BaseBusinessDataSerpElementItem   implements IGoogleReviewsSearchBusinessDataSerpElementItem {
...
contains highlighted review criteria and assessments */
    ...
    constructor(data?: IGoogleReviewsSearchBusinessDataSerpElementItem) {
    super(data);
    ...
    static fromJS(data: any): GoogleReviewsSearchBusinessDataSerpElementItem {
