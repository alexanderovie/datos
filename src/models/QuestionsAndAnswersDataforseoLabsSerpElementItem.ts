...
export interface IQuestionsAndAnswersDataforseoLabsSerpElementItem  extends IBaseDataforseoLabsSerpElementItem    {
...
export class QuestionsAndAnswersDataforseoLabsSerpElementItem  extends BaseDataforseoLabsSerpElementItem   implements IQuestionsAndAnswersDataforseoLabsSerpElementItem {
    ...
    static fromJS(data: any): QuestionsAndAnswersDataforseoLabsSerpElementItem {
