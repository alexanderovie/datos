...
export interface IAiOptimizationGeminiLlmResponsesLiveResultInfo   {
...
export class AiOptimizationGeminiLlmResponsesLiveResultInfo  implements IAiOptimizationGeminiLlmResponsesLiveResultInfo {
...
contains structured AI response data */
    ...
    constructor(data?: IAiOptimizationGeminiLlmResponsesLiveResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationGeminiLlmResponsesLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationGeminiLlmResponsesLiveResultInfo();
        result.init(data);
        return result;
    }
