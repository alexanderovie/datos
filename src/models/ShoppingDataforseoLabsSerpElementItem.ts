...
export interface IShoppingDataforseoLabsSerpElementItem  extends IBaseDataforseoLabsSerpElementItem    {
...
export class ShoppingDataforseoLabsSerpElementItem  extends BaseDataforseoLabsSerpElementItem   implements IShoppingDataforseoLabsSerpElementItem {
    ...
    static fromJS(data: any): ShoppingDataforseoLabsSerpElementItem {
