...
export interface ISerpGoogleImagesTaskPostRequestInfo   {
...
export class SerpGoogleImagesTaskPostRequestInfo  implements ISerpGoogleImagesTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    constructor(data?: ISerpGoogleImagesTaskPostRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleImagesTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleImagesTaskPostRequestInfo();
        result.init(data);
        return result;
    }
