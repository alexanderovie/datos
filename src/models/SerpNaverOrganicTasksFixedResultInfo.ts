...
export interface ISerpNaverOrganicTasksFixedResultInfo   {
...
export class SerpNaverOrganicTasksFixedResultInfo  implements ISerpNaverOrganicTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpNaverOrganicTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpNaverOrganicTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpNaverOrganicTasksFixedResultInfo();
        result.init(data);
        return result;
    }
