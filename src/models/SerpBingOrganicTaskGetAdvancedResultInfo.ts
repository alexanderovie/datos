...
export class SerpBingOrganicTaskGetAdvancedResultInfo  implements ISerpBingOrganicTaskGetAdvancedResultInfo {
...
answer_box, carousel, events, featured_snippet, hotels_pack, images, jobs, local_pack, map, organic, paid, people_also_ask, people_also_search, questions_and_answers,recipes, related_searches, shopping, top_stories, video, ai_overview */
    ...
    constructor(data?: ISerpBingOrganicTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpBingOrganicTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpBingOrganicTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
