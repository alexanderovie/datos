export interface IAppDataAppleAppInfoTaskPostRequestInfo   {
...
learn more on our Help Center */
    ...
    constructor(data?: IAppDataAppleAppInfoTaskPostRequestInfo) {
    ...
    static fromJS(data: any): AppDataAppleAppInfoTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppDataAppleAppInfoTaskPostRequestInfo();
        result.init(data);
        return result;
    }
