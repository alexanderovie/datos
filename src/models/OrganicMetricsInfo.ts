...
export interface IOrganicMetricsInfo   {
...
export class OrganicMetricsInfo  implements IOrganicMetricsInfo {
...
indicates how many ranked elements of this domain were previously presented in SERPs, but weren’t found during the last check */
    ...
    constructor(data?: IOrganicMetricsInfo) {
    ...
    static fromJS(data: any): OrganicMetricsInfo {
        data = typeof data === 'object' ? data : {};


        let result = new OrganicMetricsInfo();
        result.init(data);
        return result;
    }
