export interface ISerpGoogleDatasetInfoTasksFixedResultInfo   {
...
export class SerpGoogleDatasetInfoTasksFixedResultInfo  implements ISerpGoogleDatasetInfoTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleDatasetInfoTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleDatasetInfoTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleDatasetInfoTasksFixedResultInfo();
        result.init(data);
        return result;
    }
