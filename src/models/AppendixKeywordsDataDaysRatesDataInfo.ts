...
export class AppendixKeywordsDataDaysRatesDataInfo  implements IAppendixKeywordsDataDaysRatesDataInfo {
    ...
    constructor(data?: IAppendixKeywordsDataDaysRatesDataInfo) {
    ...
    static fromJS(data: any): AppendixKeywordsDataDaysRatesDataInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AppendixKeywordsDataDaysRatesDataInfo();
        result.init(data);
        return result;
    }
